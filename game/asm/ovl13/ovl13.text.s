...
glabel mnDebugCubeSetLighting
  /* 11A340 80131B00 8C830000 */        lw $v1, ($a0)
  /* 11A344 80131B04 3C188013 */       lui $t8, %hi(dMNDebugCubeDisplayList)
  /* 11A348 80131B08 27182CF0 */     addiu $t8, $t8, %lo(dMNDebugCubeDisplayList)
...
glabel mnDebugCubeRotateKirbyCube
  ...
  /* 11A37C 80131B3C 3C118013 */       lui $s1, %hi(dMNDebugCubeRotateVelX)
  /* 11A380 80131B40 3C128013 */       lui $s2, %hi(dMNDebugCubeRotateVelY)
  /* 11A384 80131B44 3C138013 */       lui $s3, %hi(dMNDebugCubeRotateVelZ)
  /* 11A388 80131B48 8C900074 */        lw $s0, 0x74($a0)
  /* 11A38C 80131B4C 26732D20 */     addiu $s3, $s3, %lo(dMNDebugCubeRotateVelZ)
  /* 11A390 80131B50 26522D1C */     addiu $s2, $s2, %lo(dMNDebugCubeRotateVelY)
  /* 11A394 80131B54 26312D18 */     addiu $s1, $s1, %lo(dMNDebugCubeRotateVelX)
  /* 11A398 80131B58 C6040030 */      lwc1 $f4, 0x30($s0)
  .L80131B5C:
  /* 11A39C 80131B5C C6260000 */      lwc1 $f6, ($s1) # dMNDebugCubeRotateVelX + 0
  ...
  /* 11A3B4 80131B74 C6500000 */      lwc1 $f16, ($s2) # dMNDebugCubeRotateVelY + 0
  /* 11A3B8 80131B78 46105480 */     add.s $f18, $f10, $f16
  /* 11A3BC 80131B7C E6120034 */      swc1 $f18, 0x34($s0)
  /* 11A3C0 80131B80 C6660000 */      lwc1 $f6, ($s3) # dMNDebugCubeRotateVelZ + 0
...
glabel mnDebugCubeExit
  /* 11A3FC 80131BBC 240E0001 */     addiu $t6, $zero, 1
  /* 11A400 80131BC0 3C018013 */       lui $at, %hi(dMNDebugCubeExitInterrupt)
  /* 11A404 80131BC4 03E00008 */        jr $ra
  /* 11A408 80131BC8 AC2E3138 */        sw $t6, %lo(dMNDebugCubeExitInterrupt)($at)

  /* 11A40C 80131BCC 03E00008 */        jr $ra
  /* 11A410 80131BD0 00000000 */       nop

glabel mnDebugCubeStartRumble
  /* 11A414 80131BD4 27BDFFE8 */     addiu $sp, $sp, -0x18
  /* 11A418 80131BD8 AFBF0014 */        sw $ra, 0x14($sp)
  /* 11A41C 80131BDC 3C058013 */       lui $a1, %hi(gMNDebugCubeMenuValueRumble)
  /* 11A420 80131BE0 3C068013 */       lui $a2, %hi(gMNDebugCubeMenuValueFrame)
  /* 11A424 80131BE4 8CC62D44 */        lw $a2, %lo(gMNDebugCubeMenuValueFrame)($a2)
  /* 11A428 80131BE8 8CA52D40 */        lw $a1, %lo(gMNDebugCubeMenuValueRumble)($a1)
...
glabel mnDebugCubeStopRumble
  /* 11A444 80131C04 27BDFFE8 */     addiu $sp, $sp, -0x18
  /* 11A448 80131C08 AFBF0014 */        sw $ra, 0x14($sp)
  /* 11A44C 80131C0C 3C058013 */       lui $a1, %hi(gMNDebugCubeMenuValueRumble)
  /* 11A450 80131C10 8CA52D40 */        lw $a1, %lo(gMNDebugCubeMenuValueRumble)($a1)
...
glabel mnDebugCubePlayFGM
  /* 11A46C 80131C2C 27BDFFE8 */     addiu $sp, $sp, -0x18
  /* 11A470 80131C30 AFBF0014 */        sw $ra, 0x14($sp)
  /* 11A474 80131C34 3C048013 */       lui $a0, %hi(gMNDebugCubeMenuValueFGM)
  /* 11A478 80131C38 0C008362 */       jal func_80020D88
  /* 11A47C 80131C3C 8C842D30 */        lw $a0, %lo(gMNDebugCubeMenuValueFGM)($a0)
...
glabel mnDebugCubePlayCall
  /* 11A4B0 80131C70 3C0E8013 */       lui $t6, %hi(gMNDebugCubeMenuValueCall)
  /* 11A4B4 80131C74 8DCE2D2C */        lw $t6, %lo(gMNDebugCubeMenuValueCall)($t6)
  /* 11A4B8 80131C78 3C188013 */       lui $t8, %hi(dMNDebugCubeCallFGMs)
  /* 11A4BC 80131C7C 3C018013 */       lui $at, %hi(gMNDebugCubeQueuedFGM)
  /* 11A4C0 80131C80 000E7880 */       sll $t7, $t6, 2
  /* 11A4C4 80131C84 030FC021 */      addu $t8, $t8, $t7
  /* 11A4C8 80131C88 8F182D54 */        lw $t8, %lo(dMNDebugCubeCallFGMs)($t8)
  /* 11A4CC 80131C8C 03E00008 */        jr $ra
  /* 11A4D0 80131C90 AC382D48 */        sw $t8, %lo(gMNDebugCubeQueuedFGM)($at)

glabel mnDebugCubeStopBGM
...
glabel mnDebugCubePlayBGM
  ...
  /* 11A504 80131CC4 3C048013 */       lui $a0, %hi(gMNDebugCubeMenuValueEffect)
  /* 11A508 80131CC8 0C008290 */       jal func_80020A40
  /* 11A50C 80131CCC 8C842D38 */        lw $a0, %lo(gMNDebugCubeMenuValueEffect)($a0)
  /* 11A510 80131CD0 8FBF0014 */        lw $ra, 0x14($sp)
  /* 11A514 80131CD4 240E0001 */     addiu $t6, $zero, 1
  /* 11A518 80131CD8 3C018013 */       lui $at, %hi(gMNDebugCubeBGMInterrupt)
  /* 11A51C 80131CDC AC2E2D3C */        sw $t6, %lo(gMNDebugCubeBGMInterrupt)($at)
  /* 11A520 80131CE0 03E00008 */        jr $ra
  /* 11A524 80131CE4 27BD0018 */     addiu $sp, $sp, 0x18

glabel mnDebugCubeDoTransition
  /* 11A528 80131CE8 24020001 */     addiu $v0, $zero, 1
  /* 11A52C 80131CEC 3C018013 */       lui $at, %hi(dMNDebugCubeExitInterrupt)
  /* 11A530 80131CF0 AC223138 */        sw $v0, %lo(dMNDebugCubeExitInterrupt)($at)
  /* 11A534 80131CF4 3C018013 */       lui $at, %hi(dMNDebugCubeTransitionInterrupt)
  /* 11A538 80131CF8 03E00008 */        jr $ra
  /* 11A53C 80131CFC AC22313C */        sw $v0, %lo(dMNDebugCubeTransitionInterrupt)($at)

glabel mnDebugCubeCheckAudioChange
  ...
  /* 11A558 80131D18 3C108013 */       lui $s0, %hi(gMNDebugCubeSFX)
  /* 11A55C 80131D1C 3C118013 */       lui $s1, %hi(gMNDebugCubeBGMInterrupt)
  /* 11A560 80131D20 3C128013 */       lui $s2, %hi(gMNDebugCubeCurrentSFX)
  /* 11A564 80131D24 3C138013 */       lui $s3, %hi(gMNDebugCubeQueuedFGM)
  /* 11A568 80131D28 3C148013 */       lui $s4, %hi(gMNDebugCubeMenuValueBGM)
  /* 11A56C 80131D2C AFBF002C */        sw $ra, 0x2c($sp)
  /* 11A570 80131D30 AFA40030 */        sw $a0, 0x30($sp)
  /* 11A574 80131D34 26942D34 */     addiu $s4, $s4, %lo(gMNDebugCubeMenuValueBGM)
  /* 11A578 80131D38 26732D48 */     addiu $s3, $s3, %lo(gMNDebugCubeQueuedFGM)
  /* 11A57C 80131D3C 26522D50 */     addiu $s2, $s2, %lo(gMNDebugCubeCurrentSFX)
  /* 11A580 80131D40 26312D3C */     addiu $s1, $s1, %lo(gMNDebugCubeBGMInterrupt)
  /* 11A584 80131D44 26102D4C */     addiu $s0, $s0, %lo(gMNDebugCubeSFX)
  /* 11A588 80131D48 8E2E0000 */        lw $t6, ($s1) # gMNDebugCubeBGMInterrupt + 0
  .L80131D4C:
  /* 11A58C 80131D4C 51C00009 */      beql $t6, $zero, .L80131D74
  /* 11A590 80131D50 8E030000 */        lw $v1, ($s0) # gMNDebugCubeSFX + 0
  ...
  /* 11A5A8 80131D68 8E850000 */        lw $a1, ($s4) # gMNDebugCubeMenuValueBGM + 0
  /* 11A5AC 80131D6C AE200000 */        sw $zero, ($s1) # gMNDebugCubeBGMInterrupt + 0
  .L80131D70:
  /* 11A5B0 80131D70 8E030000 */        lw $v1, ($s0) # gMNDebugCubeSFX + 0
  .L80131D74:
  /* 11A5B4 80131D74 50600008 */      beql $v1, $zero, .L80131D98
  /* 11A5B8 80131D78 8E620000 */        lw $v0, ($s3) # gMNDebugCubeQueuedFGM + 0
  /* 11A5BC 80131D7C 94620026 */       lhu $v0, 0x26($v1)
  /* 11A5C0 80131D80 50400005 */      beql $v0, $zero, .L80131D98
  /* 11A5C4 80131D84 8E620000 */        lw $v0, ($s3) # gMNDebugCubeQueuedFGM + 0
  /* 11A5C8 80131D88 8E4F0000 */        lw $t7, ($s2) # gMNDebugCubeCurrentSFX + 0
  /* 11A5CC 80131D8C 11E2000B */       beq $t7, $v0, .L80131DBC
  /* 11A5D0 80131D90 00000000 */       nop
  /* 11A5D4 80131D94 8E620000 */        lw $v0, ($s3) # gMNDebugCubeQueuedFGM + 0
  .L80131D98:
  ...
  /* 11A5EC 80131DAC AE020000 */        sw $v0, ($s0) # gMNDebugCubeSFX + 0
  /* 11A5F0 80131DB0 94580026 */       lhu $t8, 0x26($v0)
  /* 11A5F4 80131DB4 AE600000 */        sw $zero, ($s3) # gMNDebugCubeQueuedFGM + 0
  /* 11A5F8 80131DB8 AE580000 */        sw $t8, ($s2) # gMNDebugCubeCurrentSFX + 0
  .L80131DBC:
  ...
  /* 11A608 80131DC8 8E2E0000 */        lw $t6, ($s1) # gMNDebugCubeBGMInterrupt + 0
...
glabel mnDebugCubeMain
  ...
  /* 11A65C 80131E1C 3C078013 */       lui $a3, %hi(dMNDebugCubeMenuItems)
  ...
  .L80131E5C:
  /* 11A69C 80131E5C 3C198013 */       lui $t9, %hi(dMNDebugCubeExitInterrupt)
...
glabel mnDebugCubeCreateViewport
...
glabel mnDebugCubeInit
  ...
  /* 11A868 80132028 3C058013 */       lui $a1, %hi(mnDebugCubeMain)
  /* 11A86C 8013202C 24A51E00 */     addiu $a1, $a1, %lo(mnDebugCubeMain)
  ...
  /* 11A8D8 80132098 0C04C7CA */       jal mnDebugCubeCreateViewport
  /* 11A8DC 8013209C 00002025 */        or $a0, $zero, $zero
  /* 11A8E0 801320A0 3C048013 */       lui $a0, %hi(mnDebugCubeRotateKirbyCube)
  /* 11A8E4 801320A4 3C058013 */       lui $a1, %hi(dMNDebugCubeKirbyCubeDisplayList)
  /* 11A8E8 801320A8 24A52B68 */     addiu $a1, $a1, %lo(dMNDebugCubeKirbyCubeDisplayList)
  /* 11A8EC 801320AC 0C04C7A8 */       jal mnDebugCubeCreateGObj
  /* 11A8F0 801320B0 24841B24 */     addiu $a0, $a0, %lo(mnDebugCubeRotateKirbyCube)
  ...
  /* 11A928 801320E8 3C048013 */       lui $a0, %hi(gMNDebugCubeMenuValueTransition)
  ...
  /* 11A93C 801320FC 8C842D84 */        lw $a0, %lo(gMNDebugCubeMenuValueTransition)($a0)
  ...
  /* 11A954 80132114 0C002EC1 */       jal gcSetDObjAnimPlaybackRate
  ...
  /* 11A974 80132134 0C04C7A8 */       jal mnDebugCubeCreateGObj
...
glabel mnDebugCubeStartScene
  ...
  /* 11A9DC 8013219C 3C108013 */       lui $s0, %hi(dMNDebugCubeTransitionInterrupt)
  /* 11A9E0 801321A0 AE280010 */        sw $t0, 0x10($s1) # D_ovl13_80132F88 + 16
  /* 11A9E4 801321A4 2610313C */     addiu $s0, $s0, %lo(dMNDebugCubeTransitionInterrupt)
  /* 11A9E8 801321A8 26523138 */     addiu $s2, $s2, %lo(dMNDebugCubeExitInterrupt)
  /* 11A9EC 801321AC AE400000 */        sw $zero, ($s2) # dMNDebugCubeExitInterrupt + 0
  .L801321B0:
  /* 11A9F0 801321B0 AE000000 */        sw $zero, ($s0) # dMNDebugCubeTransitionInterrupt + 0
  /* 11A9F4 801321B4 0C001A0F */       jal gsGTLSceneInit
  /* 11A9F8 801321B8 02202025 */        or $a0, $s1, $zero
  /* 11A9FC 801321BC 8E090000 */        lw $t1, ($s0) # dMNDebugCubeTransitionInterrupt + 0
  /* 11AA00 801321C0 5520FFFB */      bnel $t1, $zero, .L801321B0
  /* 11AA04 801321C4 AE400000 */        sw $zero, ($s2) # dMNDebugCubeExitInterrupt + 0
