...
glabel mnDebugFallsSetLighting
  /* 150740 800D6490 8C830000 */        lw $v1, ($a0)
  /* 150744 800D6494 3C18800D */       lui $t8, %hi(dMNDebugFallsDisplayList)
  /* 150748 800D6498 271866F8 */     addiu $t8, $t8, %lo(dMNDebugFallsDisplayList)
...
glabel mnDebugFallsExit
  /* 150764 800D64B4 240E0001 */     addiu $t6, $zero, 1
  /* 150768 800D64B8 3C01800D */       lui $at, %hi(gMNDebugFallsExitInterrupt)
  /* 15076C 800D64BC 03E00008 */        jr $ra
  /* 150770 800D64C0 AC2E6720 */        sw $t6, %lo(gMNDebugFallsExitInterrupt)($at)

glabel mnDebugFallsMain
  ...
  /* 150790 800D64E0 3C07800D */       lui $a3, %hi(dMNDebugFallsMenuItems)
  /* 150794 800D64E4 2418000D */     addiu $t8, $zero, 0xd
  /* 150798 800D64E8 AFB80010 */        sw $t8, 0x10($sp)
  /* 15079C 800D64EC 24E76738 */     addiu $a3, $a3, %lo(dMNDebugFallsMenuItems)
  ...
  .L800D6500:
  /* 1507B0 800D6500 3C19800D */       lui $t9, %hi(gMNDebugFallsExitInterrupt)
  /* 1507B4 800D6504 8F396720 */        lw $t9, %lo(gMNDebugFallsExitInterrupt)($t9)
...
glabel mnDebugFallsCreateViewport
...
glabel mnDebugFallsInit
  /* 1508BC 800D660C 27BDFFE0 */     addiu $sp, $sp, -0x20
  /* 1508C0 800D6610 AFBF001C */        sw $ra, 0x1c($sp)
  /* 1508C4 800D6614 3C05800D */       lui $a1, %hi(mnDebugFallsMain)
  /* 1508C8 800D6618 24A564C4 */     addiu $a1, $a1, %lo(mnDebugFallsMain)
  /* 1508CC 800D661C 00002025 */        or $a0, $zero, $zero
  /* 1508D0 800D6620 00003025 */        or $a2, $zero, $zero
  /* 1508D4 800D6624 0C00265A */       jal omMakeGObjSPAfter
  ...
  /* 1508F8 800D6648 0C035951 */       jal mnDebugFallsCreateViewport
  ...
  /* 150908 800D6658 3C07800D */       lui $a3, %hi(dMNDebugFallsMenuItems)
  /* 15090C 800D665C 240F000D */     addiu $t7, $zero, 0xd
  /* 150910 800D6660 AFAF0010 */        sw $t7, 0x10($sp)
  /* 150914 800D6664 24E76738 */     addiu $a3, $a3, %lo(dMNDebugFallsMenuItems)
...
#
#glabel dMNDebugFallsLights1   # Routine parsed as data
