...
glabel func_ovl36_8018D0C0
  ...
  /* 166740 8018D110 0C0337DE */       jal rdManagerInitSetup
  ...
  /* 166750 8018D120 0C0337BB */       jal rdManagerGetAllocSize
  /* 166754 8018D124 24050002 */     addiu $a1, $zero, 2
  /* 166758 8018D128 00402025 */        or $a0, $v0, $zero
  /* 16675C 8018D12C 0C001260 */       jal hlMemoryAlloc
  ...
  /* 166778 8018D148 0C033781 */       jal rdManagerLoadFiles
...
glabel func_ovl36_8018D194
  ...
  /* 166894 8018D264 0C00277D */       jal omAddGObjRenderProc
  ...
  /* 1668D4 8018D2A4 0C0333F7 */       jal gcAppendSObjWithSprite
...
glabel func_ovl36_8018D614
  ...
  /* 166C7C 8018D64C 0C03F1E9 */       jal mpCollision_GetMPointCountKind
  ...
  /* 166CF8 8018D6C8 3C168011 */       lui $s6, %hi(dFighterDefaultSpawn)
  /* 166CFC 8018D6CC 3C15800A */       lui $s5, %hi(gBattleState)
  /* 166D00 8018D6D0 26B550E8 */     addiu $s5, $s5, %lo(gBattleState)
  /* 166D04 8018D6D4 26D66DD0 */     addiu $s6, $s6, %lo(dFighterDefaultSpawn)
...
glabel func_ovl36_8018DE64
  ...
  /* 167558 8018DF28 0C03F0A1 */       jal mpCollision_InitMapCollisionData
  ...
  /* 1675B0 8018DF80 0C001260 */       jal hlMemoryAlloc
