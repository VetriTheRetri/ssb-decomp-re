...
glabel mvOpeningDKLoadFiles
  ...
  /* 167880 8018D110 0C0337DE */       jal rdManagerInitSetup
  ...
  /* 167890 8018D120 0C0337BB */       jal rdManagerGetAllocSize
  /* 167894 8018D124 24050002 */     addiu $a1, $zero, 2
  /* 167898 8018D128 00402025 */        or $a0, $v0, $zero
  /* 16789C 8018D12C 0C001260 */       jal gsMemoryAlloc
  ...
  /* 1678B8 8018D148 0C033781 */       jal rdManagerLoadFiles
...
glabel mvOpeningDKDrawName
  ...
  /* 1679B4 8018D244 0C00277D */       jal omAddGObjRenderProc
...
glabel mvOpeningDKInitFighterStagePanel
  ...
  /* 167DF0 8018D680 0C03F225 */       jal mpCollision_GetMPointPositionID
  ...
  /* 167E34 8018D6C4 26D66DD0 */     addiu $s6, $s6, %lo(dFTDefaultFighterDesc)
  ...
  /* 167E8C 8018D71C 8EAB0000 */        lw $t3, ($s5) # gBattleState + 0
  /* 167E90 8018D720 3C0E8004 */       lui $t6, %hi(gPlayerControllers)
  /* 167E94 8018D724 25CE5228 */     addiu $t6, $t6, %lo(gPlayerControllers)
  ...
  /* 167EB0 8018D740 0C035E1B */       jal ftManagerSetupDataKind
  /* 167EB4 8018D744 92040023 */       lbu $a0, 0x23($s0) # D_ovl37_8018E190 + 35
  /* 167EB8 8018D748 8EA20000 */        lw $v0, ($s5) # gBattleState + 0
  ...
  /* 167F2C 8018D7BC 0C035E2D */       jal ftManagerAllocAnimHeapKind
  /* 167F30 8018D7C0 92040023 */       lbu $a0, 0x23($s0) # D_ovl37_8018E190 + 35
  /* 167F34 8018D7C4 AFA20088 */        sw $v0, 0x88($sp)
  /* 167F38 8018D7C8 0C035FCF */       jal ftManagerMakeFighter
...
glabel mvOpeningDKRenderPosedFighterBackground
  ...
  /* 167FBC 8018D84C AD6E0000 */        sw $t6, ($t3) # gDisplayListHead + 0
  /* 167FC0 8018D850 AC600004 */        sw $zero, 4($v1)
  /* 167FC4 8018D854 AC6C0000 */        sw $t4, ($v1)
  /* 167FC8 8018D858 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 167FD8 8018D868 AD6F0000 */        sw $t7, ($t3) # gDisplayListHead + 0
  /* 167FDC 8018D86C AC600004 */        sw $zero, 4($v1)
  /* 167FE0 8018D870 AC780000 */        sw $t8, ($v1)
  /* 167FE4 8018D874 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 168014 8018D8A4 AD780000 */        sw $t8, ($t3) # gDisplayListHead + 0
  ...
  /* 168028 8018D8B8 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 168038 8018D8C8 AD6F0000 */        sw $t7, ($t3) # gDisplayListHead + 0
  ...
  /* 16804C 8018D8DC 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16805C 8018D8EC AD790000 */        sw $t9, ($t3) # gDisplayListHead + 0
  ...
  /* 168070 8018D900 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 168080 8018D910 AD780000 */        sw $t8, ($t3) # gDisplayListHead + 0
  /* 168084 8018D914 AC600004 */        sw $zero, 4($v1)
  /* 168088 8018D918 AC6C0000 */        sw $t4, ($v1)
  /* 16808C 8018D91C 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  /* 168090 8018D920 24790008 */     addiu $t9, $v1, 8
  /* 168094 8018D924 AD790000 */        sw $t9, ($t3) # gDisplayListHead + 0
...
glabel mvOpeningDKCreatePosedFighter
  ...
  /* 168248 8018DAD8 0C035FCF */       jal ftManagerMakeFighter
...
glabel mvOpeningDKInit
  ...
  /* 1685D0 8018DE60 244250E8 */     addiu $v0, $v0, %lo(gBattleState)
  ...
  /* 1686A8 8018DF38 0C035C65 */       jal ftManagerAllocFighter
  ...
  /* 1686C8 8018DF58 0C035E1B */       jal ftManagerSetupDataKind
  /* 1686CC 8018DF5C 24040002 */     addiu $a0, $zero, 2
  /* 1686D0 8018DF60 3C048013 */       lui $a0, %hi(gFTAnimHeapSize)
  /* 1686D4 8018DF64 8C840D9C */        lw $a0, %lo(gFTAnimHeapSize)($a0)
...
glabel mvOpeningDKSetupDisplayList
  ...
  /* 16875C 8018DFEC 3C058013 */       lui $a1, %hi(gMPLightAngleX)
  /* 168760 8018DFF0 3C068013 */       lui $a2, %hi(gMPLightAngleY)
  /* 168764 8018DFF4 AC780004 */        sw $t8, 4($v1)
  /* 168768 8018DFF8 AC6F0000 */        sw $t7, ($v1)
  /* 16876C 8018DFFC 8CC61394 */        lw $a2, %lo(gMPLightAngleY)($a2)
  /* 168770 8018E000 0C03F2DC */       jal ftRender_Lights_DisplayLightReflect
  /* 168774 8018E004 8CA51390 */        lw $a1, %lo(gMPLightAngleX)($a1)
