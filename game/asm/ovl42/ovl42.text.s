...
glabel func_ovl42_8018D0C0
  ...
  /* 16CEC0 8018D110 0C0337DE */       jal rdManagerInitSetup
  ...
  /* 16CED0 8018D120 0C0337BB */       jal rdManagerGetAllocSize
  /* 16CED4 8018D124 24050002 */     addiu $a1, $zero, 2
  /* 16CED8 8018D128 00402025 */        or $a0, $v0, $zero
  /* 16CEDC 8018D12C 0C001260 */       jal hlMemoryAlloc
  ...
  /* 16CEF8 8018D148 0C033781 */       jal rdManagerLoadFiles
...
glabel func_ovl42_8018D194
  ...
  /* 16D074 8018D2C4 0C0333F7 */       jal gcAppendSObjWithSprite
...
glabel func_ovl42_8018D634
  ...
  /* 16D440 8018D690 0C028C10 */       jal scnmgr_scManagerCrashPrintGObjStatus
  ...
  /* 16D460 8018D6B0 0C03F225 */       jal mpCollision_GetMPointPositionID
  ...
  /* 16D498 8018D6E8 3C168011 */       lui $s6, %hi(dFighterDefaultSpawn)
  /* 16D49C 8018D6EC 3C15800A */       lui $s5, %hi(gBattleState)
  /* 16D4A0 8018D6F0 26B550E8 */     addiu $s5, $s5, %lo(gBattleState)
  /* 16D4A4 8018D6F4 26D66DD0 */     addiu $s6, $s6, %lo(dFighterDefaultSpawn)
  ...
  /* 16D4FC 8018D74C 8EAB0000 */        lw $t3, ($s5) # gBattleState + 0
  /* 16D500 8018D750 3C0E8004 */       lui $t6, %hi(gPlayerControllers)
  /* 16D504 8018D754 25CE5228 */     addiu $t6, $t6, %lo(gPlayerControllers)
...
glabel func_ovl42_8018D864
  ...
  /* 16D62C 8018D87C AD6E0000 */        sw $t6, ($t3) # gDisplayListHead + 0
  /* 16D630 8018D880 AC600004 */        sw $zero, 4($v1)
  /* 16D634 8018D884 AC6C0000 */        sw $t4, ($v1)
  /* 16D638 8018D888 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16D648 8018D898 AD6F0000 */        sw $t7, ($t3) # gDisplayListHead + 0
  /* 16D64C 8018D89C AC600004 */        sw $zero, 4($v1)
  /* 16D650 8018D8A0 AC780000 */        sw $t8, ($v1)
  /* 16D654 8018D8A4 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16D684 8018D8D4 AD780000 */        sw $t8, ($t3) # gDisplayListHead + 0
  ...
  /* 16D698 8018D8E8 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16D6A8 8018D8F8 AD6F0000 */        sw $t7, ($t3) # gDisplayListHead + 0
  ...
  /* 16D6BC 8018D90C 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16D6CC 8018D91C AD790000 */        sw $t9, ($t3) # gDisplayListHead + 0
  ...
  /* 16D6E0 8018D930 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16D6F0 8018D940 AD780000 */        sw $t8, ($t3) # gDisplayListHead + 0
  /* 16D6F4 8018D944 AC600004 */        sw $zero, 4($v1)
  /* 16D6F8 8018D948 AC6C0000 */        sw $t4, ($v1)
  /* 16D6FC 8018D94C 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  /* 16D700 8018D950 24790008 */     addiu $t9, $v1, 8
  /* 16D704 8018D954 AD790000 */        sw $t9, ($t3) # gDisplayListHead + 0
...
glabel func_ovl42_8018DE88
  ...
  /* 16DC50 8018DEA0 244250E8 */     addiu $v0, $v0, %lo(gBattleState)
  ...
  /* 16DD5C 8018DFAC 0C001260 */       jal hlMemoryAlloc
