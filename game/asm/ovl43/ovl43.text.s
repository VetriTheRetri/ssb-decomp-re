...
glabel func_ovl43_8018D0C0
  ...
  /* 16E020 8018D110 0C0337DE */       jal rdManagerInitSetup
  ...
  /* 16E030 8018D120 0C0337BB */       jal rdManagerGetAllocSize
  /* 16E034 8018D124 24050002 */     addiu $a1, $zero, 2
  /* 16E038 8018D128 00402025 */        or $a0, $v0, $zero
  /* 16E03C 8018D12C 0C001260 */       jal hlMemoryAlloc
  ...
  /* 16E058 8018D148 0C033781 */       jal rdManagerLoadFiles
...
glabel func_ovl43_8018D194
  ...
  /* 16E17C 8018D26C 0C00277D */       jal omAddGObjRenderProc
  ...
  /* 16E1BC 8018D2AC 0C0333F7 */       jal gcAppendSObjWithSprite
...
glabel func_ovl43_8018D62C
  ...
  /* 16E598 8018D688 0C028C10 */       jal scnmgr_scManagerCrashPrintGObjStatus
  ...
  /* 16E5B8 8018D6A8 0C03F225 */       jal mpCollision_GetMPointPositionID
  ...
  /* 16E604 8018D6F4 3C168011 */       lui $s6, %hi(dFighterDefaultSpawn)
  /* 16E608 8018D6F8 3C15800A */       lui $s5, %hi(gBattleState)
  /* 16E60C 8018D6FC 26B550E8 */     addiu $s5, $s5, %lo(gBattleState)
  /* 16E610 8018D700 26D66DD0 */     addiu $s6, $s6, %lo(dFighterDefaultSpawn)
  ...
  /* 16E668 8018D758 8EAB0000 */        lw $t3, ($s5) # gBattleState + 0
  /* 16E66C 8018D75C 3C0E8004 */       lui $t6, %hi(gPlayerControllers)
  /* 16E670 8018D760 25CE5228 */     addiu $t6, $t6, %lo(gPlayerControllers)
  ...
  /* 16E68C 8018D77C 0C035E1B */       jal ftManager_SetFileDataKind
  /* 16E690 8018D780 92040023 */       lbu $a0, 0x23($s0) # D_ovl43_8018E1F0 + 35
  /* 16E694 8018D784 8EA20000 */        lw $v0, ($s5) # gBattleState + 0
  ...
  /* 16E708 8018D7F8 0C035E2D */       jal ftManager_AllocAnimHeapKind
...
glabel func_ovl43_8018D870
  ...
  /* 16E798 8018D888 AD6E0000 */        sw $t6, ($t3) # gDisplayListHead + 0
  /* 16E79C 8018D88C AC600004 */        sw $zero, 4($v1)
  /* 16E7A0 8018D890 AC6C0000 */        sw $t4, ($v1)
  /* 16E7A4 8018D894 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16E7B4 8018D8A4 AD6F0000 */        sw $t7, ($t3) # gDisplayListHead + 0
  /* 16E7B8 8018D8A8 AC600004 */        sw $zero, 4($v1)
  /* 16E7BC 8018D8AC AC780000 */        sw $t8, ($v1)
  /* 16E7C0 8018D8B0 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16E7F0 8018D8E0 AD780000 */        sw $t8, ($t3) # gDisplayListHead + 0
  ...
  /* 16E804 8018D8F4 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16E814 8018D904 AD6F0000 */        sw $t7, ($t3) # gDisplayListHead + 0
  ...
  /* 16E828 8018D918 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16E838 8018D928 AD790000 */        sw $t9, ($t3) # gDisplayListHead + 0
  ...
  /* 16E84C 8018D93C 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  ...
  /* 16E85C 8018D94C AD780000 */        sw $t8, ($t3) # gDisplayListHead + 0
  /* 16E860 8018D950 AC600004 */        sw $zero, 4($v1)
  /* 16E864 8018D954 AC6C0000 */        sw $t4, ($v1)
  /* 16E868 8018D958 8D630000 */        lw $v1, ($t3) # gDisplayListHead + 0
  /* 16E86C 8018D95C 24790008 */     addiu $t9, $v1, 8
  /* 16E870 8018D960 AD790000 */        sw $t9, ($t3) # gDisplayListHead + 0
...
glabel func_ovl43_8018DA8C
  ...
  /* 16EA24 8018DB14 0C035FCF */       jal ftManager_MakeFighter
...
glabel func_ovl43_8018DE84
  ...
  /* 16EDAC 8018DE9C 244250E8 */     addiu $v0, $v0, %lo(gBattleState)
  ...
  /* 16EEB8 8018DFA8 0C001260 */       jal hlMemoryAlloc
...
glabel func_ovl43_8018E00C
  ...
  /* 16EF50 8018E040 0C03F2DC */       jal ftRender_Lights_DisplayLightReflect
