...
glabel mvOpeningYoshiNestSetupDisplayList
  ...
  /* 16FD80 80131B40 0C03F2DC */       jal ftRender_Lights_DisplayLightReflect
...
glabel mvOpeningYoshiNestCreateNest
  ...
  /* 16FDDC 80131B9C 3C058001 */       lui $a1, %hi(odRenderDObjTreeDLLinksForGObj)
  /* 16FDE0 80131BA0 2418FFFF */     addiu $t8, $zero, -1
  /* 16FDE4 80131BA4 AFB80010 */        sw $t8, 0x10($sp)
  /* 16FDE8 80131BA8 24A54768 */     addiu $a1, $a1, %lo(odRenderDObjTreeDLLinksForGObj)
  /* 16FDEC 80131BAC 02002025 */        or $a0, $s0, $zero
  /* 16FDF0 80131BB0 24060006 */     addiu $a2, $zero, 6
  /* 16FDF4 80131BB4 0C00277D */       jal omAddGObjRenderProc
...
glabel mvOpeningYoshiNestCreateFighters
  ...
  /* 16FF0C 80131CCC 0C035FCF */       jal ftManagerMakeFighter
...
glabel mvOpeningYoshiNestCreateBackground
  ...
  /* 16FFB0 80131D70 0C00277D */       jal omAddGObjRenderProc
  ...
  /* 16FFCC 80131D8C 0C0333F7 */       jal gcAppendSObjWithSprite
...
glabel mvOpeningYoshiNestCreateStageObjects
  ...
  /* 17003C 80131DFC 3C058001 */       lui $a1, %hi(odRenderDObjTreeDLLinksForGObj)
  /* 170040 80131E00 2418FFFF */     addiu $t8, $zero, -1
  /* 170044 80131E04 AFB80010 */        sw $t8, 0x10($sp)
  /* 170048 80131E08 24A54768 */     addiu $a1, $a1, %lo(odRenderDObjTreeDLLinksForGObj)
  /* 17004C 80131E0C 02002025 */        or $a0, $s0, $zero
  /* 170050 80131E10 24060006 */     addiu $a2, $zero, 6
  /* 170054 80131E14 0C00277D */       jal omAddGObjRenderProc
...
glabel mvOpeningYoshiNestInit
  ...
  /* 1703A4 80132164 0C0337DE */       jal rdManagerInitSetup
  ...
  /* 1703B8 80132178 0C0337BB */       jal rdManagerGetAllocSize
  /* 1703BC 8013217C 24050002 */     addiu $a1, $zero, 2
  /* 1703C0 80132180 00402025 */        or $a0, $v0, $zero
  /* 1703C4 80132184 0C001260 */       jal gsMemoryAlloc
  ...
  /* 170434 801321F4 0C035C65 */       jal ftManagerAllocFighter
  /* 170438 801321F8 24050004 */     addiu $a1, $zero, 4
  /* 17043C 801321FC 0C035E1B */       jal ftManagerSetupDataKind
  ...
  /* 17044C 8013220C 3C118013 */       lui $s1, %hi(gFTAnimHeapSize)
  /* 170450 80132210 26310D9C */     addiu $s1, $s1, %lo(gFTAnimHeapSize)
  ...
  .L8013221C:
  /* 17045C 8013221C 8E240000 */        lw $a0, ($s1) # gFTAnimHeapSize + 0
...
glabel intro_yoshi_nest_entry
  ...
  /* 17054C 8013230C 0C001A0F */       jal gsGTLSceneInit
