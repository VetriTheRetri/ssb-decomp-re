...
glabel mnDebugMenuUpdateMenuInputs
  /* 1AB6B0 80369240 3C038004 */       lui $v1, %hi(gSysController + 8)
  /* 1AB6B4 80369244 80635478 */        lb $v1, %lo(gSysController + 8)($v1)
  /* 1AB6B8 80369248 3C068037 */       lui $a2, %hi(gMNDebugMenuPreviousInputs)
  ...
  /* 1AB6C8 80369258 24C69FCC */     addiu $a2, $a2, %lo(gMNDebugMenuPreviousInputs)
  ...
  /* 1AB6D8 80369268 3C038004 */       lui $v1, %hi(gSysController + 9)
  /* 1AB6DC 8036926C 34420200 */       ori $v0, $v0, 0x200
  /* 1AB6E0 80369270 3042FFFF */      andi $v0, $v0, 0xffff
  .L80369274:
  /* 1AB6E4 80369274 80635479 */        lb $v1, %lo(gSysController + 9)($v1)
  ...
  /* 1AB708 80369298 3C038037 */       lui $v1, %hi(gMNDebugMenuRapidScrollWait)
  /* 1AB70C 8036929C 34420400 */       ori $v0, $v0, 0x400
  /* 1AB710 803692A0 3042FFFF */      andi $v0, $v0, 0xffff
  .L803692A4:
  /* 1AB714 803692A4 94CE0000 */       lhu $t6, ($a2) # gMNDebugMenuPreviousInputs + 0
  /* 1AB718 803692A8 3C058037 */       lui $a1, %hi(gMNDebugMenuNewInputs)
  /* 1AB71C 803692AC 24A59FD0 */     addiu $a1, $a1, %lo(gMNDebugMenuNewInputs)
  /* 1AB720 803692B0 004E2026 */       xor $a0, $v0, $t6
  /* 1AB724 803692B4 00827824 */       and $t7, $a0, $v0
  /* 1AB728 803692B8 10800006 */      beqz $a0, .L803692D4
  /* 1AB72C 803692BC A4AF0000 */        sh $t7, ($a1) # gMNDebugMenuNewInputs + 0
  /* 1AB730 803692C0 3C018037 */       lui $at, %hi(gMNDebugMenuStickInputs)
  /* 1AB734 803692C4 24639FD8 */     addiu $v1, $v1, %lo(gMNDebugMenuRapidScrollWait)
  /* 1AB738 803692C8 A42F9FD4 */        sh $t7, %lo(gMNDebugMenuStickInputs)($at)
  /* 1AB73C 803692CC 1000000E */         b .L80369308
  /* 1AB740 803692D0 AC790000 */        sw $t9, ($v1) # gMNDebugMenuRapidScrollWait + 0
  .L803692D4:
  /* 1AB744 803692D4 3C038037 */       lui $v1, %hi(gMNDebugMenuRapidScrollWait)
  /* 1AB748 803692D8 24639FD8 */     addiu $v1, $v1, %lo(gMNDebugMenuRapidScrollWait)
  /* 1AB74C 803692DC 8C680000 */        lw $t0, ($v1) # gMNDebugMenuRapidScrollWait + 0
  /* 1AB750 803692E0 2509FFFF */     addiu $t1, $t0, -1
  /* 1AB754 803692E4 19200004 */      blez $t1, .L803692F8
  /* 1AB758 803692E8 AC690000 */        sw $t1, ($v1) # gMNDebugMenuRapidScrollWait + 0
  /* 1AB75C 803692EC 3C018037 */       lui $at, %hi(gMNDebugMenuStickInputs)
  /* 1AB760 803692F0 10000005 */         b .L80369308
  /* 1AB764 803692F4 A4209FD4 */        sh $zero, %lo(gMNDebugMenuStickInputs)($at)
  .L803692F8:
  /* 1AB768 803692F8 3C018037 */       lui $at, %hi(gMNDebugMenuStickInputs)
  /* 1AB76C 803692FC A4229FD4 */        sh $v0, %lo(gMNDebugMenuStickInputs)($at)
  /* 1AB770 80369300 240B0005 */     addiu $t3, $zero, 5
  /* 1AB774 80369304 AC6B0000 */        sw $t3, ($v1) # gMNDebugMenuRapidScrollWait + 0
  .L80369308:
  /* 1AB778 80369308 03E00008 */        jr $ra
  /* 1AB77C 8036930C A4C20000 */        sh $v0, ($a2) # gMNDebugMenuPreviousInputs + 0

glabel mnDebugMenuDrawString
...
glabel mnDebugMenuDrawBorder
  ...
  /* 1AB7E4 80369374 3C118037 */       lui $s1, %hi(gMNDebugMenuMenuPosition)
  /* 1AB7E8 80369378 26319F7C */     addiu $s1, $s1, %lo(gMNDebugMenuMenuPosition)
  ...
  /* 1AB7FC 8036938C 962F0006 */       lhu $t7, 6($s1) # gMNDebugMenuMenuPosition + 6
  ...
  /* 1AB828 803693B8 96380004 */       lhu $t8, 4($s1) # gMNDebugMenuMenuPosition + 4
  ...
  /* 1AB84C 803693DC 96280006 */       lhu $t0, 6($s1) # gMNDebugMenuMenuPosition + 6
  ...
  /* 1AB874 80369404 962B0004 */       lhu $t3, 4($s1) # gMNDebugMenuMenuPosition + 4
  /* 1AB878 80369408 962E0006 */       lhu $t6, 6($s1) # gMNDebugMenuMenuPosition + 6
...
glabel mnDebugMenuDrawBackground
  ...
  /* 1AB8D0 80369460 3C058037 */       lui $a1, %hi(gMNDebugMenuMenuPosition)
  /* 1AB8D4 80369464 AFA20024 */        sw $v0, 0x24($sp)
  /* 1AB8D8 80369468 24A59F7C */     addiu $a1, $a1, %lo(gMNDebugMenuMenuPosition)
  /* 1AB8DC 8036946C 0C0DD295 */       jal func_ovl8_80374A54
  /* 1AB8E0 80369470 8FA40028 */        lw $a0, 0x28($sp)
  /* 1AB8E4 80369474 3C028037 */       lui $v0, %hi(gMNDebugMenuMenuPosition)
  /* 1AB8E8 80369478 24429F7C */     addiu $v0, $v0, %lo(gMNDebugMenuMenuPosition)
  /* 1AB8EC 8036947C 94580004 */       lhu $t8, 4($v0) # gMNDebugMenuMenuPosition + 4
  /* 1AB8F0 80369480 94480006 */       lhu $t0, 6($v0) # gMNDebugMenuMenuPosition + 6
...
glabel mnDebugMenuDrawMenuItem
  ...
  /* 1AB978 80369508 0C0DA4C4 */       jal mnDebugMenuDrawString
  ...
  /* 1AB99C 8036952C 0C0DA4C4 */       jal mnDebugMenuDrawString
  ...
  /* 1AB9C0 80369550 0C0DA4C4 */       jal mnDebugMenuDrawString
  ...
  /* 1AB9F4 80369584 0C0DA4C4 */       jal mnDebugMenuDrawString
  ...
  /* 1ABA24 803695B4 0C0DA4C4 */       jal mnDebugMenuDrawString
  ...
  /* 1ABA54 803695E4 0C0DA4C4 */       jal mnDebugMenuDrawString
...
glabel mnDebugMenuDrawMenuItems
  ...
  /* 1ABABC 8036964C 0C0DA532 */       jal mnDebugMenuDrawMenuItem
...
glabel gMNDebugMenuRenderMenu
  /* 1ABB44 803696D4 3C028037 */       lui $v0, %hi(gMNDebugMenuRedrawInterrupt)
  /* 1ABB48 803696D8 2442141C */     addiu $v0, $v0, %lo(gMNDebugMenuRedrawInterrupt)
  /* 1ABB4C 803696DC 8C4E0000 */        lw $t6, ($v0) # gMNDebugMenuRedrawInterrupt + 0
  ...
  /* 1ABB7C 8036970C 3C058037 */       lui $a1, %hi(gMNDebugMenuMenuItems)
  /* 1ABB80 80369710 3C068037 */       lui $a2, %hi(gMNDebugMenuMenuItemsCount)
  /* 1ABB84 80369714 8CC61410 */        lw $a2, %lo(gMNDebugMenuMenuItemsCount)($a2)
  /* 1ABB88 80369718 8CA5140C */        lw $a1, %lo(gMNDebugMenuMenuItems)($a1)
  /* 1ABB8C 8036971C 0C0DA580 */       jal mnDebugMenuDrawMenuItems
  /* 1ABB90 80369720 8C841404 */        lw $a0, %lo(D_ovl9_80371404)($a0)
  /* 1ABB94 80369724 3C048037 */       lui $a0, %hi(D_ovl9_80371404)
  /* 1ABB98 80369728 3C058037 */       lui $a1, %hi(gMNDebugMenuCursorIndex)
  /* 1ABB9C 8036972C 8CA51414 */        lw $a1, %lo(gMNDebugMenuCursorIndex)($a1)
...
glabel mnDebugMenuHandleInputs
  /* 1ABBCC 8036975C 27BDFFE8 */     addiu $sp, $sp, -0x18
  /* 1ABBD0 80369760 AFBF0014 */        sw $ra, 0x14($sp)
  /* 1ABBD4 80369764 0C0DA490 */       jal mnDebugMenuUpdateMenuInputs
  /* 1ABBD8 80369768 AFA40018 */        sw $a0, 0x18($sp)
  /* 1ABBDC 8036976C 3C048004 */       lui $a0, %hi(gSysController + 4)
  /* 1ABBE0 80369770 94845474 */       lhu $a0, %lo(gSysController + 4)($a0)
  /* 1ABBE4 80369774 3C088037 */       lui $t0, %hi(gMNDebugMenuStickInputs)
  /* 1ABBE8 80369778 25089FD4 */     addiu $t0, $t0, %lo(gMNDebugMenuStickInputs)
  ...
  /* 1ABBF8 80369788 950F0000 */       lhu $t7, ($t0) # gMNDebugMenuStickInputs + 0
  /* 1ABBFC 8036978C 31F80800 */      andi $t8, $t7, 0x800
  /* 1ABC00 80369790 13000011 */      beqz $t8, .L803697D8
  .L80369794:
  /* 1ABC04 80369794 3C058037 */       lui $a1, %hi(gMNDebugMenuCursorIndex)
  /* 1ABC08 80369798 24A51414 */     addiu $a1, $a1, %lo(gMNDebugMenuCursorIndex)
  /* 1ABC0C 8036979C 8CA20000 */        lw $v0, ($a1) # gMNDebugMenuCursorIndex + 0
  /* 1ABC10 803697A0 3C088037 */       lui $t0, %hi(gMNDebugMenuStickInputs)
  /* 1ABC14 803697A4 25089FD4 */     addiu $t0, $t0, %lo(gMNDebugMenuStickInputs)
  /* 1ABC18 803697A8 18400004 */      blez $v0, .L803697BC
  /* 1ABC1C 803697AC 3C068037 */       lui $a2, %hi(gMNDebugMenuRedrawInterrupt)
  /* 1ABC20 803697B0 2459FFFF */     addiu $t9, $v0, -1
  /* 1ABC24 803697B4 10000005 */         b .L803697CC
  /* 1ABC28 803697B8 ACB90000 */        sw $t9, ($a1) # gMNDebugMenuCursorIndex + 0
  .L803697BC:
  /* 1ABC2C 803697BC 3C0B8037 */       lui $t3, %hi(gMNDebugMenuMenuItemsCount)
  /* 1ABC30 803697C0 8D6B1410 */        lw $t3, %lo(gMNDebugMenuMenuItemsCount)($t3)
  /* 1ABC34 803697C4 256CFFFF */     addiu $t4, $t3, -1
  /* 1ABC38 803697C8 ACAC0000 */        sw $t4, ($a1) # gMNDebugMenuCursorIndex + 0
  .L803697CC:
  /* 1ABC3C 803697CC 24C6141C */     addiu $a2, $a2, %lo(gMNDebugMenuRedrawInterrupt)
  /* 1ABC40 803697D0 24070001 */     addiu $a3, $zero, 1
  /* 1ABC44 803697D4 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  .L803697D8:
  /* 1ABC48 803697D8 3C058037 */       lui $a1, %hi(gMNDebugMenuCursorIndex)
  /* 1ABC4C 803697DC 3C068037 */       lui $a2, %hi(gMNDebugMenuRedrawInterrupt)
  /* 1ABC50 803697E0 24C6141C */     addiu $a2, $a2, %lo(gMNDebugMenuRedrawInterrupt)
  /* 1ABC54 803697E4 24A51414 */     addiu $a1, $a1, %lo(gMNDebugMenuCursorIndex)
  /* 1ABC58 803697E8 15A00004 */      bnez $t5, .L803697FC
  /* 1ABC5C 803697EC 24070001 */     addiu $a3, $zero, 1
  /* 1ABC60 803697F0 950E0000 */       lhu $t6, ($t0) # gMNDebugMenuStickInputs + 0
  /* 1ABC64 803697F4 31CF0400 */      andi $t7, $t6, 0x400
  /* 1ABC68 803697F8 11E0000C */      beqz $t7, .L8036982C
  .L803697FC:
  /* 1ABC6C 803697FC 3C188037 */       lui $t8, %hi(gMNDebugMenuMenuItemsCount)
  /* 1ABC70 80369800 8F181410 */        lw $t8, %lo(gMNDebugMenuMenuItemsCount)($t8)
  /* 1ABC74 80369804 8CA20000 */        lw $v0, ($a1) # gMNDebugMenuCursorIndex + 0
  ...
  /* 1ABC88 80369818 ACCB0000 */        sw $t3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  /* 1ABC8C 8036981C 244C0001 */     addiu $t4, $v0, 1
  /* 1ABC90 80369820 10000002 */         b .L8036982C
  /* 1ABC94 80369824 ACAC0000 */        sw $t4, ($a1) # gMNDebugMenuCursorIndex + 0
  .L80369828:
  /* 1ABC98 80369828 ACA00000 */        sw $zero, ($a1) # gMNDebugMenuCursorIndex + 0
  .L8036982C:
  /* 1ABC9C 8036982C 30820200 */      andi $v0, $a0, 0x200
  /* 1ABCA0 80369830 54400006 */      bnel $v0, $zero, .L8036984C
  /* 1ABCA4 80369834 8CB80000 */        lw $t8, ($a1) # gMNDebugMenuCursorIndex + 0
  /* 1ABCA8 80369838 950D0000 */       lhu $t5, ($t0) # gMNDebugMenuStickInputs + 0
  /* 1ABCAC 8036983C 31AE0200 */      andi $t6, $t5, 0x200
  /* 1ABCB0 80369840 11C00071 */      beqz $t6, jtgt_ovl9_80369A08
  /* 1ABCB4 80369844 00000000 */       nop
  /* 1ABCB8 80369848 8CB80000 */        lw $t8, ($a1) # gMNDebugMenuCursorIndex + 0
  .L8036984C:
  /* 1ABCBC 8036984C 240A001C */     addiu $t2, $zero, 0x1c
  /* 1ABCC0 80369850 3C098037 */       lui $t1, %hi(gMNDebugMenuMenuItems)
  /* 1ABCC4 80369854 030A0019 */     multu $t8, $t2
  /* 1ABCC8 80369858 2529140C */     addiu $t1, $t1, %lo(gMNDebugMenuMenuItems)
  /* 1ABCCC 8036985C 8D2F0000 */        lw $t7, ($t1) # gMNDebugMenuMenuItems + 0
  ...
  .L803698D4:
  /* 1ABD44 803698D4 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  /* 1ABD48 803698D8 3C048004 */       lui $a0, %hi(gSysController + 4)
  /* 1ABD4C 803698DC 1000004A */         b jtgt_ovl9_80369A08
  /* 1ABD50 803698E0 94845474 */       lhu $a0, %lo(gSysController + 4)($a0)
  ...
  /* 1ABD88 80369918 3C048004 */       lui $a0, %hi(gSysController + 4)
  ...
  .L803699B4:
  /* 1ABE24 803699B4 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  /* 1ABE28 803699B8 10000013 */         b jtgt_ovl9_80369A08
  /* 1ABE2C 803699BC 94845474 */       lhu $a0, %lo(gSysController + 4)($a0)
  ...
  /* 1ABE4C 803699DC 3C048004 */       lui $a0, %hi(gSysController + 4)
  ...
  .L80369A00:
  /* 1ABE70 80369A00 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  /* 1ABE74 80369A04 94845474 */       lhu $a0, %lo(gSysController + 4)($a0)
  glabel jtgt_ovl9_80369A08
  /* 1ABE78 80369A08 3C098037 */       lui $t1, %hi(gMNDebugMenuMenuItems)
  /* 1ABE7C 80369A0C 30820100 */      andi $v0, $a0, 0x100
  /* 1ABE80 80369A10 2529140C */     addiu $t1, $t1, %lo(gMNDebugMenuMenuItems)
  /* 1ABE84 80369A14 14400005 */      bnez $v0, .L80369A2C
  /* 1ABE88 80369A18 240A001C */     addiu $t2, $zero, 0x1c
  /* 1ABE8C 80369A1C 950C0000 */       lhu $t4, ($t0) # gMNDebugMenuStickInputs + 0
  /* 1ABE90 80369A20 318D0100 */      andi $t5, $t4, 0x100
  /* 1ABE94 80369A24 11A00069 */      beqz $t5, jtgt_ovl9_80369BCC
  /* 1ABE98 80369A28 00000000 */       nop
  .L80369A2C:
  /* 1ABE9C 80369A2C 8CB80000 */        lw $t8, ($a1) # gMNDebugMenuCursorIndex + 0
  /* 1ABEA0 80369A30 8D2E0000 */        lw $t6, ($t1) # gMNDebugMenuMenuItems + 0
  ...
  /* 1ABF20 80369AB0 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  ...
  /* 1ABFF8 80369B88 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  ...
  .L80369BC8:
  /* 1AC038 80369BC8 ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  glabel jtgt_ovl9_80369BCC
  /* 1AC03C 80369BCC 3C028004 */       lui $v0, %hi(gSysController + 8)
  /* 1AC040 80369BD0 80425478 */        lb $v0, %lo(gSysController + 8)($v0)
  /* 1AC044 80369BD4 3C0E8004 */       lui $t6, %hi(gSysController + 2)
  ...
  /* 1AC064 80369BF4 8CAC0000 */        lw $t4, ($a1) # gMNDebugMenuCursorIndex + 0
  /* 1AC068 80369BF8 8D2B0000 */        lw $t3, ($t1) # gMNDebugMenuMenuItems + 0
  ...
  .L80369C8C:
  /* 1AC0FC 80369C8C ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  .L80369C90:
  /* 1AC100 80369C90 95CE5472 */       lhu $t6, %lo(gSysController + 2)($t6)
  ...
  /* 1AC190 80369D20 3C068037 */       lui $a2, %hi(gMNDebugMenuRedrawInterrupt)
  /* 1AC194 80369D24 24C6141C */     addiu $a2, $a2, %lo(gMNDebugMenuRedrawInterrupt)
  /* 1AC198 80369D28 24070001 */     addiu $a3, $zero, 1
  /* 1AC19C 80369D2C ACC70000 */        sw $a3, ($a2) # gMNDebugMenuRedrawInterrupt + 0
  .L80369D30:
  /* 1AC1A0 80369D30 3C198004 */       lui $t9, %hi(gSysController + 2)
  /* 1AC1A4 80369D34 97395472 */       lhu $t9, %lo(gSysController + 2)($t9)
...
glabel mnDebugMenuCreateMenu
  /* 1AC1E8 80369D78 3C088037 */       lui $t0, %hi(gMNDebugMenuIsMenuOpen)
  /* 1AC1EC 80369D7C 25081420 */     addiu $t0, $t0, %lo(gMNDebugMenuIsMenuOpen)
  /* 1AC1F0 80369D80 8D0E0000 */        lw $t6, ($t0) # gMNDebugMenuIsMenuOpen + 0
  ...
  /* 1AC210 80369DA0 AD0F0000 */        sw $t7, ($t0) # gMNDebugMenuIsMenuOpen + 0
  /* 1AC214 80369DA4 3C018037 */       lui $at, %hi(gMNDebugMenuMenuItems)
  /* 1AC218 80369DA8 AC27140C */        sw $a3, %lo(gMNDebugMenuMenuItems)($at)
  /* 1AC21C 80369DAC 3C018037 */       lui $at, %hi(gMNDebugMenuMenuItemsCount)
  /* 1AC220 80369DB0 3C038037 */       lui $v1, %hi(gMNDebugMenuRedrawInterrupt)
  /* 1AC224 80369DB4 AC221410 */        sw $v0, %lo(gMNDebugMenuMenuItemsCount)($at)
  /* 1AC228 80369DB8 2463141C */     addiu $v1, $v1, %lo(gMNDebugMenuRedrawInterrupt)
  /* 1AC22C 80369DBC AC600000 */        sw $zero, ($v1) # gMNDebugMenuRedrawInterrupt + 0
  ...
  /* 1AC25C 80369DEC A4850002 */        sh $a1, 2($a0) # gMNDebugMenuMenuPosition + 2
  /* 1AC260 80369DF0 A4860004 */        sh $a2, 4($a0) # gMNDebugMenuMenuPosition + 4
  /* 1AC264 80369DF4 A48C0006 */        sh $t4, 6($a0) # gMNDebugMenuMenuPosition + 6
  /* 1AC268 80369DF8 0C0E0720 */       jal func_ovl8_80381C80
  /* 1AC26C 80369DFC A48A0000 */        sh $t2, ($a0) # gMNDebugMenuMenuPosition + 0
  ...
  /* 1AC2AC 80369E3C 0C0DA580 */       jal mnDebugMenuDrawMenuItems
  /* 1AC2B0 80369E40 8FA60028 */        lw $a2, 0x28($sp)
  /* 1AC2B4 80369E44 3C048037 */       lui $a0, %hi(D_ovl9_80371404)
  /* 1AC2B8 80369E48 3C058037 */       lui $a1, %hi(gMNDebugMenuCursorIndex)
...
glabel mnDebugMenuInitMenu
  ...
  /* 1AC3B8 80369F48 3C018037 */       lui $at, %hi(gMNDebugMenuIsMenuOpen)
  /* 1AC3BC 80369F4C AC201420 */        sw $zero, %lo(gMNDebugMenuIsMenuOpen)($at)
...
#glabel gMNDebugMenuMenuPosition   # Routine parsed as data
