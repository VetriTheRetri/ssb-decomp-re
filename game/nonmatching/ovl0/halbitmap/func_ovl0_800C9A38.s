...
glabel func_ovl0_800C9A38
  ...
  /* 045934 800C9F54 0C0067A8 */       jal hlMtxF2LFixedW
  ...
  /* 045980 800C9FA0 3C038013 */       lui $v1, %hi(ftRender_HitShuffle_Offsets)
  /* 045984 800C9FA4 2463B930 */     addiu $v1, $v1, %lo(ftRender_HitShuffle_Offsets)
  ...
  .L800CA008:
  /* 0459E8 800CA008 0C0067A8 */       jal hlMtxF2LFixedW
  ...
  .L800CB1AC:
  /* 046B8C 800CB1AC 0C008D89 */       jal gsFatalPrintF
  /* 046B90 800CB1B0 02002025 */        or $a0, $s0, $zero
  /* 046B94 800CB1B4 0C028C10 */       jal scnmgr_scManagerCrashPrintGObjStatus
  ...
  /* 046BAC 800CB1CC 3C0E8004 */       lui $t6, %hi(gOMObjCurrentRendering)
  /* 046BB0 800CB1D0 46028083 */     div.s $f2, $f16, $f2
  /* 046BB4 800CB1D4 8DCE6A58 */        lw $t6, %lo(gOMObjCurrentRendering)($t6)
  ...
  /* 046CB4 800CB2D4 0C0067A8 */       jal hlMtxF2LFixedW
