...
glabel func_ovl0_800CB360
  ...
  /* 046D54 800CB374 3C018004 */       lui $at, %hi(gSpriteLayerScale)
  /* 046D58 800CB378 31CF0002 */      andi $t7, $t6, 2
  /* 046D5C 800CB37C 15E0003C */      bnez $t7, .L800CB470
  /* 046D60 800CB380 3C048004 */       lui $a0, %hi(gDisplayListHead + 4)
  /* 046D64 800CB384 C4246FA4 */      lwc1 $f4, %lo(gSpriteLayerScale)($at)
  ...
  /* 046D94 800CB3B4 3C058004 */       lui $a1, %hi(gDisplayListHead + 4)
  /* 046D98 800CB3B8 24A565B4 */     addiu $a1, $a1, %lo(gDisplayListHead + 4)
  ...
  .L800CB3FC:
  /* 046DDC 800CB3FC 3C058004 */       lui $a1, %hi(gDisplayListHead)
  /* 046DE0 800CB400 24A565B0 */     addiu $a1, $a1, %lo(gDisplayListHead)
  ...
  /* 046DF4 800CB414 3C058004 */       lui $a1, %hi(gDisplayListHead)
  /* 046DF8 800CB418 24A565B0 */     addiu $a1, $a1, %lo(gDisplayListHead)
  ...
  /* 046E18 800CB438 8CA30004 */        lw $v1, 4($a1) # gDisplayListHead + 4
  ...
  /* 046E28 800CB448 8CA30004 */        lw $v1, 4($a1) # gDisplayListHead + 4
  .L800CB44C:
  ...
  /* 046E38 800CB458 ACAE0004 */        sw $t6, 4($a1) # gDisplayListHead + 4
  /* 046E3C 800CB45C AC780004 */        sw $t8, 4($v1)
  /* 046E40 800CB460 AC6F0000 */        sw $t7, ($v1)
  /* 046E44 800CB464 C7A60024 */      lwc1 $f6, 0x24($sp)
  .L800CB468:
  /* 046E48 800CB468 3C018004 */       lui $at, %hi(gSpriteLayerScale)
  /* 046E4C 800CB46C E4266FA4 */      swc1 $f6, %lo(gSpriteLayerScale)($at)
  .L800CB470:
