...
glabel func_ovl0_800CD440
  ...
  /* 048E40 800CD460 3C0E8004 */       lui $t6, %hi(dOMOrthoDefault)
  /* 048E44 800CD464 25CEB894 */     addiu $t6, $t6, %lo(dOMOrthoDefault)
  /* 048E48 800CD468 8FA40018 */        lw $a0, 0x18($sp)
  /* 048E4C 800CD46C 8DD80000 */        lw $t8, ($t6) # dOMOrthoDefault + 0
  /* 048E50 800CD470 AC980018 */        sw $t8, 0x18($a0)
  /* 048E54 800CD474 8DCF0004 */        lw $t7, 4($t6) # dOMOrthoDefault + 4
  /* 048E58 800CD478 AC8F001C */        sw $t7, 0x1c($a0)
  /* 048E5C 800CD47C 8DD80008 */        lw $t8, 8($t6) # dOMOrthoDefault + 8
  /* 048E60 800CD480 AC980020 */        sw $t8, 0x20($a0)
  /* 048E64 800CD484 8DCF000C */        lw $t7, 0xc($t6) # dOMOrthoDefault + 12
  /* 048E68 800CD488 AC8F0024 */        sw $t7, 0x24($a0)
  /* 048E6C 800CD48C 8DD80010 */        lw $t8, 0x10($t6) # dOMOrthoDefault + 16
  /* 048E70 800CD490 AC980028 */        sw $t8, 0x28($a0)
  /* 048E74 800CD494 8DCF0014 */        lw $t7, 0x14($t6) # dOMOrthoDefault + 20
  /* 048E78 800CD498 AC8F002C */        sw $t7, 0x2c($a0)
  /* 048E7C 800CD49C 8DD80018 */        lw $t8, 0x18($t6) # dOMOrthoDefault + 24
  /* 048E80 800CD4A0 AC980030 */        sw $t8, 0x30($a0)
  /* 048E84 800CD4A4 8DCF001C */        lw $t7, 0x1c($t6) # dOMOrthoDefault + 28
  ...
  /* 048EC0 800CD4E0 3C0E8004 */       lui $t6, %hi(dOMPerspDefault)
  /* 048EC4 800CD4E4 25CEB878 */     addiu $t6, $t6, %lo(dOMPerspDefault)
  /* 048EC8 800CD4E8 8FA40018 */        lw $a0, 0x18($sp)
  /* 048ECC 800CD4EC 8DD80000 */        lw $t8, ($t6) # dOMPerspDefault + 0
  /* 048ED0 800CD4F0 AC980018 */        sw $t8, 0x18($a0)
  /* 048ED4 800CD4F4 8DCF0004 */        lw $t7, 4($t6) # dOMPerspDefault + 4
  /* 048ED8 800CD4F8 AC8F001C */        sw $t7, 0x1c($a0)
  /* 048EDC 800CD4FC 8DD80008 */        lw $t8, 8($t6) # dOMPerspDefault + 8
  /* 048EE0 800CD500 AC980020 */        sw $t8, 0x20($a0)
  /* 048EE4 800CD504 8DCF000C */        lw $t7, 0xc($t6) # dOMPerspDefault + 12
  /* 048EE8 800CD508 AC8F0024 */        sw $t7, 0x24($a0)
  /* 048EEC 800CD50C 8DD80010 */        lw $t8, 0x10($t6) # dOMPerspDefault + 16
  /* 048EF0 800CD510 AC980028 */        sw $t8, 0x28($a0)
  /* 048EF4 800CD514 8DCF0014 */        lw $t7, 0x14($t6) # dOMPerspDefault + 20
  /* 048EF8 800CD518 AC8F002C */        sw $t7, 0x2c($a0)
  /* 048EFC 800CD51C 8DD80018 */        lw $t8, 0x18($t6) # dOMPerspDefault + 24
