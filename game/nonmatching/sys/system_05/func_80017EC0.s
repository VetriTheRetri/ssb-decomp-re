...
glabel func_80017EC0
  ...
  /* 018AF0 80017EF0 3C108004 */       lui $s0, %hi(gDisplayListHead)
  /* 018AF4 80017EF4 261065B0 */     addiu $s0, $s0, %lo(gDisplayListHead)
  ...
  /* 018B0C 80017F0C 8E110000 */        lw $s1, ($s0) # gDisplayListHead + 0
  ...
  /* 018B24 80017F24 8E0F0000 */        lw $t7, ($s0) # gDisplayListHead + 0
  ...
  /* 018B58 80017F58 AE090000 */        sw $t1, ($s0) # gDisplayListHead + 0
  ...
  /* 018B74 80017F74 8E0C0000 */        lw $t4, ($s0) # gDisplayListHead + 0
  ...
  /* 018B88 80017F88 3C048004 */       lui $a0, %hi(gDisplayListHead + 4)
  /* 018B8C 80017F8C 248465B4 */     addiu $a0, $a0, %lo(gDisplayListHead + 4)
  ...
  .L80017FA4:
  /* 018BA4 80017FA4 3C118004 */       lui $s1, %hi(gDisplayListHead + 4)
  ...
  /* 018BB8 80017FB8 263165B4 */     addiu $s1, $s1, %lo(gDisplayListHead + 4)
  .L80017FBC:
  /* 018BBC 80017FBC 8E2F0000 */        lw $t7, ($s1) # gDisplayListHead + 4 + 0
  ...
  /* 018BD0 80017FD0 AE38FFFC */        sw $t8, -4($s1) # gDisplayListHead + 4 + -4
  ...
  /* 018C00 80018000 3C118004 */       lui $s1, %hi(gDisplayListHead + 4)
  /* 018C04 80018004 3C128004 */       lui $s2, %hi((D_800472B0 + 4))
  /* 018C08 80018008 265272B4 */     addiu $s2, $s2, %lo((D_800472B0 + 4))
  /* 018C0C 8001800C 263165B4 */     addiu $s1, $s1, %lo(gDisplayListHead + 4)
  ...
  /* 018C20 80018020 8E300000 */        lw $s0, ($s1) # gDisplayListHead + 4 + 0
  ...
  /* 018C38 80018038 AE2A0000 */        sw $t2, ($s1) # gDisplayListHead + 4 + 0
  .L8001803C:
  /* 018C3C 8001803C AE2B0000 */        sw $t3, ($s1) # gDisplayListHead + 4 + 0
  /* 018C40 80018040 AC560000 */        sw $s6, ($v0)
  /* 018C44 80018044 8E2C0000 */        lw $t4, ($s1) # gDisplayListHead + 4 + 0
  ...
  .L80018070:
  /* 018C70 80018070 8E300000 */        lw $s0, ($s1) # gDisplayListHead + 4 + 0
  ...
  /* 018C80 80018080 AE2F0000 */        sw $t7, ($s1) # gDisplayListHead + 4 + 0
