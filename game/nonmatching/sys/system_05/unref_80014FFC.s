...
glabel unref_80014FFC
  ...
  /* 015C24 80015024 3C018004 */       lui $at, %hi(gSpriteLayerScale)
  /* 015C28 80015028 E4246FA4 */      swc1 $f4, %lo(gSpriteLayerScale)($at)
  ...
  /* 015C54 80015054 0C0051E6 */       jal odGetDObjDistFromEye
  ...
  /* 015CB0 800150B0 0C00435C */       jal odRenderDObjMain
  ...
  /* 015CE0 800150E0 3C118004 */       lui $s1, %hi(gDisplayListHead)
  /* 015CE4 800150E4 1041004D */       beq $v0, $at, .L8001521C
  /* 015CE8 800150E8 263165B0 */     addiu $s1, $s1, %lo(gDisplayListHead)
  ...
  /* 015D8C 8001518C 3C148004 */       lui $s4, %hi(gGraphicsHeap + 12)
  /* 015D90 80015190 8E9465E4 */        lw $s4, %lo(gGraphicsHeap + 12)($s4)
  /* 015D94 80015194 02602025 */        or $a0, $s3, $zero
  /* 015D98 80015198 02302821 */      addu $a1, $s1, $s0
  /* 015D9C 8001519C AFA60034 */        sw $a2, 0x34($sp)
  /* 015DA0 800151A0 0C004B64 */       jal odRenderMObjForDObj
  ...
  .L80015220:
  /* 015E20 80015220 3C118004 */       lui $s1, %hi(gDisplayListHead)
  /* 015E24 80015224 263165B0 */     addiu $s1, $s1, %lo(gDisplayListHead)
