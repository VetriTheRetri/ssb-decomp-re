...
glabel update_global_contdata
  ...
  /* 004C3C 8000403C 3C018004 */       lui $at, %hi(gSysController + 2)
  ...
  /* 004C50 80004050 A42F5472 */        sh $t7, %lo(gSysController + 2)($at)
  /* 004C54 80004054 94580000 */       lhu $t8, ($v0)
  /* 004C58 80004058 3C018004 */       lui $at, %hi(gSysController)
  /* 004C5C 8000405C A4385470 */        sh $t8, %lo(gSysController)($at)
  /* 004C60 80004060 94590004 */       lhu $t9, 4($v0)
  /* 004C64 80004064 3C018004 */       lui $at, %hi(gSysController + 4)
  /* 004C68 80004068 A4395474 */        sh $t9, %lo(gSysController + 4)($at)
  /* 004C6C 8000406C 94490006 */       lhu $t1, 6($v0)
  /* 004C70 80004070 3C018004 */       lui $at, %hi(gSysController + 6)
  /* 004C74 80004074 A4295476 */        sh $t1, %lo(gSysController + 6)($at)
  /* 004C78 80004078 804A0008 */        lb $t2, 8($v0)
  /* 004C7C 8000407C 3C018004 */       lui $at, %hi(gSysController + 8)
  /* 004C80 80004080 A02A5478 */        sb $t2, %lo(gSysController + 8)($at)
  /* 004C84 80004084 804B0009 */        lb $t3, 9($v0)
  /* 004C88 80004088 3C018004 */       lui $at, %hi(gSysController + 9)
  /* 004C8C 8000408C 27BD0018 */     addiu $sp, $sp, 0x18
  /* 004C90 80004090 A02B5479 */        sb $t3, %lo(gSysController + 9)($at)
