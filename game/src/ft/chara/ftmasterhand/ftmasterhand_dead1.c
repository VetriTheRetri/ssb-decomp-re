...
{
    ftStatus_IfAnimEnd_ProcStatus(fighter_gobj, ftMasterHand_Dead2_SetStatus);
}
...
void ftMasterHand_Dead1_SetStatus(GObj *fighter_gobj)
{
    ...
    ftMain_SetFighterStatus(fighter_gobj, ftStatus_MasterHand_Dead1, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
