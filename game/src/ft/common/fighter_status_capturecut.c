...
// 0x80188A30
ftThrowReleaseDesc ftCommon_Catch_ReleaseKnockback   = { 361, 100, 30, 0 };  // Knockback suffered by throwing player

// 0x80188A40
ftThrowReleaseDesc ftCommon_Capture_ReleaseKnockback = { 361,  80,  0, 0 };  // Knockback suffered by caught player
...
void ftCommon_Shouldered_ProcInterrupt(GObj *fighter_gobj)
{
    ...
    {
        ftCommon_CatchCut_DamageApplyKnockback(capture_gobj, &ftCommon_Catch_ReleaseKnockback); // Deal knockback to player this fighter is caught by
        ftCommon_CaptureCut_DamageApplyKnockback(fighter_gobj, &ftCommon_Capture_ReleaseKnockback); // Deal knockback to this fighter
