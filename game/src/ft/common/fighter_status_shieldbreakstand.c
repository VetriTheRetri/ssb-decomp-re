...
{
    ftStatus_IfAnimEnd_ProcStatus(fighter_gobj, ftCommon_FuraFura_SetStatus);
}
...
void ftCommon_ShieldBreakStand_SetStatus(GObj *fighter_gobj)
{
    ...
    ftMain_SetFighterStatus(fighter_gobj, status_id, 0.0F, 1.0F, FTCOMMON_SHIELDBREAKSTAND_STATUPDATE_FLAGS);
}
