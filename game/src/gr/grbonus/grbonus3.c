...
void grBonus3_RBomb_MakeGround(void)
{
    ...
    omAddGObjCommonProc(omMakeGObjSPAfter(GObj_Kind_Ground, NULL, 1, 0x80000000U), grBonus3_RBomb_ProcUpdate, 1, 4);
...
{
    omAddGObjCommonProc(omMakeGObjSPAfter(GObj_Kind_Ground, NULL, 1, 0x80000000U), grBonus3_Finish_ProcUpdate, 1, 4);
}
