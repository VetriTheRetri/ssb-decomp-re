...
void mnBonusDrawTitleAndBack()
{
    ...
    gMnBonusTitleGObj = title_gobj = omMakeGObjSPAfter(0U, NULL, 0x17U, 0x80000000U);
...
void mnBonusDrawBestTime()
{
    ...
    {
        omEjectGObj(gMnBonusHighscoreGobj);
    ...
    if (ft_kind != Ft_Kind_Null)
    {
        ...
        gMnBonusHighscoreGobj = best_time_gobj = omMakeGObjSPAfter(0U, NULL, 0x17U, 0x80000000U);
...
void mnBonusDrawBestCount()
{
    ...
    if (ft_kind != Ft_Kind_Null)
    {
        gMnBonusHighscoreGobj = count_gobj = omMakeGObjSPAfter(0U, NULL, 0x17U, 0x80000000U);
...
void mnDrawBonusTotalTime()
{
    ...
    gMnBonusTotalTimeGobj = best_time_gobj = omMakeGObjSPAfter(0U, NULL, 0x17U, 0x80000000U);
    omAddGObjRenderProc(best_time_gobj, func_ovl0_800CCF00, 0x1AU, 0x80000000U, -1);
...
void mnBonusCreateWhiteSquare(s32 port_id)
{
    ...
    gMnBonusPanel.white_square = white_square_gobj = omMakeGObjSPAfter(0U, NULL, 0x1AU, 0x80000000U);
...
void mnBonusHandleTitlePress()
{
    ...
    omEjectGObj(gMnBonusTitleGObj);
    mnBonusDrawTitleAndBack();
    mnBonusDrawHighscore();

    if (gMnBonusTotalTimeGobj != NULL)
    {
        omEjectGObj(gMnBonusTotalTimeGobj);
...
{
    omAddGObjCommonProc(omMakeGObjSPAfter(0U, NULL, 0x18U, 0x80000000U), mnBonusAutopositionToken, 1, 1);
}
...
void mnBonusInitCSS()
{
    ...
    omMakeGObjSPAfter(0x400U, mnBonusMain, 0xFU, 0x80000000U);
