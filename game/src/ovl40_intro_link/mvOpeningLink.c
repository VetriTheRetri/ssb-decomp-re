...
// ovl40 stuff
extern CameraVec7 dMvOpeningLinkCameraSettingsStart; // 0x8018E070
extern CameraVec7 dMvOpeningLinkCameraSettingsEnd; // 0x8018E08C
...
extern RldmFileId D_ovl40_8018E0B0[2];
extern intptr_t dMvOpeningLinkNameOffsets[4]; // 0x8018E0B8;
extern f32 dMvOpeningLinkNameCharPositions[3]; // 0x8018E0CC;

extern scUnkDataBounds D_ovl40_8018E0DC;
extern scRuntimeInfo D_ovl40_8018E0F8;

extern s32 gMvOpeningLinkFramesElapsed; // 0x8018E1C8
extern GObj* gMvOpeningLinkNameGObj; // 0x8018E1CC
extern GObj* gMvOpeningLinkStageFighterGObj; // 0x8018E1D0

extern GObj* gMvOpeningLinkStageCameraGObj; // 0x8018E1D8
extern void* gMvOpeningLinkAnimHeap; // 0x8018E1DC
extern f32 gMvOpeningLinkPosedFighterXSpeed; // 0x8018E1E0

extern CameraVec7 dMvOpeningLinkCameraSettingsAdjustedStart; // 0x8018E1E8
extern CameraVec7 dMvOpeningLinkCameraSettingsAdjustedEnd; // 0x8018E208

extern rdFileNode D_ovl40_8018E228[48];
extern rdFileNode D_ovl40_8018E3A8[7];
extern uintptr_t D_NF_001AC870;
extern uintptr_t D_NF_00000854;

extern uintptr_t gMvOpeningLinkFilesArray[2]; // 0x8018E3E0[2]
// gMvOpeningLinkFilesArray[0] - D_ovl40_8018E3E0; // file 0x025 pointer
// gMvOpeningLinkFilesArray[1] - D_ovl40_8018E3E4; // file 0x041 pointer

extern gmBattleState gMvOpeningLinkBattleState; // 0x8018E3E8

// Offsets
extern intptr_t FILE_041_LINK_CAMERA_PARAMS_OFFSET = 0xC0; // file 0x041 offset for Link's fighter pose camera settings
...
void mvOpeningLinkInitFighterStagePanel()
{
    ...
    for (i = 0; i < ARRAY_COUNT(gBattleState->player_block); i++)
    {
        ...
        gMvOpeningLinkStageFighterGObj = fighter_gobj = ftManager_MakeFighter(&spawn_info);
...
void intro_focus_link_entry()
{
    ...
    func_8000683C(&D_ovl40_8018E0F8);
}
