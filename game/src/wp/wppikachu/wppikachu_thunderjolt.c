...
// 0x80169390
sb32 wpPikachu_ThunderJoltAir_ProcUpdate(GObj *weapon_gobj)
{
...
// 0x801693EC
sb32 wpPikachu_ThunderJoltAir_ProcMap(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
    Vec3f pos;
    u32 unused[2];
    ...
    else if (wp->coll_data.update_mask_curr & MPCOLL_KIND_LWALL)
    {
        ...
        wpPikachu_ThunderJoltGround_MakeWeapon(weapon_gobj, &DObjGetStruct(weapon_gobj)->translate.vec.f, 3);

        return TRUE;
    }

    else if (wp->coll_data.update_mask_curr & MPCOLL_KIND_RWALL)
    {
        ...
        wpPikachu_ThunderJoltGround_MakeWeapon(weapon_gobj, &DObjGetStruct(weapon_gobj)->translate.vec.f, 1);
...
// 0x8016953C
sb32 wpPikachu_ThunderJoltAir_ProcHit(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
...
// 0x8016956C
sb32 wpPikachu_ThunderJoltAir_ProcHop(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
...
// 0x801695B0
sb32 wpPikachu_ThunderJoltAir_ProcReflector(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
...
// 0x801696A0
sb32 wpPikachu_ThunderJoltGround_ProcUpdate(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
...
// 0x80169BF0
sb32 func_ovl3_80169BF0(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
    Vec3f angle;
...
// 0x80169D08
sb32 wpPikachu_ThunderJoltGround_ProcMap(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
    s32 coll_type;
    Vec3f pos;
...
// 0x8016A374
sb32 wpPikachu_ThunderJoltGround_ProcHit(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
...
// 0x8016A3A4
sb32 wpPikachu_ThunderJoltGround_ProcReflector(GObj *weapon_gobj)
{
    wpStruct *wp = wpGetStruct(weapon_gobj);
    ftStruct *fp = ftGetStruct(wp->owner_gobj);
...
GObj* wpPikachu_ThunderJoltGround_MakeWeapon(GObj *prev_gobj, Vec3f *pos, s32 coll_type)
{
    ...
    case 0:
        ...
        DObjGetStruct(new_gobj)->rotate.vec.f.y = (new_wp->lr >= 0.0F) ? PI32 : 0;
        break;
    ...
    case 3:
        ...
        {
            DObjGetStruct(new_gobj)->rotate.vec.f.y = PI32;
            new_wp->lr = WALL_UP;
        }
        break;
