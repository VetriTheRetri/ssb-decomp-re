...
extern intptr_t lFtPikachuThunderJoltAnimJoint;  // 0x00001A20
extern intptr_t lFtPikachuThunderJoltMatAnimJoint;  // 0x00001AE0
...
void wpPikachuThunderJoltGroundAddAnim(GObj *weapon_gobj)
{
    ...
    (
        weapon_gobj, 
        (uintptr_t)gFtDataPikachuExtra3 + (intptr_t)&lFtPikachuThunderJoltAnimJoint, 
        (uintptr_t)gFtDataPikachuExtra3 + (intptr_t)&lFtPikachuThunderJoltMatAnimJoint, 
        0.0F
    ); // Linker thing
