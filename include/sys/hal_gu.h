...
extern void
hal_look_at_f(Mtx4f* mf, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 xUp, f32 yUp, f32 zUp);
extern void hal_look_at(Mtx* m, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 xUp, f32 yUp, f32 zUp);
extern void hal_mod_look_at_f(Mtx4f* mf, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 arg7, f32 xUp,
							  f32 yUp, f32 zUp);
extern void
hal_mod_look_at(Mtx* m, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 arg7, f32 xUp, f32 yUp, f32 zUp);
extern void hal_look_at_reflect_f(Mtx4f* mf, LookAt* l, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt,
								  f32 xUp, f32 yUp, f32 zUp);
extern void hal_look_at_reflect(Mtx* m, LookAt* l, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt, f32 xUp,
								f32 yUp, f32 zUp);
extern void hal_mod_look_at_reflect_f(Mtx4f* mf, LookAt* l, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt,
									  f32 arg8, f32 xUp, f32 yUp, f32 zUp);
extern void hal_mod_look_at_reflect(Mtx* m, LookAt* l, f32 xEye, f32 yEye, f32 zEye, f32 xAt, f32 yAt, f32 zAt,
									f32 arg8, f32 xUp, f32 yUp, f32 zUp);
...
extern void hal_rotate_translate_f(Mtx4f* mf, f32 dx, f32 dy, f32 dz, f32 angle, f32 rx, f32 ry, f32 rz);
extern void hal_rotate_translate(Mtx* m, f32 dx, f32 dy, f32 dz, f32 angle, f32 rx, f32 ry, f32 rz);
extern void hal_rotate_translate_rowscale_f(Mtx4f* mf, f32 dx, f32 dy, f32 dz, f32 angle, f32 rx, f32 ry, f32 rz,
											f32 sx, f32 sy, f32 sz);
extern void hal_rotate_translate_rowscale(Mtx* m, f32 dx, f32 dy, f32 dz, f32 angle, f32 rx, f32 ry, f32 rz, f32 sx,
										  f32 sy, f32 sz);
...
extern void
hal_rotate_rpy_translate_scale_f(Mtx4f* mf, f32 dx, f32 dy, f32 dz, f32 r, f32 p, f32 h, f32 sx, f32 sy, f32 sz);
extern void hal_rotate_rpy_translate_scale(Mtx* m, f32 dx, f32 dy, f32 dz, f32 r, f32 p, f32 h, f32 sx, f32 sy, f32 sz);
...
extern void
hal_rotate_pyr_translate_scale_f(Mtx4f* mf, f32 dx, f32 dy, f32 dz, f32 r, f32 p, f32 h, f32 sx, f32 sy, f32 sz);
extern void hal_rotate_pyr_translate_scale(Mtx* m, f32 dx, f32 dy, f32 dz, f32 r, f32 p, f32 h, f32 sx, f32 sy, f32 sz);
...
extern void hal_rotate_translate_f_degrees(Mtx4f* mf, f32 dx, f32 dy, f32 dz, f32 a, f32 rx, f32 ry, f32 rz);
extern void hal_rotate_translate_degrees(Mtx* m, f32 dx, f32 dy, f32 dz, f32 a, f32 rx, f32 ry, f32 rz);
...
extern void hal_rotate_rpy_translate_f_degrees(Mtx4f* mf, f32 dx, f32 dy, f32 dz, f32 r, f32 p, f32 h);
