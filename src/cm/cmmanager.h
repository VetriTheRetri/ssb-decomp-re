...
extern void func_ovl2_8010D030(AObjEvent *arg0, f32 arg1, Vec3f *arg2);
...
extern sb32 cmManagerLookAtProcMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
extern sb32 cmManagerPrepLookAtProcMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
...
extern sb32 cmManagerPlayerMagnifyProcMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
extern sb32 cmManageOrthoLookAtProcMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
extern sb32 cmManagerPrepProjectionProcMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
