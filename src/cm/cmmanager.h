...
extern void func_ovl2_8010C55C(CObj *cobj, Vec3f *arg1, f32 arg2);
...
extern sb32 cmManagerLookAtFuncMatrix(Mtx *mtx, CObj *cobj, Gfx **dl);
extern sb32 cmManagerPrepLookAtFuncMatrix(Mtx *mtx, CObj *cobj, Gfx **dl);
