...
extern void cmManagerRunGlobalFuncCamera(GObj *camera_gobj);
...
extern sb32 cmManagerLookAtFuncMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
extern sb32 cmManagerPrepLookAtFuncMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
...
extern sb32 cmManagerPlayerMagnifyFuncMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
extern sb32 cmManageOrthoLookAtFuncMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
extern sb32 cmManagerPrepProjectionFuncMatrix(Mtx *mtx, Camera *cam, Gfx **dl);
