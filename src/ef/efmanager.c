...
efCreateDesc dEFManagerDamageFlyOrbsEffectDesc =
{
    ...
    // DObj transformation struct 2
    {
        OMMtx_Transform_Sca,                // Main matrix transformations  
        OMMtx_Transform_Null,               // Secondary matrix transformations
        0x00                                // ???
    },
...
GObj* efManagerMakeEffect(efCreateDesc *effect_desc, sb32 is_force_return)
{
    ...
    else
    {
        ...
        if (effect_flags & 0x4)
        {
            func_8000F590(effect_gobj, (void*)(addr + effect_desc->o_dobjsetup), NULL, OMMtx_Transform_Null, OMMtx_Transform_Null, 0);
...
// 0x800FFB38
GObj* efManagerDamageSpawnOrbsCheckRandomMakeEffect(Vec3f *pos)
{
...
// 0x80100218
GObj* efManagerDamageSpawnSparksCheckRandomMakeEffect(Vec3f *pos, s32 lr)
{
    if (mtTrigGetRandomIntRange(4) != 0)
    {
        return NULL;
...
void efManagerDamageSpawnMDustProcUpdate(GObj *effect_gobj)
{
    ...
    if (!(lifetime % EFPART_DAMAGESPAWNMDUST_LIFETIME_MOD))
    {
        ...
        if (new_gobj != NULL)
        {
            ...
            new_ep->effect_vars.damage_fly_mdust.vel.x = __cosf(angle) * EFPART_DAMAGESPAWNMDUST_VEL_BASE * this_ep->effect_vars.damage_spawn_mdust.lr;
...
// 0x80100440
GObj* efManagerDamageSpawnMDustCheckRandomMakeEffect(Vec3f *pos, s32 lr)
{
    if (mtTrigGetRandomIntRange(4) != 0)
    {
        return NULL;
...
void efManagerPikachuThunderTrailProcUpdate(GObj *effect_gobj)
{
    ...
    if (DObjGetStruct(effect_gobj)->mobj->current_image_id != 3)
    {
        ...
        else DObjGetStruct(effect_gobj)->mobj->current_image_id = mtTrigGetRandomIntRange(3);
    }
}
...
void efManagerLoseKirbyStarProcUpdate(GObj *effect_gobj)
{
    ...
    {
        func_800269C0_275C0(alSound_SFX_KirbyStarPing1);
