...
void efManagerInitEffects(void)
{
    ...
    sEFManagerStructsAllocFree = ep = syProgMalloc(sizeof(efStruct) * EFFECT_ALLOC_NUM, 0x8);
    ...
    sEFManagerTexturesFile1 = lbRelocGetFileExternHeap(&D_NF_00000053, syProgMalloc(lbRelocGetFileSize(&D_NF_00000053), 0x10));
    sEFManagerTexturesFile2 = lbRelocGetFileExternHeap(&D_NF_00000054, syProgMalloc(lbRelocGetFileSize(&D_NF_00000054), 0x10));
    sEFManagerTexturesFile3 = lbRelocGetFileExternHeap(&D_NF_00000055, syProgMalloc(lbRelocGetFileSize(&D_NF_00000055), 0x10));
...
void efManagerImpactWaveProcDisplay(GObj *effect_gobj)
{
    ...
    gDPSetPrimColor(gSYProgDLHeads[0]++, 0, 0, dEFManagerImpactWavePrimColorR[index], dEFManagerImpactWavePrimColorG[index], dEFManagerImpactWavePrimColorB[index], (s32)ep->effect_vars.impact_wave.alpha);
...
#if defined (DAIRANTOU_OPT0)
    gDPSetEnvColor(gSYProgDLHeads[0]++, 0x00, 0x00, 0x00, 0xFF);
#else
    gDPSetEnvColor(gSYProgDLHeads[0]++, dEFManagerImpactWaveEnvColorR[index], dEFManagerImpactWaveEnvColorG[index], dEFManagerImpactWaveEnvColorB[index], 0xFF);
#endif
...
GObj* efManagerQuakeMakeEffect(s32 magnitude) // Linker things here
{
    ...
    {
    case 0:
        gcAddAnimJointAll(effect_gobj, lbGetDataFromFile(AObjEvent32**, sEFManagerTexturesFile1, &lEFManagerQuakeMag0AnimJoint), 0.0F);
        break;

    case 1:
        gcAddAnimJointAll(effect_gobj, lbGetDataFromFile(AObjEvent32**, sEFManagerTexturesFile1, &lEFManagerQuakeMag1AnimJoint), 0.0F);
        break;

    case 2:
        gcAddAnimJointAll(effect_gobj, lbGetDataFromFile(AObjEvent32**, sEFManagerTexturesFile1, &lEFManagerQuakeMag2AnimJoint), 0.0F);
        break;

    case 3: // Used by POW Block 
        gcAddAnimJointAll(effect_gobj, lbGetDataFromFile(AObjEvent32**, sEFManagerTexturesFile1, &lEFManagerQuakeMag3AnimJoint), 0.0F);
        break;
...
void efManagerFoxReflectorSetAnimID(GObj *effect_gobj, s32 anim_id)
{
    ...
    gcAddAnimJointAll(effect_gobj, lbGetDataFromFile(AObjEvent32**, gFTDataFoxSpecial2, dEFManagerFoxReflectorAnimJointOffsets[anim_id]), 0.0F);
    gcPlayAnimAll(effect_gobj);
}
...
void efManagerShieldProcDisplay(GObj *effect_gobj)
{
    ...
    gDPSetPrimColor(gSYProgDLHeads[1]++, 0, 0, dEFManagerShieldColors[id].prim.r, dEFManagerShieldColors[id].prim.g, dEFManagerShieldColors[id].prim.b, 0xC0);
    gDPSetEnvColor(gSYProgDLHeads[1]++, dEFManagerShieldColors[id].env.r, dEFManagerShieldColors[id].env.g, dEFManagerShieldColors[id].env.b, 0xC0);
...
void efManagerYoshiShieldProcDisplay(GObj *effect_gobj)
{
    ...
    gDPPipeSync(gSYProgDLHeads[1]++);
    gDPSetEnvColor(gSYProgDLHeads[1]++, color[nSYColorRGBAIndexR], color[nSYColorRGBAIndexG], color[nSYColorRGBAIndexB], 0x00);
...
GObj* efManagerPikachuThunderShockMakeEffect(GObj *fighter_gobj, Vec3f *pos, s32 frame)
{
    ...
    case 1:
        ...
        (
            effect_gobj, 
            lbGetDataFromFile(AObjEvent32**, gFTDataPikachuSpecial2, &lEFManagerPikachuThunderShock1AnimJoint), 
            lbGetDataFromFile(AObjEvent32***, gFTDataPikachuSpecial2, &lEFManagerPikachuThunderShock1MatAnimJoint), 
            0.0F
        );
        gcPlayAnimAll(effect_gobj);
        break;
    ...
    case 2:
        ...
        (
            effect_gobj, 
            lbGetDataFromFile(AObjEvent32**, gFTDataPikachuSpecial2, &lEFManagerPikachuThunderShock2AnimJoint), 
            lbGetDataFromFile(AObjEvent32***, gFTDataPikachuSpecial2, &lEFManagerPikachuThunderShock2MatAnimJoint), 
            0.0F
        );
        gcPlayAnimAll(effect_gobj);
        break;
...
GObj* efManagerCaptainEntryCarMakeEffect(Vec3f *pos, s32 lr)
{
    ...
    gcAddAnimJointAll(effect_gobj, lbGetDataFromFile(AObjEvent32**, gFTDataCaptainSpecial2, &D_NF_00006200), 0.0F);
    ...
    for (i = nFTPartsJointCommonStart; i > 0; i--)
    {
        ...
        gcAddDObjAnimJoint(node_dobj, lbGetDataFromFile(AObjEvent32*, gFTDataCaptainSpecial2, &D_NF_00006518), 0.0F);

        node_dobj = node_dobj->sib_next;

        gcAddDObjAnimJoint(node_dobj, lbGetDataFromFile(AObjEvent32*, gFTDataCaptainSpecial2, &D_NF_00006598), 0.0F);
...
GObj* efManagerFoxEntryArwingMakeEffect(Vec3f *pos, s32 lr)
{
    ...
    gcAddDObjAnimJoint(what, lbGetDataFromFile(AObjEvent32*, gFTDataFoxSpecial3, &D_NF_00002E74), 0.0F); // Linker thing
