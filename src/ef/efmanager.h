...
extern void efManagerTimerProcUpdate(GObj *effect_gobj);
extern GObj* efManagerPikachuUnkMakeEffect(Vec3f *pos, s32 arg1);
...
extern void efManagerDeadExplodeOffsetMakeEffect(Vec3f *pos);
...
extern LBParticle* efManagerKirbyParticle2MakeEffect(Vec3f *pos);
extern LBParticle* efManagerKirbyParticle5MakeEffect(Vec3f *pos);
