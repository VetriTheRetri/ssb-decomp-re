...
extern efParticle* efManagerDestroyParticleGObj(efParticle *ptcl, GObj *effect_gobj);
extern void efManagerDefaultProcDead(efTransform *tfrm);
...
extern void efManagerDamageNormalHeavyProcDead(efTransform *tfrm);
...
extern efParticle* efManagerFlameRandgcMakeEffect(Vec3f *pos);
...
extern void efManagerImpactWaveProcDraw(GObj *effect_gobj);
...
extern void efManagerDamageCoinProcDead(efTransform *tfrm);
...
extern void efManagerShieldProcDraw(GObj *effect_gobj);
extern GObj* efParticle_Shield_MakeEffect(GObj *fighter_gobj);
extern void efManagerYoshiShieldProcDraw(GObj *effect_gobj);
...
extern void efManagerPikachuThunderTrailProcDraw(GObj *effect_gobj);
...
extern void efManagerNessPKThunderTrailProcDraw(GObj *effect_gobj);
