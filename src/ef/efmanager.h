...
extern LBParticle* efManagerDestroyParticleGObj(LBParticle *ptc, GObj *effect_gobj);
extern void efManagerDefaultProcDead(LBTransform *tfm);
...
extern void efManagerDamageNormalHeavyProcDead(LBTransform *tfm);
...
extern void efManagerDamageCoinProcDead(LBTransform *tfm);
