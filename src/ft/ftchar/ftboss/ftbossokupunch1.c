...
{
    ftStatus_IfAnimEnd_ProcStatus(fighter_gobj, ftBossOkupunch2SetStatus);
}
...
void ftBossOkupunch1SetStatus(GObj *fighter_gobj)
{
    ...
    ftMainSetFighterStatus(fighter_gobj, ftStatus_Boss_Okupunch1, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
