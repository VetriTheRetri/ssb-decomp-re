...
void ftDonkeyThrowFDamageSetStatus(GObj *fighter_gobj)
{
    ...
    ftCommonDamageInitDamageVars(fighter_gobj, nFTDonkeyStatusThrowFDamage, this_fp->damage_queue, this_fp->damage_knockback, this_fp->damage_angle, this_fp->lr_damage, this_fp->damage_index, this_fp->damage_element, this_fp->damage_player_number, FALSE, FALSE, TRUE);
    ...
    if (this_fp->catch_gobj != NULL)
    {
        ...
        func_ovl2_800EB528(capture_fp->joint[nFTPartsJointTopN]);
    }
}
