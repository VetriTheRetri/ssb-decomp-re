...
void ftYoshiSpecialAirHiSwitchStatusGround(GObj *fighter_gobj)
{
    ...
    ftMap_SetGround(fp);
    ftMainSetFighterStatus(fighter_gobj, nFTYoshiStatusSpecialHi, fighter_gobj->anim_frame, 1.0F, FTSTATUPDATE_EFFECT_PRESERVE);
...
void ftYoshiSpecialHiSwitchStatusAir(GObj *fighter_gobj)
{
    ...
    ftMap_SetAir(fp);
    ftMainSetFighterStatus(fighter_gobj, nFTYoshiStatusSpecialAirHi, fighter_gobj->anim_frame, 1.0F, FTSTATUPDATE_EFFECT_PRESERVE);
...
{
    ftMainSetFighterStatus(fighter_gobj, nFTYoshiStatusSpecialHi, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
...
{
    ftMainSetFighterStatus(fighter_gobj, nFTYoshiStatusSpecialAirHi, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
    ftYoshiSpecialHiInitStatusVars(fighter_gobj);
    ftMainUpdateAnimCheckInterrupt(fighter_gobj);
}
