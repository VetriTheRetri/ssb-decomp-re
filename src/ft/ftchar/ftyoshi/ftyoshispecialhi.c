...
void ftYoshiSpecialAirHiSwitchStatusGround(GObj *fighter_gobj)
{
    ...
    ftMap_SetGround(fp);
    ftMainSetFighterStatus(fighter_gobj, ftStatus_Yoshi_SpecialHi, fighter_gobj->anim_frame, 1.0F, FTSTATUPDATE_EFFECT_PRESERVE);
...
void ftYoshiSpecialHiSwitchStatusAir(GObj *fighter_gobj)
{
    ...
    ftMap_SetAir(fp);
    ftMainSetFighterStatus(fighter_gobj, ftStatus_Yoshi_SpecialAirHi, fighter_gobj->anim_frame, 1.0F, FTSTATUPDATE_EFFECT_PRESERVE);
...
{
    ftMainSetFighterStatus(fighter_gobj, ftStatus_Yoshi_SpecialHi, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
...
{
    ftMainSetFighterStatus(fighter_gobj, ftStatus_Yoshi_SpecialAirHi, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
    ftYoshiSpecialHiInitStatusVars(fighter_gobj);
    ftMainUpdateAnimCheckInterrupt(fighter_gobj);
}
