...
void ftCommonAttackS3SetStatus(GObj *fighter_gobj)
{
    ...
    {
        if (fp->ft_data->mainmotion->script_info[nFTCommonMotionAttackS3HiS].anim_file_id != 0)
        {
        ...
        else if (fp->ft_data->mainmotion->script_info[nFTCommonMotionAttackS3Hi].anim_file_id != 0)
        {
            stick_angle = ftParamGetStickAngleRads(fp);
