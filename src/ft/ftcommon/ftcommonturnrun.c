...
void ftCommonTurnRunProcUpdate(GObj *fighter_gobj)
{
    ...
    ftStatusSetOnAnimEnd(fighter_gobj, ftCommon_Run_SetStatus);
}
...
void ftCommonTurnRunSetStatus(GObj *fighter_gobj)
{
    ...
    ftMainSetFighterStatus(fighter_gobj, ftStatus_Common_TurnRun, 0.0F, 1.0F, FTSTATUPDATE_NONE_PRESERVE);
