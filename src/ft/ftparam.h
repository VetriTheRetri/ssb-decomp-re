...
extern void ftParamClearAtkAll(GObj *fighter_gobj);
extern void ftParamClearAtkRecordID(FTStruct *fp, s32 attack_id);
extern void ftParamRefreshAtkID(GObj *fighter_gobj, s32 attack_id);
