...
extern void ftParamMakeRumble(ftStruct *fp, s32 rumble_id, s32 duration);
...
extern void ftParamMoveFighterDLLink(GObj *fighter_gobj, u8 dl_link);
...
extern void ftParamInitFighterHurtPartAll(GObj *fighter_gobj);
extern void ftParamModifyFighterHurtPartID(GObj *fighter_gobj, s32 joint_id, Vec3f *offset, Vec3f *size);
extern void ftParamSetModelPartID(GObj *fighter_gobj, s32 joint_id, s32 drawstatus);
extern void ftParamSetModelPartDefaultID(GObj *fighter_gobj, s32 joint_id, s32 drawstatus);
...
extern void ftParamSetTexturePartID(GObj *fighter_gobj, s32 texture_part_id, s32 texture_id);
extern void ftParamResetTexturePartAll(GObj *fighter_gobj);
extern sb32 ftParamCheckSetColAnimID(gmColAnim *colanim, s32 colanim_id, s32 duration);
extern sb32 ftParamCheckSetFighterColAnimID(GObj *fighter_gobj, s32 colanim_id, s32 duration);
...
extern void ftParamSetExplainInputSeq(GObj *fighter_gobj, ftExplainCommand *p_inputseq);
extern sb32 ftParamCheckExplainInputSeq(GObj *fighter_gobj);
...
extern s32 ftParamGetStaledDamageOutput(s32 player, s32 damage, s32 attack_id, u16 motion_count);
