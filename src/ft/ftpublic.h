...
extern sb32 ftPublicTryStartCall(GObj *gobj, f32 knockback, s32 player_number);
...
extern void ftPublicDecideCommon(GObj *fighter_gobj, s32 player_number, f32 knockback, sb32 is_force_curr_knockback);
