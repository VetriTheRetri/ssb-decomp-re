...
extern sb32 ftPublicityTryStartChant(GObj *gobj, f32 knockback, s32 player_number);
extern void ftPublicityTryInterruptChant(void);
extern void ftPublicityPlayCommon(u16 new_sfx);
extern void ftPublicityCommonStop(void);
extern void ftPublicityDecideChant(GObj *gobj, s32 player_num, f32 knockback);
extern void ftPublicityDecideCommon(GObj *fighter_gobj, s32 player_number, f32 knockback, sb32 is_force_current_knockback);
