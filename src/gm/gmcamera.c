...
// 8010DB54
GObj* gmCameraMakeWallpaperCamera()
{
...
// 8010DDC4
void gmCameraScreenFlashMakeCamera()
{
...
// 8010E1A4
void gmCameraMakePlayerMagnifyCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 8010E2D4
void gmCameraMakePlayerArrowsCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 8010E374
GObj* gmCameraMakeInterfaceCamera()
{
	GObj *camera_gobj = gcMakeCameraGObj
	(
		nGCCommonKindScissorCamera,
