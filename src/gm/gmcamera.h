...
extern void gmCameraGetFocusAngleClamp(Vec3f *at, Vec3f *vec);
extern void gmCameraUpdateInishieFocus(Vec3f *arg0, Vec3f *arg1);
extern f32 gmCameraGetPanScale(void);
extern void gmCameraPan(CObj *cobj, Vec3f *pos, f32 scale);
extern void gmCameraUpdateEyePosition(CObj *cobj, Vec3f *arg1);
extern void gmCameraAdjustTargetDist(f32 dist);
...
extern void gmCameraUnusedFuncCamera(GObj *camera_gobj);
...
extern void gmCameraUnusedFuncMatrix(Mtx *mtx, CObj *cobj, Gfx **dl);
