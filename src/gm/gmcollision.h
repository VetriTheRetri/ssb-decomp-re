...
extern void gmCollisionMultiplyMatrix(Mtx44f dst, Mtx44f lhs, Mtx44f rhs);
extern void gmCollisionSetInvertMatrix(Mtx44f dst, Mtx44f src);
extern void gmCollisionGetMatrixRotation(Mtx44f mtx, Vec3f *rotate);
extern void gmCollisionGetMatrixTranslation(Mtx44f mtx, Vec3f *vec);
extern void gmCollisionBuildPartsMatrix(DObj *main_dobj);
extern void gmCollisionUpdatePartsInvertMatrix(DObj *main_dobj);
extern void gmCollisionUpdatePartsScale(DObj *main_dobj);
extern void gmCollisionGetFighterPartsWorldPosition(DObj *main_dobj, Vec3f *vec);
extern void gmCollisionGetPartsInversePosition(DObj *main_dobj, Vec3f *vec);
extern void gmCollisionSetCapsuleMatrix(s32 arg0, Vec3f *arg1, Vec3f *arg2, sb32 *arg3, Mtx44f mtx, f32 *p_scale);
extern u32 gmCollisionGetOutcodesXY(Vec3f *lhs, Vec3f *rhs);
extern u32 gmCollisionGetOutcodesZ(Vec3f *lhs, Vec3f *rhs);
...
extern sb32 gmCollisionTestCapsule(Vec3f *arg0, Vec3f *arg1, f32 arg2, s32 opkind, Mtx44f mtx, s32 arg5, Vec3f *arg6, f32 arg7, s32 arg8, f32 arg9);
...
extern sb32 gmCollisionTestOverlap2D(Vec3f *arg0, Vec3f *arg1, f32 arg2, s32 arg3, Vec3f *arg4, Vec3f *arg5, f32 arg6, s32 arg7);
