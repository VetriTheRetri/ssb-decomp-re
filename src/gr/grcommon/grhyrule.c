...
// 8010A36C
void grHyruleTwisterUpdateSleep()
{
...
// 8010A3B4
void grHyruleTwisterUpdateWait()
{
	Vec3f pos;
	GObj *twister_gobj;
...
// 8010A444
void grHyruleTwisterUpdateSummon()
{
	s32 lr;
...
// 8010A4F4
sb32 grHyruleTwisterDecLifetimeCheckStop()
{
	gGRCommonStruct.hyrule.twister_wait--;
...
// 8010A610
void grHyruleTwisterUpdateMove()
{
...
// 8010A7CC
void grHyruleTwisterUpdateTurn()
{
	if (grHyruleTwisterDecLifetimeCheckStop() == FALSE)
	{
		gGRCommonStruct.hyrule.twister_turn_wait--;
...
// 8010A824
void grHyruleTwisterUpdateStop()
{
	GObj *fighter_gobj = gGCCommonLinks[nGCCommonLinkIDFighter];
...
// 8010A8B4
void grHyruleTwisterUpdateSubside()
{
	gGRCommonStruct.hyrule.twister_wait--;
