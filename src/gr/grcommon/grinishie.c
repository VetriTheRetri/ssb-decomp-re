...
// 80108CD0
void grInishieScaleUpdateFighterStatsGA()
{
...
// 8010929C
void grInishieScaleUpdateRetract()
{
	DObj *l_dobj;
	DObj *r_dobj;
...
// 8010972C
void grInishiePakkunSetWaitFighter()
{
	s32 i;
...
// 80109838
void grInishiePowerBlockUpdateWait()
{
...
// 8010986C
void grInishiePowerBlockSetWait()
{
	gGRCommonStruct.inishie.pblock_status = nGRInishiePowerBlockStatusMake;
	gGRCommonStruct.inishie.pblock_appear_wait = 1800;
}
...
// 80109888
void grInishiePowerBlockUpdateMake()
{
	GObj *pblock_gobj;
	Vec3f pos;
	Vec3f vel;
...
// 8010992C
void grInishiePowerBlockUpdateDamage()
{
	gGRCommonStruct.inishie.pblock_appear_wait--;
...
// 80109B4C
void grInishiePowerBlockSetDamage()
{
