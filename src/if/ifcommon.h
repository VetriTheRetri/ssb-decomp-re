...
extern void ifCommonPlayerDamageProcDraw(GObj *interface_gobj);
...
extern void ifCommonPlayerStockMultiProcDraw(GObj *interface_gobj);
extern void ifCommonPlayerStockSetIconAttr(void);
extern void ifCommonPlayerStockMultiMakeInterface(s32 player);
extern void ifCommonPlayerStockSingleProcDraw(GObj *interface_gobj);
...
extern void ifCommonPlayerMagnifyProcDraw(ftStruct *fp);
extern void ifCommonPlayerMagnifyMakeInterface(void);
extern void ifCommonPlayerArrowsLeftProcDraw(GObj *interface_gobj);
extern void ifCommonPlayerArrowsRightProcDraw(GObj *interface_gobj);
...
extern GObj* ifCommonPlayerArrowsMakeInterface(void (*proc_draw)(GObj*), void (*proc_update)(GObj*));
extern void ifCommonPlayerArrowsProcRun(GObj *interface_gobj);
extern void ifCommonPlayerArrowsMainProcDraw(GObj *interface_gobj);
extern void ifCommonPlayerArrowsInitInterface(void);
extern void ifCommonPlayerArrowsUpdateFlags(f32 x, f32 y);
extern void ifCommonPlayerTagProcDraw(GObj *interface_gobj);
extern void ifCommonPlayerTagMakeInterface(void);
extern void ifCommonItemArrowProcDraw(GObj *interface_gobj);
...
extern void ifCommonTimerProcDraw(GObj *interface_gobj);
...
extern void ifCommonBattlePauseProcDraw(GObj *interface_gobj);
