...
extern intptr_t lIFCommonAnnounceCommonLetterB;             // 0x000009A8
...
extern void ifCommonPlayerDamageFuncDisplay(GObj *interface_gobj);
...
extern void ifCommonPlayerStockMultiFuncDisplay(GObj *interface_gobj);
...
extern GObj* ifCommonPlayerArrowsMakeInterface(void (*func_display)(GObj*), void (*proc_update)(GObj*));
extern void ifCommonPlayerArrowsFuncRun(GObj *interface_gobj);
extern void ifCommonPlayerArrowsMainFuncDisplay(GObj *interface_gobj);
extern void ifCommonPlayerArrowsInitInterface(void);
extern void ifCommonPlayerArrowsUpdateFlags(f32 x, f32 y);
extern void ifCommonPlayerTagFuncDisplay(GObj *interface_gobj);
extern void ifCommonPlayerTagMakeInterface(void);
extern void ifCommonItemArrowFuncDisplay(GObj *interface_gobj);
...
extern void ifCommonTimerFuncDisplay(GObj *interface_gobj);
...
extern void ifCommonBattleInterfacePauseFuncGObj(GObj *interface_gobj, u32 unused);
extern void ifCommonBattleInterfaceResumeFuncGObj(GObj *interface_gobj, u32 unused);
...
extern void ifCommonBattlePauseFuncDisplay(GObj *interface_gobj);
