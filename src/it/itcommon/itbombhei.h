...
extern void itBombHeiExplodeNInitItemVars(GObj *item_gobj);
extern sb32 itBombHeiExplodeNProcUpdate(GObj *item_gobj);
extern void itBombHeiExplodeNSetStatus(GObj *item_gobj);
