...
void itRBombContainerSmashMakeEffect(Vec3f *pos)
{
    ...
    if (ep != NULL)
    {
        ...
        if (effect_gobj != NULL)
        {
            ...
            dl = (Gfx*) ((*(uintptr_t*)((uintptr_t)*dITRBombItemDesc.p_file + dITRBombItemDesc.o_attributes) - (uintptr_t)&lITRBombDataStart) + (uintptr_t)&lITRBombEffectDisplayList); // Linker thing
