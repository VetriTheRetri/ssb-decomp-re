...
// 800D4B60
void lbBackupClearBonusStageTime()
{
	s32 i;
...
// 800D4C48
void lbBackupClearAllData()
{
	gSCManagerBackupData = dSCManagerDefaultBackupData;
}

// 0x800D4C90 - unused
void func_ovl0_800D4C90()
{
	return;
}
