...
extern GObj* lbTransitionMakeCamera(u32 id, s32 link, u32 link_order, u64 cobj_mask);
extern void lbTransitionFuncDisplay(GObj *gobj);
extern void lbTransitionProcUpdate(GObj *gobj);
extern GObj* lbTransitionMakeTransition(s32 transition_id, u32 id, s32 link, void (*func_display)(GObj*), u8 dl_link_id, void (*proc_common)(GObj*));
