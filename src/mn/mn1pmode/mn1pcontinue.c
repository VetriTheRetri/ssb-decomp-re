...
// 801322DC
void mnPlayers1PGameContinueMakeRoomFadeOut()
{
	GObj *gobj;
...
// 80132460
void mnPlayers1PGameContinueMakeRoomFadeIn()
{
	GObj *gobj;
...
// 801325E8
void mnPlayers1PGameContinueMakeSpotlightFade()
{
	GObj *gobj;
...
// 80132648
void mnPlayers1PGameContinueMakeRoom()
{
	GObj *gobj;
	SObj *sobj;
...
// 801326D4
void mnPlayers1PGameContinueMakeSpotlight()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132824
void mnPlayers1PGameContinueMakeContinue()
{
	GObj *gobj;
	SObj *sobj;
...
// 801329D0
void mnPlayers1PGameContinueMakeOptions()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132B50
void mnPlayers1PGameContinueMakeCursor()
{
	GObj *gobj;
	SObj *sobj;
...
// 8013307C
void mnPlayers1PGameContinueMakeGameOverText()
{
	GObj *gobj;
	SObj *sobj;
...
// 80133368
void mnPlayers1PGameContinueMakeGameOver()
{
	GObj *gobj;
...
// 801333C4
void mnPlayers1PGameContinueMakeRoomFadeInCamera()
{
...
// 80133474
void mnPlayers1PGameContinueMakeSpotlightFadeCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80133524
void mnPlayers1PGameContinueMakeRoomFadeOutCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80133694
void mnPlayers1PGameContinueMakeMainCamera()
{
// 08048600
	CObj *cobj = CObjGetStruct
	(
...
// 80133718
void mnPlayers1PGameContinueMakeRoomCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 801337B8
void mnPlayers1PGameContinueMakeSpotlightCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80133868
void mnPlayers1PGameContinueMakeTextCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80133918
void mnPlayers1PGameContinueInitVars()
{
...
// 0x80133990 - real
void mnPlayers1PGameContinueUnused0x80133990()
{
	return;
}
...
// 80133F58
void mnPlayers1PGameContinueFuncStart()
{
	s32 unused;
...
// 801340FC
void mnPlayers1PGameContinueStartScene()
{
