...
// 0x801331D0
lbFileNode sMN1PModeStatusBuf[24];
...
{
    SObj  *sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonOptionTabLeftSprite));
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonOptionTabMiddleSprite));
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonOptionTabRightSprite));
...
void mn1PModeMake1PGame(void)
{
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeText1PGameSprite));
...
void mn1PModeMakeTrainingMode(void)
{
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeTextTraningModeSprite));
...
void mn1PModeMakeBonus1Practice(void)
{
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeOptionTabSprite));
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeTextBonus1PracticeSprite));
...
void mn1PModeMakeBonus2Practice(void)
{
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeTextBonus2PracticeSprite));
...
void mn1PModeMakeLabels(void)
{
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonSmashLogoSprite));
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeLabel1PSprite));
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonLabelGameModeSprite));
...
void mn1PModeMakeDecals(void)
{
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonWallpaperSprite));
    
    sobj->pos.x = 10.0F;
    sobj->pos.y = 10.0F;

    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[0], &lMNCommonDecalPaperSprite));
    ...
    sobj = lbCommonMakeSObjForGObj(gobj, lbGetDataFromFile(Sprite*, sMN1PModeFiles[1], &lMN1PModeDecalControllerSprite));
...
void mn1PModeProcStart(void)
{
    ...
    rl_setup.status_buf = sMN1PModeStatusBuf;
    rl_setup.status_buf_size = ARRAY_COUNT(sMN1PModeStatusBuf);
    ...
    gcMakeGObjSPAfter(0, mn1PModeProcRun, 0, GOBJ_LINKORDER_DEFAULT);
...
void mn1PModeStartScene(void)
{
    ...
    gsGTLSceneInit(&dMN1PModeGtlSetup);
}
