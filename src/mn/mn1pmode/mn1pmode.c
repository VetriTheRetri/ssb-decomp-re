...
// 80131FE8
void mn1PModeMakeBonus1Practice()
{
	GObj *gobj;
	SObj *sobj;
...
// 801320F8
void mn1PModeMakeBonus2Practice()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132730
void mn1PModeMakeOptionsCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
