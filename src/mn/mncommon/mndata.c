...
{
    SObj *sobj = gcAppendSObjWithSprite(gobj, spGetSpriteFromFile(sMNDataFiles[0], &lMNCommonOptionTabLeftSprite));
    ...
    sobj = gcAppendSObjWithSprite(gobj, spGetSpriteFromFile(sMNDataFiles[0], &lMNCommonOptionTabMiddleSprite));
    ...
    sobj = gcAppendSObjWithSprite(gobj, spGetSpriteFromFile(sMNDataFiles[0], &lMNCommonOptionTabRightSprite));
