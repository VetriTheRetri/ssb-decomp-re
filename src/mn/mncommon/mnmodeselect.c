...
// 80132398
void mnModeSelectMakeLabelsCamera()
{
...
// 80132438
void mnModeSelectMakeDecalsCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
