...
// 80131B24
sb32 mnDataCheckSoundTestUnlocked()
{
...
// 80131D54
void func_ovl61_80131D54()
{
	return;
}

// 80131D5C
void mnDataMakeCharacters()
{
	GObj *gobj;
	SObj *sobj;
	s32 pos_x;
