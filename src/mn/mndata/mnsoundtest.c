...
// 80131B00
void mnSoundTestUpdateOptionColors()
{
	s32 i;
...
// 80131B80
void mnSoundTestUpdateControllerInputs()
{
...
// 801320B4
void mnSoundTestUpdateFunctions()
{
...
// 8013234C
SObj* mnSoundTestMakeHeaderSObjs()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132638
SObj* mnSoundTestMakeMusicSObjs()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132894
SObj* mnSoundTestMakeSoundSObjs()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132AF4
SObj* mnSoundTestMakeVoiceSObjs()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132EC8
void mnSoundTestMakeButtonSObjs()
{
...
// 80133398
void mnSoundTestMakeSelectIDGObjs()
{
...
// 801335C8
void mnSoundTestMakeArrowSObjs()
{
