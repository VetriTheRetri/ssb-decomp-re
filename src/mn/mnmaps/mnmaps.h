...
extern void mnMapsLabelsFuncDisplay(GObj *gobj);
...
extern void mnMapsPreviewWallpaperFuncDisplay(GObj *gobj);
extern GObj* mnMapsMakePreviewWallpaper(s32 gkind);
extern void mnMapsModelPriFuncDisplay(GObj *gobj);
extern void mnMapsModelSecFuncDisplay(GObj *gobj);
