...
// 80131BC8
void mnBackupClearMakeHeaderSObjs()
{
	GObj *gobj;
	SObj *sobj;
...
// 80131D44
void mnBackupClearSetOptionSpriteColors()
{
	GObj *gobj;
	SObj *sobj;
...
// 80132124
void mnBackupClearEjectOptionConfirmGObj()
{
...
// 80132430
void mnBackupClearMakeMainCamera()
{
...
// 801325D4
void mnBackupClearUpdateOptionMainMenu()
{
	s32 stick_range;
