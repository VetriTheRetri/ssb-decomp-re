...
// 801329F4
void mnOptionMakeSoundUnderline()
{
	gcAddGObjDisplay
	(
		gcMakeGObjSPAfter
...
// 80132A40
void mnOptionMakeSoundUnderlineCamera()
{
...
// 80132B80
void mnOptionMakeOptionsCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
