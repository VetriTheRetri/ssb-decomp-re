...
// 80131DCC
void mnScreenAdjustMakeInstruction()
{
	GObj *gobj;
	SObj *sobj;
...
// 80131E74
void mnScreenAdjustMakeFrameCamera()
{
...
// 80131F14
void mnScreenAdjustMakeSpriteCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 8013204C
void mnScreenAdjustBackupOffsets()
{
