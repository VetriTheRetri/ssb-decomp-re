...
extern sb32 mnPlayers1PGameCheckTimeArrowRightInRange(GObj *gobj);
extern sb32 mnPlayers1PGameCheckTimeArrowLeftInRange(GObj *gobj);
...
extern void mnPlayers1PGameUpdateCursorDisplay(GObj *gobj, s32 player);
extern sb32 mnPlayers1PGameCheckLevelArrowRightInRange(GObj *gobj);
extern sb32 mnPlayers1PGameCheckLevelArrowLeftInRange(GObj *gobj);
extern sb32 mnPlayers1PGameCheckLevelArrowPress(GObj *gobj);
extern sb32 mnPlayers1PGameCheckStockArrowRightInRange(GObj *gobj);
extern sb32 mnPlayers1PGameCheckStockArrowLeftInRange(GObj *gobj);
