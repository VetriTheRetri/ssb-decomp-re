...
extern void mnPlayersVSMakePortraitAll();
...
extern void mnPlayersVSDestroyTeamSelectAll();
extern void mnPlayersVSMakeTeamSelectAll();
...
extern void mnPlayersVSMakePortraitCamera();
extern void mnPlayersVSMakePortraitWallpaperCamera();
extern void mnPlayersVSMakePortraitFlashCamera();
extern void mnPlayersVSMakeGateCamera();
extern void mnPlayersVSMakePlayerKindSelectCamera();
extern void mnPlayersVSMakePlayerKindCamera();
extern void mnPlayersVSMakeTeamSelectCamera();
...
extern void mnPlayersVSMakeWallpaper();
extern void mnPlayersVSMakeLabels();
...
extern void mnPlayersVSMakeFighterCamera();
...
extern void mnPlayersVSUpdateGateAll();
extern sb32 mnPlayersVSCheckGameModeInRange(GObj *gobj);
extern void mnPlayersVSUpdateGameMode();
...
extern sb32 mnPlayersVSCheckHandicapOn();
extern sb32 mnPlayersVSCheckHandicapAuto();
extern sb32 mnPlayersVSCheckHandicap();
...
extern void mnPlayersVSBackToVSMode();
...
extern void mnPlayersVSMakeCursorCamera();
extern void mnPlayersVSMakePuckCamera();
extern void mnPlayersVSMakeHandicapLevelCamera();
extern void mnPlayersVSMakeReadyCamera();
...
extern void mnPlayersVSMakePuckAdjust();
extern void mnPlayersVSUpdatePuckGlowColor(GObj *gobj);
extern void mnPlayersVSMakePuckGlow();
extern void mnPlayersVSCostumeSyncProcUpdate(GObj *gobj);
extern void mnPlayersVSMakeCostumeSync();
extern void mnPlayersVSSpotlightProcUpdate(GObj *gobj);
extern void mnPlayersVSMakeSpotlight();
extern void mnPlayersVSReadyProcUpdate(GObj *gobj);
extern void mnPlayersVSMakeReady();
extern void mnPlayersVSUpdateGate(s32 player);
extern void mnPlayersVSUpdateControllerOrders();
extern s32 mnPlayersVSGetReadyPlayerCount();
extern void mnPlayersVSSetPlayerNot(s32 player);
extern void mnPlayersVSSetIdlePlayerNotAll();
extern sb32 mnPlayersVSCheckSingleTeam();
extern sb32 mnPlayersVSCheckNoPuckOnPortraitAll();
extern sb32 mnPlayersVSCheckReady();
extern void mnPlayersVSSetSceneData();
extern void mnPlayersVSPauseSlotProcesses();
...
extern void mnPlayersVSInitVars();
extern void mnPlayersVSInitSlot(s32 player);
extern void mnPlayersVSInitSlotAll();
extern void mnPlayersVSFuncStart();
