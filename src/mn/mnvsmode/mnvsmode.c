...
// 80132EBC
void mnVSModeMakeVSOptionsButton()
{
	GObj* button_gobj;
	SObj* button_sobj;
...
// 8013342C
void mnVSModeMakeButtonValuegSYRdpViewport()
{
...
// 801334CC
void mnVSModeMakeButtonViewport()
{
	GObj *camera_gobj = gcMakeCameraGObj
	(
		1,
...
// 8013356C
void mnVSModeMakeMenuNameViewport()
{
	GObj *camera_gobj = gcMakeCameraGObj
	(
		1,
