...
// 80131B24
sb32 mnVSOptionsCheckHaveItemSwitch()
{
...
// 80132478
void mnVSOptionsMakeDamageDigits()
{
	GObj *gobj;
	s32 unused;
...
// 80132564
void mnVSOptionsMakeDamageOption()
{
	GObj *gobj;
	SObj *sobj;
	s32 pos_y;
...
// 801326F0
void mnVSOptionsMakeItemSwitchOption()
{
	GObj *gobj;
	SObj *sobj;
#if defined(REGION_US)
...
// 80132804
void mnVSOptionsMakeStageSelectOption()
{
	GObj *gobj;
	SObj *sobj;
	s32 pos_y;
...
// 80132968
void mnVSOptionsMakeTeamAttackOption()
{
	GObj *gobj;
	SObj *sobj;
	s32 pos_y;
...
// 80132AC8
void mnVSOptionsMakeHandicapOption()
{
	GObj *gobj;
	SObj *sobj;
	s32 pos_y;
...
// 80133558
void mnVSOptionsMakeTintCamera()
{
...
// 801335F8
void mnVSOptionsMakeOptionCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80133698
void mnVSOptionsMakeLabelUnderlineCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80133738
void mnVSOptionsMakeWallpaperCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 801337D8
void mnVSOptionsMakeDecalCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 8013394C
void mnVSOptionsSetAllSettings()
{
...
// 801339C4
void mnVSOptionsSetHandicapSettings()
{
	s32 i;
