...
extern void mnVSOptionsLabelFuncDisplay(GObj *gobj);
...
extern void mnVSOptionsUnderlineFuncDisplay(GObj *gobj);
extern void mnVSOptionsMakeUnderline(void);
extern void mnVSOptionsTintFuncDisplay(GObj *gobj);
