...
sb32 mpCollisionGetUDCommon(s32 line_id, Vec3f *object_pos, f32 *dist, u32 *flags, Vec3f *angle, s32 ud)
{
    ...
    if ((yakumono_dobj->aobj_script != NULL) || (yakumono_dobj->user_data.s != nMPYakumonoStatusNone))
    {
...
void func_ovl2_800FB808(void)
{
    ...
    for (i = 0; i < gMPCollisionGeometry->yakumono_count; i++, line_info++)
    {
        ...
        if ((yakumono_dobj->aobj_script != NULL) || (yakumono_dobj->user_data.s < nMPYakumonoStatusOff && yakumono_dobj->user_data.s != nMPYakumonoStatusNone))
        {
...
void func_ovl2_800FBD14(void)
{
    ...
    for (i = 0; i < gMPCollisionGeometry->yakumono_count; i++, line_info++)
    {
        ...
        {
            if (yakumono_dobj->aobj_script != NULL)
            {
...
sb32 mpCollisionCheckExistPlatformLineID(s32 line_id)
{
    ...
    if ((yakumono_dobj->user_data.s != nMPYakumonoStatusNone) || (yakumono_dobj->aobj_script != NULL))
    {
        return TRUE;
    }
    else return FALSE;
