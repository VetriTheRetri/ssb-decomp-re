...
// 80131B58
void mvEndingMakeRoomBackground()
{
	GObj *gobj;
...
// 801321A4
void mvEndingMakeRoomFadeInCamera()
{
...
// 8013249C
void mvEndingMakeRoomLightCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
