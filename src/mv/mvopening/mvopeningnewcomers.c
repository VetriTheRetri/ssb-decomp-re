...
// 80131C38
void mvOpeningNewcomersMakePurin()
{
	GObj* gobj;
	DObj* dobj;
...
// 80131D28
void mvOpeningNewcomersMakeCaptain()
{
	GObj* gobj;
	DObj* dobj;
...
// 80131E18
void mvOpeningNewcomersMakeLuigi()
{
	GObj* gobj;
	DObj* dobj;
...
// 80131F08
void mvOpeningNewcomersMakeNess()
{
	GObj* gobj;
	DObj* dobj;
...
// 80131FF8
void mvOpeningNewcomersMakeAll()
{
...
// 80132164
void mvOpeningNewcomersMakeHide()
{
...
// 801321B8
void mvOpeningNewcomersMakeNewcomersCamera()
{
	s32 unused;
...
// 801322E8
void mvOpeningNewcomersMakeHideCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80132388
void mvOpeningNewcomersInitVars()
{
...
// 80132490
void mvOpeningNewcomersFuncStart()
{
	s32 unused;
