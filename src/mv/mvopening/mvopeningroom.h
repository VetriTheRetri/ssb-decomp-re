...
extern void mvOpeningRoomMakePluckedFighter(s32 fkind);
extern void mvOpeningRoomLogoWallpaperFuncDisplay(GObj *gobj);
...
extern void mvOpeningRoomCloseUpOverlayFuncDisplay(GObj *gobj);
extern void mvOpeningRoomMakeCloseUpOverlay(void);
extern void mvOpeningRoomMakeCloseUpOverlayCamera(void);
extern void mvOpeningRoomWallpaperFuncDisplay(GObj *gobj);
...
extern void mvOpeningRoomTransitionOverlayFuncDisplay(GObj *gobj);
extern void mvOpeningRoomTransitionOutlineFuncDisplay(GObj *gobj);
...
extern s32 mvOpeningRoomGetPluckedFighterKind(void);
