...
// 80131E88
void mvOpeningRunMakeWallpaper()
{
	GObj *gobj;
	SObj *left_sobj;
	SObj *right_sobj;
...
// 80132138
void mvOpeningRunMakeMainCamera()
{
...
// 801321BC
void mvOpeningRunMakeWallpaperCamera()
{
