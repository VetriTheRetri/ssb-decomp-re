...
// 80131DEC
void mvOpeningSectorMakeWallpaper()
{
	GObj* wallpaper_gobj;
	SObj* wallpaper_sobj;
...
// 80131F4C
void mvOpeningSectorMakeGreatFox()
{
	GObj* great_fox_gobj;
...
// 801321E0
void mvOpeningSectorMakeCockpit()
{
	GObj* cockpit_gobj;
	SObj* cockpit_sobj;
...
// 80132290
void mvOpeningSectorMakeArwings()
{
	GObj* arwing_gobj;
...
// 80132400
void mvOpeningSectorMakeMainCamera()
{
...
// 80132500
void mvOpeningSectorMakeWallpaperCamera()
{
...
// 801325A0
void mvOpeningSectorMakeCockpitCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 80132640
void mvOpeningSectorInitTotalTimeTics()
{
