...
// 80131B58
void mvOpeningStandoffMakeGround()
{
...
// 80131C00
void mvOpeningStandoffMakeFighters()
{
	GObj* fighter_gobj;
...
// 80131FC8
void mvOpeningStandoffMakeWallpaper()
{
	GObj* wallpaper_gobj;
	SObj* wallpaper_sobj;
...
// 801320C0
void mvOpeningStandoffMakeLightning()
{
	GObj* lightning_gobj;
...
// 80132338
void mvOpeningStandoffMakeLightningFlash()
{
	gcAddGObjDisplay
	(
		gcMakeGObjSPAfter
...
// 80132384
void mvOpeningStandoffMakeLightningFlashCamera()
{
...
// 8013242C
void mvOpeningStandoffMakeMainCamera()
{
...
// 80132530
void mvOpeningStandoffMakeWallpaperCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 801325D0
void mvOpeningStandoffInitTotalTimeTics()
{
...
// 801326A8
void mvOpeningStandoffFuncStart()
{
	s32 unused;
