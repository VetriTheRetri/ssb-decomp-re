...
// 80131B58
void mvOpeningYamabukiMakeWallpaper()
{
	GObj* gobj;
	SObj* sobj;
...
// 80131BD4
void mvOpeningYamabukiMakeFighter()
{
	GObj* fighter_gobj;
...
// 80131CA4
void mvOpeningYamabukiMakeLegs()
{
...
// 80131D7C
void mvOpeningYamabukiMakeLegsShadow()
{
	GObj* gobj = gcMakeGObjSPAfter(0, NULL, 17, GOBJ_PRIORITY_DEFAULT);
	gcSetupCustomDObjs
	(
...
// 80131E54
void mvOpeningYamabukiMakeMBall()
{
	GObj* gobj = gcMakeGObjSPAfter(0, NULL, 17, GOBJ_PRIORITY_DEFAULT);
	gcSetupCustomDObjs
	(
...
// 80131F2C
void mvOpeningYamabukiMakeMainCamera()
{
...
// 80132030
void mvOpeningYamabukiMakeWallpaperCamera()
{
...
// 801320D0
void mvOpeningYamabukiInitTotalTimeTics()
{
...
// 801321A8
void mvOpeningYamabukiFuncStart()
{
	s32 unused;
