...
void mnTrainingAddRedXBoxToPortrait(GObj* portrait_gobj, s32 portrait_id)
{
	...
	portrait_sobj = gcAppendSObjWithSprite(portrait_gobj, (gMNTrainingFilesArray[6] + xbox_image_offset)); // AppendTexture
...
void mnTrainingCreatePanel(s32 port_id)
{
	...
	gcAddGObjDisplay(namelogo_gobj, func_ovl0_800CCF00, 0x1CU, 0x80000000U, -1);
