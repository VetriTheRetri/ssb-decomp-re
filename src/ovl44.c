...
void mvOpeningRunningInit()
{
	...
	rldmSetup.status_buffer = D_ovl44_80132748;
	rldmSetup.status_buffer_size = ARRAY_COUNT(D_ovl44_80132748);
	rldmSetup.force_status_buffer = D_ovl44_80132A68;
	rldmSetup.force_status_buffer_size = ARRAY_COUNT(D_ovl44_80132A68);
	lbRelocInitSetup(&rldmSetup);
	lbRelocLoadFilesExtern(D_ovl44_801325D0, ARRAY_COUNT(D_ovl44_801325D0), gMvOpeningRunningFilesArray, syTasklogMalloc(lbRelocGetAllocSize(D_ovl44_801325D0, ARRAY_COUNT(D_ovl44_801325D0)), 0x10));
