...
// 0x80131E10
void sc1PStageClearMakeScoreDigitSObjs(GObj *gobj, s32 points, f32 x, f32 y, syColorRGBPair *colors, s32 offset_x, s32 digit_kind, s32 sub, s32 digit_count_max, sb32 is_fixed_digit_count)
{
	SObj *sobj;
	f32 calc_x;
	s32 i;
	...
	sobj = gcAppendSObjWithSprite(gobj, sc1PStageClearGetScoreDigitSprite(digit_kind, points % 10));
	...
	for (i = 1; i < ((is_fixed_digit_count != FALSE) ? digit_count_max : sc1PStageClearGetScoreDigitCount(points, digit_count_max)); i++)
	{
		...
		sobj = gcAppendSObjWithSprite(gobj, sc1PStageClearGetScoreDigitSprite(digit_kind, digit % 10));
	...
	if (is_negative != FALSE)
	{
		if (digit_kind == 1)
		{
			sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[4], &lSC1PStageClearPointsNSign));
		}
		sc1PStageClearSetDigitSpriteColor(sobj, digit_kind, colors);
...
void sc1PStageClearMakeTextSObjs(void)
{
	...
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextShadow));
	...
	{
		sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextResult));
		sobj->sprite.attr &= ~SP_FASTCOPY;
		sobj->sprite.attr |= SP_TRANSPARENT;
	...
	{
		sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextClear));
...
void sc1PStageClearMakeTimerTextSObjs(f32 y)
{
	...
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextTimer));
	...
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextColon));
...
void sc1PStageClearMakeDamageTextSObjs(f32 y)
{
	...
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextDamage));
...
void sc1PStageClearMakeTargetTextSObjs(void)
{
	...
	gcAddGObjDisplay(gobj, sc1PStageClearTextProcRender, 26, GOBJ_DLLINKORDER_DEFAULT, -1);
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextTarget));
...
void func_ovl56_80132E40(f32 x, f32 y, s32 objective_num)
{
	...
	{
	case nSC1PGameStageBonus1:
		sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[5], &lSC1PStageClearTarget));
		break;

	case nSC1PGameStageBonus2:
		sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[5], &lSC1PStageClearPlatform));
		break;
	}
	sobj->sprite.attr &= ~SP_FASTCOPY;
	sobj->sprite.attr |= SP_TRANSPARENT;
...
s32 sc1PStageClearAppendBonusStatGetPoints(s32 bonus_id, s32 bonus_num, f32 x, f32 y)
{
	...
	if (bonus_id == nSC1PGameBonusGameClear)
		...
		sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], dSC1PStageClearBonusData[bonus_id].offset));
	...
	{
		sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[4], &lSC1PStageClearBonusMultiplySign));
	...
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[4], &lSC1PStageClearBonusColon));
...
void sc1PStageClearMakeBonusTable(void)
{
	...
	sobj = gcAppendSObjWithSprite(gobj, gcGetDataFromFile(Sprite*, sSC1PStageClearFiles[0], &lSC1PStageClearTextSpecialBonus));
...
{
	0x00000000, func_8000A5E4, func_8000A340, &ovl56_BSS_END,
	0x00000000, 0x00000001, 0x00000002, 0x00004E20,
	0x00001000, 0x00000000, 0x00000000, 0x00008000,
	0x00020000, 0x0000C000, sc1PStageClearProcLights, 0x80004310,
	0x00000000, 0x00000600, 0x00000000, 0x00000000,
	0x00000000, 0x00000000, 0x00000088, 0x00000000,
	0x800D5CAC, 0x00000000, 0x00000000, 0x00000000,
	0x00000000, 0x00000088, 0x00000000, 0x0000006C,
	0x00000000, 0x00000090, sc1PStageClearProcStart
};
