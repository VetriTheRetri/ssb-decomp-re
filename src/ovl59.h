...
extern void syMatrixTraRotRpyRSca_f(Mtx44f mf,f32 dx,f32 dy,f32 dz,f32 r,f32 p,f32 h,f32 sx,f32 sy,f32 sz);
...
extern intptr_t lCreditsAObjStream;             // 00007338
...
// 8013A8DC
AObjStream *gCreditsNameAObjStream;
