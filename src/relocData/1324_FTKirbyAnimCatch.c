...
u16 dFTKirbyAnimCatch_joint22[118] = {
	...
	ftAnimEnd(),
	0x40C0, 0x0000, 0x0000, 0x482E, 0x0000, 0x0000, 0x0000, 0x0000, 0x38C1, 0x0006, 0x0258, 0x0690, 0x38C1, 0x000A, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
};
