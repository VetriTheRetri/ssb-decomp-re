...
u16 dFTKirbyAnimInhaleEnd_joint24[70] = {
	...
	ftAnimEnd(),
	0x4080, 0x0708, 0x486E, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x3881, 0x0002, 0x0000, 0x3881, 0x0012, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
};
