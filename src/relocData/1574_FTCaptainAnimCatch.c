...
u16 dFTCaptainAnimCatch_joint25[94] = {
	...
	ftAnimEnd(),
	0x40C0, 0x0080, 0x02BA, 0x482E, 0x0000, 0x0648, 0x0000, 0x015B, 0x38C1, 0x0006, 0xFE43, 0x0404, 0x38C1, 0x000A, 0x0080, 0x02BA, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
};
