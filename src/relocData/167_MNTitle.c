...
u32 dMNTitle_LogoAnimJoint_AnimJoint_0x251E4[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    ...
	    0x3FB33333,  /* 1.399999976158142f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 110),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 59),
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LogoAnimJoint_AnimJoint_0x25218[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX, 30),
	    0xC2040000,  /* -33.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 29),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3FB37574,  /* 1.402021884918213f */
	    0x3FB37574,  /* 1.402021884918213f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX, 80),
	    0xC1B80000,  /* -23.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 80),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAX, 60),
	    0xC1B80000,  /* -23.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
...
u32 dMNTitle_LogoAnimJoint_AnimJoint_0x25284[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAY, 60),
	    0xC1C80000,  /* -25.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 59),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAY, 50),
	    0xC1900000,  /* -18.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 50),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
...
u32 dMNTitle_LogoAnimJoint_AnimJoint_0x252F0[] = {
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 110),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 110),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 60),
	    0x42C80000,  /* 100.0f */
	    0x42700000,  /* 60.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3F800000,  /* 1.0f */
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25390[13] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0f */
	    0x40A00000,  /* 5f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 60),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 56),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x253C4[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0f */
	    0x40800000,  /* 4f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 24),
	    0x00000000,  /* 0f */
	    0x40800000,  /* 4f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 36),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 32),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25404[16] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 51),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 47),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25444[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x40A00000,  /* 5f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 12),
	    0x40A00000,  /* 5f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 48),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 44),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25484[16] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 54),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 50),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x254C4[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3727C5AC,  /* 1e-05f */
	    0x40800000,  /* 4f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 21),
	    0x3727C5AC,  /* 1e-05f */
	    0x40800000,  /* 4f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 39),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 35),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25504[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x40A00000,  /* 5f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 30),
	    0x40A00000,  /* 5f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 30),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 26),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25544[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x40800000,  /* 4f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 15),
	    0x40800000,  /* 4f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 45),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 41),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25584[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x40A00000,  /* 5f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 36),
	    0x40A00000,  /* 5f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 24),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 20),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x255C4[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0f */
	    0x40800000,  /* 4f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 3),
	    0x00000000,  /* 0f */
	    0x40800000,  /* 4f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 57),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 53),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25604[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3727C5AC,  /* 1e-05f */
	    0x40800000,  /* 4f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 33),
	    0x3727C5AC,  /* 1e-05f */
	    0x40800000,  /* 4f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 27),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 23),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25644[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3727C5AC,  /* 1e-05f */
	    0x40A00000,  /* 5f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 18),
	    0x3727C5AC,  /* 1e-05f */
	    0x40A00000,  /* 5f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 42),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 38),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25684[16] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3727C5AC,  /* 1e-05f */
	    0x40A00000,  /* 5f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 27),
	    0x3727C5AC,  /* 1e-05f */
	    0x40A00000,  /* 5f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 8),
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 33),
	    0x3F800000,  /* 1f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 29),
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};

u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x256C4[18] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0xC30E8000,  /* -142.5f */
	    0x3727C5AC,  /* 1e-05f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 30),
	    0xC30E8000,  /* -142.5f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 29),
	    0x3727C5AC,  /* 1e-05f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3F800000,  /* 1f */
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAY, 34),
	    0xC2B00000,  /* -88f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 34),
	    0x3F800000,  /* 1f */
	    0x3F800000,  /* 1f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x2570C[22] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    ...
	    0x3727C5AC,  /* 1e-05f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 36),
	    0x43013333,  /* 129.2f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 35),
	    0x3727C5AC,  /* 1e-05f */
	    0x3727C5AC,  /* 1e-05f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3F800000,  /* 1f */
	...
	aobjEvent32SetTargetRate(AOBJ_FLAG_TRAY, 0),
	    0xBFCAF553,  /* -1.58561f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 28),
	    0x3F800000,  /* 1f */
	    0x3F800000,  /* 1f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAY, 27),
	    0x42D20000,  /* 105f */
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25370[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0.0f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 11),
	    0x00000000,  /* 0.0f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_SCAX, 0),
	    0x3A81192F,  /* 0.0009849424241110682f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 5),
	...
	aobjEvent32Wait(1),
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX, 1),
	    0x3F8D8BC5,  /* 1.1058279275894165f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAY, 2),
	    0x3FB33333,  /* 1.399999976158142f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX, 1),
	    0x3FB33333,  /* 1.399999976158142f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAX, 3),
	    0x3F800000,  /* 1.0f */
	aobjEvent32Wait(1),
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAY, 2),
	    0x3F800000,  /* 1.0f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25448[] = {
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 3),
	    0x3FB33334,  /* 1.4000000953674316f */
	    0x3FB33334,  /* 1.4000000953674316f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 10),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 3),
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x254F4[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 0),
	    0xC1200000,  /* -10.0f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAX, 6),
	    0x3FC00000,  /* 1.5f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAX, 9),
	    0xC1F5CA71,  /* -30.723848342895508f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 9),
	    0x42200000,  /* 40.0f */
	    0xBE088887,  /* -0.13333331048488617f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAY, 3),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAY, 3),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 2),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 8),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32Wait(1),
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 7),
	    0xC1F5CA71,  /* -30.723848342895508f */
	    0x42200000,  /* 40.0f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3D9BD484,  /* 0.07608893513679504f */
	    0xBD754070,  /* -0.05987590551376343f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 0),
	    0xC01A075C,  /* -2.4066991806030273f */
	    0xBF6C373E,  /* -0.9227179288864136f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 10),
	    0xC34D8474,  /* -205.51739501953125f */
	    0xBF949266,  /* -1.1607177257537842f */
	    0xC1FAC9A4,  /* -31.34845733642578f */
	    0x40AD860D,  /* 5.422613620758057f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 4),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 2),
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 7),
	    0x400CCCCD,  /* 2.200000047683716f */
	    0x3FE66669,  /* 1.8000003099441528f */
	aobjEvent32Wait(2),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 2),
	    0x42CCA9A4,  /* 102.33132934570312f */
	    0x408075DF,  /* 4.014388561248779f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 2),
	    0xC374E6B2,  /* -244.90115356445312f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_TRAX, 0),
	    0x408DA7CF,  /* 4.426734447479248f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 14),
	    0xC2D20000,  /* -105.0f */
	    0x40C8A50D,  /* 6.270147800445557f */
	    0x41C00000,  /* 24.0f */
	    0xC19371AE,  /* -18.43050765991211f */
	aobjEvent32Wait(3),
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 11),
	    0x3F800000,  /* 1.0f */
	    0x3F19999A,  /* 0.6000000238418579f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 8),
	    0xC2D20000,  /* -105.0f */
	    0x41C00000,  /* 24.0f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 5),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25678[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x4191CEDA,  /* 18.226001739501953f */
	    0x41C00000,  /* 24.0f */
	    0x40A00000,  /* 5.0f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 16),
	    0x41C00000,  /* 24.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 4),
	    0x4191CEDA,  /* 18.226001739501953f */
	    0x40A00000,  /* 5.0f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	...
	aobjEvent32SetVal(AOBJ_FLAG_TRAX, 5),
	    0x41F00000,  /* 30.0f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX, 2),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 2),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 10),
	    ...
	    0x3F800000,  /* 1.0f */
	aobjEvent32Wait(1),
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 7),
	    0x41F00000,  /* 30.0f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_TRAX, 0),
	    0x404BAB0C,  /* 3.182314872741699f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 9),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX, 5),
	    0x4012B4E0,  /* 2.2922897338867188f */
	aobjEvent32SetValRate(AOBJ_FLAG_SCAY, 1),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    ...
	    0x4006B4E3,  /* 2.104790449142456f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 7),
	    0xC2100000,  /* -36.0f */
	    0xC08C7FEB,  /* -4.390614986419678f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 9),
	    0x4006B4E3,  /* 2.104790449142456f */
	    0x4006B4E3,  /* 2.104790449142456f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 7),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 11),
	    0x42D80000,  /* 108.0f */
	    0xC0E55A74,  /* -7.167291641235352f */
	    0x41C00000,  /* 24.0f */
	    0x4050C06F,  /* 3.2617452144622803f */
	aobjEvent32Wait(2),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 7),
	    0x3F800000,  /* 1.0f */
	    0xBD43C13A,  /* -0.04779169708490372f */
	    0x3F800000,  /* 1.0f */
	    0xBD43C13A,  /* -0.04779169708490372f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 2),
	    0x3FE703B1,  /* 1.8048001527786255f */
	    0x3FE7035D,  /* 1.8047901391983032f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 7),
	    0x42D80000,  /* 108.0f */
	    0x41C00000,  /* 24.0f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x257E4[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 4),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 16),
	    0x3F800000,  /* 1.0f */
	aobjEvent32Wait(4),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 12),
	    0x3F800000,  /* 1.0f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25824[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    ...
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 21),
	    0xC30E8000,  /* -142.5f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 29),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAY, 26),
	    0xC2B00000,  /* -88.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY, 3),
	    0xC2B00000,  /* -88.0f */
	aobjEvent32End(),
};
...
u32 dMNTitle_LabelsAnimJoint_AnimJoint_0x25870[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    ...
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 26),
	    0x43013333,  /* 129.1999969482422f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 25),
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	    0x3727C5AC,  /* 9.999999747378752e-06f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x3F800000,  /* 1.0f */
	...
	aobjEvent32SetVal(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 24),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
...
u32 dMNTitle_PressStartAnimJoint_AnimJoint_0x258D8[14] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x3F800000,  /* 1f */
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 19),
	    0x3F800000,  /* 1f */
	    0x3F800000,  /* 1f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 1),
	    0x00000000,  /* 0f */
...
u32 dMNTitle_PressStartAnimJoint_AnimJoint_0x2591C[155] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 0),
	    0x00000000,  /* 0f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 12),
	    0xBF435608,  /* -0.763031f */
	    0xBBB879E5,  /* -0.00562977f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 4),
	    0x00000000,  /* 0f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX, 15),
	    0xBE9999A1,  /* -0.3f */
	aobjEvent32Wait(8),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 15),
	    0x3ED45E7C,  /* 0.414783f */
	    0x3CCE0E2D,  /* 0.0251532f */
	aobjEvent32Wait(7),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 6),
	    0x00000000,  /* 0f */
	    0x3D12492B,  /* 0.0357143f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 8),
	    0x3E4CCCD5,  /* 0.2f */
	...
	aobjEvent32Wait(6),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 6),
	    0xB3000000,  /* -2.98023e-08f */
	    0xBC7C0FCA,  /* -0.0153846f */
	aobjEvent32Wait(5),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 8),
	    0x3F0C27F1,  /* 0.547484f */
	    0x3C53AA65,  /* 0.012919f */
	aobjEvent32Wait(1),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 7),
	    0x00000000,  /* 0f */
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 8),
	    ...
	    0xBC14F20C,  /* -0.00909091f */
	aobjEvent32Wait(1),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY, 4),
	...
	aobjEvent32Wait(3),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 3),
	    0xBE4CCCD5,  /* -0.2f */
	...
	aobjEvent32Wait(2),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 13),
	...
	aobjEvent32Wait(1),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 13),
	    0xBEF12FB0,  /* -0.471067f */
	    0x3B1B9292,  /* 0.00237385f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 9),
	    0x3B3F42F2,  /* 0.00291842f */
	    0x3BA546D4,  /* 0.00504384f */
	aobjEvent32Wait(1),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY, 8),
	    0xBEB52E6B,  /* -0.35387f */
	    0x3BFC5882,  /* 0.00770098f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 11),
	...
	aobjEvent32Wait(1),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 11),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 19),
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX, 22),
	    0x00000000,  /* 0f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY, 7),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAY, 5),
	    0x00000000,  /* 0f */
	aobjEvent32SetAnim(0x000, 0),
...
u32 dMNTitle_PressStartAnimJoint_AnimJoint_0x25B88[158] = {
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 0),
	    0x00000000,  /* 0f */
	    0x00000000,  /* 0f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 28),
	    0x3DFB94CF,  /* 0.122842f */
	...
	aobjEvent32Wait(5),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 14),
	    0xBDF22556,  /* -0.118235f */
	    0x3B932B00,  /* 0.00449121f */
	aobjEvent32Wait(4),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 13),
	    0xBD4CCCD5,  /* -0.05f */
	...
	aobjEvent32Wait(5),
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX, 7),
	    0x3E9999A1,  /* 0.3f */
	aobjEvent32Wait(3),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 9),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 8),
	    0xBE4CCCD5,  /* -0.2f */
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 5),
	    0x00000000,  /* 0f */
	...
	aobjEvent32Wait(2),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 7),
	    0xB3000000,  /* -2.98023e-08f */
	    0x3C7F5FCD,  /* 0.0155868f */
	aobjEvent32Wait(6),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 10),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 8),
	    ...
	    0xBD143503,  /* -0.0361834f */
	aobjEvent32Wait(3),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 16),
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAX, 15),
	    0x00000000,  /* 0f */
	aobjEvent32Wait(5),
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAY, 10),
	    0x00000000,  /* 0f */
	aobjEvent32SetAnim(0x000, 0),
...
u32 dMNTitle_PressStartAnimJoint_AnimJoint_0x25E08[23] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 0),
	    0xC3120000,  /* -146f */
	    0x431B8000,  /* 155.5f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 16),
	    0xC2A70000,  /* -83.5f */
	    0x42600000,  /* 56f */
	aobjEvent32Cmd12(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 6),
	aobjEvent32SetValRate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x403F6F54,  /* 2.99117f */
	...
	aobjEvent32SetValRate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 12),
	    0x3F800000,  /* 1f */
	    0x3E6407A5,  /* 0.222685f */
	    0x3F800000,  /* 1f */
	    0x3E658B0A,  /* 0.224163f */
	aobjEvent32Wait(10),
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAY, 2),
	    0xC2A70000,  /* -83.5f */
	    0x42600000,  /* 56f */
	aobjEvent32End(),
};
...
u32 dMNTitle_SlashAnimJoint_AnimJoint_0x25E84[] = {
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 0),
	    0x3FC050F0,  /* 1.5024700164794922f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 30),
	    0x3FC05100,  /* 1.502471923828125f */
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 5),
	    0x3E312C78,  /* 0.17302119731903076f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX, 15),
...
u32 dMNTitle_SlashAnimJoint_AnimJoint_0x25EBC[] = {
	...
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY, 29),
...
u32 dMNTitle_SlashAnimJoint_AnimJoint_0x25EF4[] = {
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 0),
	    0x40251EB8,  /* 2.5799999237060547f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 60),
	    0x40251EB5,  /* 2.5799992084503174f */
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 5),
	    0x3ED13099,  /* 0.4085738956928253f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 15),
	    0x3A83126F,  /* 0.0010000000474974513f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32End(),
};
...
u32 dMNTitle_SlashAnimJoint_AnimJoint_0x25F24[] = {
	...
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 59),
	    0x438FFAE2,  /* 287.96002197265625f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAX, 15),
...
u32 dMNTitle_SlashMat_AnimJoint_0x25F74[] = {
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX, 33),
	    0x3F800000,  /* 1.0f */
...
u32 dMNTitle_SlashMat_AnimJoint_0x25FB4[] = {
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY, 64),
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY, 1),
	    0x40000000,  /* 2.0f */
	    0x40000000,  /* 2.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY, 1),
	    0x40400000,  /* 3.0f */
	...
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY, 1),
	    0x40A00000,  /* 5.0f */
	    0x40A00000,  /* 5.0f */
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY, 1),
	    0x40C00000,  /* 6.0f */
	    0x40C00000,  /* 6.0f */
	aobjEvent32Wait(12),
	aobjEvent32End(),
...
u32 dMNTitle_FireAnimJoint_AnimJoint_0x29038[] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY, 20),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY, 150),
	    0xC4B9AC93,  /* -1485.3929443359375f */
	aobjEvent32End(),
};
