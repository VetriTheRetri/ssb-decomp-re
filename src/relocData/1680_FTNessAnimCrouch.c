...
u16 dFTNessAnimCrouch_joint25[52] = {
	...
	ftAnimEnd(),
	0x400E, 0x0038, 0x0000, 0x0000, 0x48E0, 0xFF82, 0xFFAE, 0xFFF4, 0x200F, 0x0001, 0xFE6C, 0xFFDC, 0xFFAA, 0xFFBA, 0xFF8F, 0xFF89, 0x380F, 0x0003, 0xFFA7, 0xFEE5, 0xFE22, 0x0000,
};
