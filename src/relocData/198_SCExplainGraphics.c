...
u32 dSCExplainGraphics_StickTapForward_MatAnimJoint[402] = {
	(u32)((u8*)dSCExplainGraphics_StickTapForward_MatAnimJoint + 0x2C),
	aobjEvent32End(),
	aobjEvent32SetValAfterBlock(0x001, 0),
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32Wait(15),
	aobjEvent32SetAnim(0x000, 0),
	(u32)((u8*)dSCExplainGraphics_StickTapForward_MatAnimJoint + 0x8),
	(u32)((u8*)dSCExplainGraphics_StickTapForward_MatAnimJoint + 0x8),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x002, 12288),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x001, 13056),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x001, 31552),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x003, 32727),
	aobjEvent32SetVal0RateBlock(0x000, 0),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x007, 32767),
	    0xB6100000,
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x00D, 32767),
	    0xFFD96310,
	aobjEvent32End(),
	aobjEvent32End(),
	...
	aobjEvent32SetValBlock(0x3FF, 32767),
	    ...
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	    0x4DFFFFFF,  /* 536870880.0f */
	    0xFFFFFFFF,  /* nanf */
	    0x00000000,  /* 0.0f */
	    0x00000003,  /* 4.203895392974451e-45f */
	    0xBFFFFFFF,  /* -1.9999998807907104f */
	    0xFFFFFFFF,  /* nanf */
	    0x00000000,  /* 0.0f */
	aobjEvent32EndRaw(0x000, 59),
	    ...
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 1215),
	    0xFFFFFFFF,
	    0xFFD96310,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x002, 32255),
	    0xFFFFFFFF,
	    0xB6100000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x2D7, 32767),
	    0xFFFFFFD7,
	aobjEvent32SetVal0RateBlock(0x000, 0),
	aobjEvent32EndRaw(0x220, 310),
	    0x9DFFFFFF,
	    0xFFFFFB40,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x077, 32767),
	    0xFFFFFFFF,
	    0xFFFFB300,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x007, 16383),
	    0xFFFFFFFF,
	    0xFFFB3000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 19967),
	    0xFFFFFFFF,
	    0xFFD40000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 2047),
	    ...
	    0xFF700000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 447),
	    0xFFFFFFFF,
	    0xFB100000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 111),
	    0xFFFFFFFF,
	    0xF6000000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 29),
	    0xFFFFFFFF,
	    0xD1000000,
	aobjEvent32End(),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x01D, 8192),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x015, 29184),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x00D, 32512),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x005, 32736),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x001, 32762),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x001, 28671),
	    0xFF000000,
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x001, 12287),
	    0xFFE00000,
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x001, 12287),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 28671),
	    0xFFFF2000,
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 12287),
	    0xFFFFF000,
	aobjEvent32End(),
	aobjEvent32End(),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 3839),
	    0xFFFFFFFF,
	aobjEvent32JumpRaw(0x1DD, 9826, 0x00000000),
	aobjEvent32EndRaw(0x000, 2815),
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x05F, 32767),
	    0xFFFEA622,
	...
	aobjEvent32End(),
	    ...
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32SetTargetRate(0x1FF, 32767),
	    0xFFFFFFFF,  /* nanf */
	    0xFFFFFFFF,  /* nanf */
	    0x00000000,  /* 0.0f */
	    0x006FFFFF,  /* 1.0285574168396551e-38f */
	    0xFFFFFFFF,  /* nanf */
	    0xFFFFFFFF,  /* nanf */
	    0x00000000,  /* 0.0f */
	    0x0002FFFF,  /* 2.755050871755093e-40f */
	    0xFFFFFFFF,  /* nanf */
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 3839),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32SetValAfterBlock(0x0F3, 15855),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	    0x0000016A,  /* 5.072700440855838e-43f */
	    0xDFFFFFFF,  /* -3.6893485948395848e+19f */
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32JumpRaw(0x11B, 32767, 0xFFFFFFFF),
	aobjEvent32End(),
	aobjEvent32End(),
	    0x6CFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 41),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 959),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 19711),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x009, 20479),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x079, 32767),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32JumpRaw(0x17F, 32767, 0xFFFFFFFF),
	    0xFFFFFFFF,
	aobjEvent32End(),
	aobjEvent32SetVal(0x3FF, 32767),
	    0xFFFFFFFF,  /* nanf */
	    0xFFFFFFFF,  /* nanf */
	    0x00000000,  /* 0.0f */
	    0x6FFFFFFF,  /* 1.5845631558379571e+29f */
	    0xFFFFFFFF,  /* nanf */
	    0xFFFFFFFF,  /* nanf */
	...
	aobjEvent32EndRaw(0x000, 2815),
	    ...
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x000, 7679),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x000, 20479),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x000, 32767),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x001, 8191),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x001, 16383),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x001, 24575),
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	    0xFFFFFFFF,
	aobjEvent32EndRaw(0x001, 28671),
...
u32 dSCExplainGraphics_TapSparkMatAnimJoint_MatAnimJoint[136] = {
	(u32)((u8*)dSCExplainGraphics_TapSparkMatAnimJoint_MatAnimJoint + 0x24),
	aobjEvent32SetValAfterBlock(0x001, 0),
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32Wait(6),
	aobjEvent32End(),
	(u32)((u8*)dSCExplainGraphics_TapSparkMatAnimJoint_MatAnimJoint + 0x4),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32End(),
	    ...
	    0x54444444,
	    0x44444451,
	aobjEvent32SetValAfterBlock(0x288, 17476),
	    0x44444511,  /* 785.0791625976562f */
	    0x11544444,  /* 1.674488716050302e-28f */
	    0x44445111,  /* 785.2666625976562f */
	aobjEvent32SetVal0RateBlock(0x22A, 17476),
	    0x44451111,  /* 788.2666625976562f */
	    0x11115444,  /* 1.1464449476179872e-28f */
	    0x44511111,  /* 836.2666625976562f */
	    0x11111544,  /* 1.1445036102340449e-28f */
	    0x44444441,
	aobjEvent32SetValAfterBlock(0x088, 17476),
	...
	aobjEvent32Cmd17(0x044, 8737),
	    0x12222222,  /* 5.11602585979567e-28f */
	aobjEvent32Cmd17(0x0C2, 4369),
	    0x11111622,  /* 1.1445303325120232e-28f */
	    0x22261111,  /* 2.2506229959314827e-18f */
	aobjEvent32SetVal0RateBlock(0x222, 25122),
	    0x22226111,  /* 2.200648052043479e-18f */
	    0x11162222,  /* 1.1843431563223962e-28f */
	    0x22222611,  /* 2.1975246180504788e-18f */
	aobjEvent32SetVal0RateBlock(0x2C4, 8738),
	    0x22222261,  /* 2.1973294034259163e-18f */
	    0x16222222,  /* 1.3097026201076916e-25f */
	    0x22222226,  /* 2.197317202511881e-18f */
	    0x62222222,  /* 7.477080170718613e+20f */
	aobjEvent32Cmd17(0x044, 8738),
	    0x22222222,  /* 2.1973163753312686e-18f */
	aobjEvent32Cmd17(0x044, 8738),
	    0x22222222,  /* 2.1973163753312686e-18f */
	...
	aobjEvent32EndRaw(0x003, 32767),
	    0xF8010681,
	aobjEvent32EndRaw(0x37F, 1279),
	    0xF529F83F,
	    0xF83FF83F,
	    0xF83FF83F,
	    0xF83FF83F,
	    0xF83FF83F,
	aobjEvent32EndRaw(0x025, 32750),
	aobjEvent32End(),
	aobjEvent32SetValBlock(0x2FE, 0),
	    0xFFFFFFFF,  /* nanf */
	    0xFFE5FFEE,  /* nanf */
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
