...
u32 dNMarioMain_animlock[2] = {
	0x10425200,
	0x00000000,
};

/* @ 0x000C, 8 bytes: FTAttributes.setup_parts target (was dNMarioMain_pre+0xC) */
u32 dNMarioMain_setup_parts[2] = {
	0xFFFFFF00,
	0x00000000,
};

/* @ 0x0014, 64 bytes: FTAttributes.hiddenparts target (was dNMarioMain_pre+0x14) */
u32 dNMarioMain_hiddenparts[16] = {
	0x00000002,
	0x00000000,
	0x00000001,
	0x00000003,
...
/* @ 0x0054, 100 bytes: FTAttributes.modelparts_container target (was dNMarioMain_pre+0x54) */
u32 dNMarioMain_modelparts_container[25] = {
	0x00000000,
	0x00000000,
	0x00000000,
	0x00000000,
...
u32 dNMarioMain_commonparts_container[8] = {
...
/* @ 0x00DC, 432 bytes: FTAttributes.thrown_status target (was dNMarioMain_pre+0xDC) */
u32 dNMarioMain_thrown_status[108] = {
	0xFFFFFFFF,
	0x000000BA,
	0x000000B6,
	0x000000B9,
...
/* @ 0x028C, 12 bytes: FTAttributes.sprites target (was dNMarioMain_pre+0x28C) */
u32 dNMarioMain_sprites[3] = {
	0x00000000,
	0x00000000,
...
FTAttributes dNMarioMain_attr = {
	...
	(u32*)dNMarioMain_setup_parts, /* setup_parts */
	(u32*)dNMarioMain_animlock, /* animlock */
	{ 12, 15, 20, 25, 9 }, /* effect_joint_ids */
	{ FALSE, TRUE, FALSE, FALSE, FALSE }, /* cliff_status_ga */
	0, /* unused_0x2CC */
	(FTHiddenPart*)dNMarioMain_hiddenparts, /* hiddenparts */
	(FTCommonPartContainer*)dNMarioMain_commonparts_container, /* commonparts_container */
	NULL, /* dobj_lookup */
	...
	(FTSprites*)dNMarioMain_sprites, /* sprites */
	NULL, /* skeleton */
};
