...
FTHiddenPart dNMarioMain_hiddenparts[4] = {
...
FTModelPartDesc *dNMarioMain_modelparts_container[25] = {
...
FTThrownStatus dNMarioMain_thrown_status[54] = {
...
FTAttributes dNMarioMain_attr = {
	...
	&dNMarioMain_commonparts_container, /* commonparts_container */
	NULL, /* dobj_lookup */
