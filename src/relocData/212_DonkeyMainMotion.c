...
u32 dDonkeyMainMotion_0x0C14[] = {
	/* FTThrowHitDesc */ -1, 2, 361, 100, 0, 0, 0, /* status, damage, angle, kb_scale, kb_weight, kb_base, element */
	/* FTThrowHitDesc */ -1, 2, 361, 100, 0, 0, 0, /* status, damage, angle, kb_scale, kb_weight, kb_base, element */
};
...
u32 dDonkeyMainMotion_0x0CF0[] = {
	/* FTThrowHitDesc */ 52, 8, 45, 80, 0, 70, 0, /* status, damage, angle, kb_scale, kb_weight, kb_base, element */
	/* FTThrowHitDesc */ -1, 2, 361, 100, 0, 0, 0, /* status, damage, angle, kb_scale, kb_weight, kb_base, element */
};
...
u32 dDonkeyMainMotion_0x0D88[] = {
	/* FTThrowHitDesc */ 52, 18, 45, 70, 0, 80, 0, /* status, damage, angle, kb_scale, kb_weight, kb_base, element */
	/* FTThrowHitDesc */ -1, 9, 361, 100, 0, 0, 0, /* status, damage, angle, kb_scale, kb_weight, kb_base, element */
};
