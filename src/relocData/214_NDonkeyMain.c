...
FTHiddenPart dNDonkeyMain_hiddenparts[4] = {
...
FTModelPartDesc *dNDonkeyMain_modelparts_container[26] = {
...
FTCommonPartContainer dNDonkeyMain_commonparts_container = {
	{
		{ (DObjDesc*)&dNDonkeyModel_JointTree, NULL, NULL, 0x00 },
		{ (DObjDesc*)&dNDonkeyModel_JointTree, NULL, NULL, 0x00 },
	},
};

/* @ 0x00DC, 432 bytes: FTAttributes.thrown_status target (was dNDonkeyMain_pre+0xDC) */
FTThrownStatus dNDonkeyMain_thrown_status[54] = {
