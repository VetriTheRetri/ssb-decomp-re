...
extern ftMotionCommand dKirbyMainMotion_Damage_0x1088[];
...
extern u32 dKirbyMainMotion_Jab_Subroutine[];
...
extern FTThrowHitDesc dKirbyMainMotion_ThrowB_HitDesc[2];
...
ftMotionCommand dKirbyMainMotion_Catch[] = {
	ftMotionCommandSetThrow(dKirbyMainMotion_0x0E4C),
	ftMotionCommandEffect(0, nEFKindDustLight, 0, 0, 0, -120, 0, 60, 0),
	ftMotionCommandWaitAsync(6),
...
/* ── Region-divergent block sequence (0x0ED8 onward) ───────────────────
 * US and JP diverge structurally here: JP fragments many commands across
 * extra chain-target blocks (201 blocks vs US 96). Each move that differs
 * is wrapped whole in its own guard with its US and JP forms adjacent;
 * JP-only fragment blocks ride with the move they continue. The few blocks
 * identical in both regions stay unguarded. */
...
ftMotionCommand dKirbyMainMotion_ForwardThrow[] = {
	ftMotionCommandSetThrow(dKirbyMainMotion_0x0ED8),
	ftMotionCommandSetTexturePartID(6),
	ftMotionCommandPlaySmashVoice(nSYAudioFGMExplodeS),
...
FTThrowHitDesc dKirbyMainMotion_ThrowB_HitDesc[2] = {
	{ 54, 16, 115,  70, 0, 70, 0 },
	{ -1,  8, 361, 100, 0,  0, 0 },
};
...
ftMotionCommand dKirbyMainMotion_ThrowB[] = {
	ftMotionCommandSetTexturePartID(6),
	ftMotionCommandSetThrow(dKirbyMainMotion_ThrowB_HitDesc),
	ftMotionCommandPlaySmashVoice(nSYAudioFGMExplodeS),
...
ftMotionCommand dKirbyMainMotion_JabLoopStart[] = {
	ftMotionCommandEnd(),
};

u32 dKirbyMainMotion_Jab_Subroutine[] = {
	...
	ftMotionCommandMakeAttackColl(1, 0, 16, 1, 1, 0, 180, 200, 0, 0, 70, 50, 0, 3, 0, 1, 0, 8),
#endif
	ftMotionCommandPlayFGMStoreInfo(nSYAudioFGMLightSwingS),
	ftMotionCommandWait(2),
	ftMotionCommandClearAttackCollAll(),
...
ftMotionCommand dKirbyMainMotion_JabLoop[] = {
	ftMotionCommandSetTexturePartID(6),
	ftMotionCommandSetFlag2(1),
	ftMotionCommandSubroutine(dKirbyMainMotion_Jab_Subroutine),
	ftMotionCommandWaitAsync(6),
...
// Inline f32 table, not motion script: the original split mis-decoded these
// 36 floats as ftMotionCommands (e.g. -30.0f = 0xC1F00000 read as HideItem).
// Unreferenced inline data; 6 rows x 6, cols 0/4/5 constant (-30, 180, -30).
f32 dKirbyMainMotion_0x1220[36] = {
...
ftMotionCommand dKirbyMainMotion_JabLoopEnd[] = {
	ftMotionCommandEnd(),
};

ftMotionCommand dKirbyMainMotion_DashAttack[] = {
	ftMotionCommandWaitAsync(4),
...
#else
	ftMotionCommandMakeAttackColl(0, 0, 29, 18, 1, 0, 320, 140, 0, 0, 90, 120, 0, 3, 0, 2, 1, 24),
...
#else
	ftMotionCommandMakeAttackColl(0, 0, 29, 20, 1, 0, 300, 180, 0, 0, 34, 75, 0, 3, 0, 2, 1, 40),
...
#else
	ftMotionCommandMakeAttackColl(0, 0, 5, 16, 1, 0, 300, 0, 60, 0, 361, 100, 100, 3, 0, 1, 0, 10),
#endif
	ftMotionCommandWaitAsync(8),
#if defined(REGION_US)
	ftMotionCommandSetAttackCollDamage(0, 10),
...
u32 dKirbyMainMotion_FinalCutterLand[] = {
	ftMotionCommandSetSlopeContour(4),
	ftMotionPlayVoice(nSYAudioVoiceKirbySmash1),
	ftMotionCommandSetFlag2(2),
...
ftMotionCommand dKirbyMainMotion_InhaleStartGround[] = {
...
ftMotionCommand dKirbyMainMotion_InhaleStuffed[] = {
	ftMotionCommandSetTexturePartID(10),
	ftMotionCommandEnd(),
};
...
ftMotionCommand dKirbyMainMotion_LuigiFireballGround[] = {
	ftMotionCommandEffect(0, nEFKindDustDashSmall, 0, 0, 0, -210, 0, 0, 0),
};
...
ftMotionCommand dKirbyMainMotion_LuigiFireball[] = {
	ftMotionCommandEffect(0, nEFKindDustLight, 0, 0, 0, -200, 0, 0, 0),
	ftMotionCommandGoto(dKirbyMainMotion_0x1D88),
};

/* Ground-entry to the second LuigiFireball-copy script; falls through into the
 * 0x1DD8 body just as LuigiFireballGround falls through into 0x1D88. JP merges
 * this fragment and the 0x1DD8 body into one LuigiFireballGround_0x1DC8 block. */
ftMotionCommand dKirbyMainMotion_LuigiFireballGround_0x1DC8[] = {
	ftMotionCommandEffect(0, nEFKindDustDashSmall, 0, 0, 0, -210, 0, 0, 0),
};
...
ftMotionCommand dKirbyMainMotion_LaserGround_0x1E18[] = {
	ftMotionCommandHideItem(0),
...
ftMotionCommand dKirbyMainMotion_ChargeShotStart[] = {
	ftMotionCommandSetSlopeContour(3),
...
ftMotionCommand dKirbyMainMotion_ShootingChargeShot[] = {
	ftMotionCommandSetSlopeContour(3),
	ftMotionCommandSetColAnim(nGMColAnimFighterFoxSpecialHiStart, 0),
	ftMotionCommandSetFlag0(1),
	ftMotionCommandMakeRumble(0, 9),
...
ftMotionCommand dKirbyMainMotion_Boomerang_0x2174[] = {
...
ftMotionCommand dKirbyMainMotion_0x218C[] = {
