...
#if defined(REGION_JP)
u8 dGRMetalMap_item_weights[20] = { 0x46, 0x28, 0x78, 0x00, 0x14, 0x08, 0x06, 0x0A, 0x05, 0x0C, 0x16, 0x08, 0x0A, 0x07, 0x0A, 0x0A, 0x0A, 0x05, 0x05, 0x12 };
#else
u8 dGRMetalMap_item_weights[20] = { 0x3C, 0x28, 0x78, 0x00, 0x14, 0x08, 0x06, 0x0A, 0x05, 0x0C, 0x16, 0x08, 0x0A, 0x07, 0x0A, 0x0A, 0x0A, 0x05, 0x05, 0x12 };
#endif
#else
#if defined(REGION_JP)
u8 dGRMetalMap_item_weights[20] = { 0x46, 0x28, 0x78, 0x00, 0x01, 0x00, 0x06, 0x0A, 0x05, 0x0C, 0x16, 0x08, 0x0A, 0x07, 0x0A, 0x0A, 0x0A, 0x05, 0x05, 0x12 };
#else
