...
u32 dMarioShieldPose_script2_1[19] = {
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAX, 0),
	    0xBE860A92,  /* -0.2617993950843811f */
	    0x41100000,  /* 9.0f */
	aobjEvent32SetValRate(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAX, 90),
...
u32 dMarioShieldPose_script2_3[16] = {
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTZ, 15),
	    0x00000000,  /* 0.0f */
...
u32 dMarioShieldPose_script2_7[7] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script3_1[20] = {
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAX, 90),
	    ...
	    0x00000000,  /* 0.0f */
	    0xBD088889,  /* -0.03333333507180214f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAX, 45),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script4_1[20] = {
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAX, 0),
	    0xBE567750,  /* -0.20943951606750488f */
	    0xBB05720F,  /* -0.0020362173672765493f */
	    0xBF060A92,  /* -0.5235987901687622f */
	    0xBB8EFA35,  /* -0.004363323096185923f */
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 180),
	    0x00000000,  /* 0.0f */
...
u32 dMarioShieldPose_script4_7[8] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 90),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script5_5[29] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 38),
...
u32 dMarioShieldPose_script5_6[19] = {
	...
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 30),
...
u32 dMarioShieldPose_script5_7[8] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 135),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script6_5[33] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTZ, 39),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTZ, 4),
...
u32 dMarioShieldPose_script6_6[18] = {
	...
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 39),
	    0x00000000,  /* 0.0f */
	    0xBC11DB61,  /* -0.00890240166336298f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 1),
	    0xBC91DB61,  /* -0.01780480332672596f */
...
u32 dMarioShieldPose_script6_7[8] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 180),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script7_7[8] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 225),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script8_1[16] = {
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAX, 0),
	    ...
	    0x00000000,  /* 0.0f */
	    0x3D088889,  /* 0.03333333507180214f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAX, 90),
	    0x3EBBA866,  /* 0.36651915311813354f */
	    0x00000000,  /* 0.0f */
	    0xBE860A92,  /* -0.2617993950843811f */
	    0x41100000,  /* 9.0f */
...
u32 dMarioShieldPose_script8_7[8] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 270),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
...
u32 dMarioShieldPose_script9_7[8] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 360),
	    0x3FA78D36,  /* 1.3089969158172607f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 315),
	aobjEvent32Wait(45),
	aobjEvent32End(),
};
