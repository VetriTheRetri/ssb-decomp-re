...
extern u16 dNessModel_palette_0xACD8[];
extern u16 dNessModel_palette_0xAE08[];
extern u16 dNessModel_palette_0xBD98[];
extern u16 dNessModel_palette_0xBDC0[];
...
extern MObjSub dNessModel_gap_0x2C04_sub_0x4CC[];
extern MObjSub dNessModel_gap_0x2C04_sub_0x544[];
extern MObjSub dNessModel_gap_0x2C04_sub_0x5BC[];
...
u8 dNessModel_Joint_0x0040_post[160] = {
...
MObjSub dNessModel_Joint_0x0040_post_sub_0xA0[1] = {
	{
		...
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x2C),
		0x0004,
		0x02, 0x00,
		0x0010,
...
MObjSub dNessModel_Joint_0x0040_post_sub_0x118[1] = {
	{
		...
		0.8686000108718872f, 0.949999988079071f,
		0.065700002014637f, 0.8686000108718872f,
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x3C),
		0x0004,
		0x02, 0x00,
		0x0010,
		0x0020, 0x0020, 0x0020,
...
MObjSub dNessModel_Joint_0x0040_post_sub_0x208[1] = {
	{
		...
		1.0f, 1.0f,
		0.0f, 1.0f,
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x4C),
		0x0004,
		0x02, 0x00,
		0x0008,
...
MObjSub dNessModel_Joint_0x0040_post_sub_0x280[1] = {
	{
		0x0000,
		0x02, 0x02,
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x5C),
...
MObjSub dNessModel_Joint_0x0040_post_sub_0x3E8[1] = {
	{
		...
		1.0f, 1.0f,
		0.0f, 1.0f,
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x70),
		0x0004,
		0x02, 0x00,
		0x0008,
		0x0008, 0x0008, 0x0010,
...
MObjSub dNessModel_Joint_0x0040_post_sub_0x460[1] = {
	{
		...
		1.0f, 1.0f,
		0.0f, 1.0f,
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x80),
		0x0004,
		0x02, 0x00,
		0x0008,
...
MObjSub dNessModel_Joint_0x0040_post_sub_0x550[1] = {
	{
		...
		1.0f, 1.0f,
		0.0f, 1.0f,
		(void**)((u8*)dNessModel_Joint_0x0040_post + 0x90),
		0x0004,
		0x02, 0x00,
		0x0008,
		0x0008, 0x0008, 0x0008,
...
u32 dNessModel_gap_0x2C04_sub_0x278[4] = {
	0x0BA03018,
	0x0BA12B36,
	0x0BA22B82,
	0x0BA32ABE,
...
u32 dNessModel_gap_0x2C04_sub_0x288[4] = {
	0x0BA43018,
	0x0BA52AAA,
	0x0BA62AB4,
	0x0BA72ABE,
...
u32 dNessModel_gap_0x2C04_sub_0x298[4] = {
	0x0BA82F70,
	0x0BA92AAA,
	0x0BAA2AB4,
	0x0BAB2F66,
...
u32 dNessModel_gap_0x2C04_sub_0x2A8[5] = {
	0x0BAC2DE8,
	0x0BAD2BE0,
	0x0BAE2C62,
	0x0BAF2D66,
...
u32 dNessModel_gap_0x2C04_sub_0x2BC[4] = {
	0x0BB12F70,
	0x0BB22AAA,
	0x0BB32AB4,
	0x0BB42F66,
...
u32 dNessModel_gap_0x2C04_sub_0x2CC[4] = {
	0x0BB53018,
	0x0BB62AAA,
	0x0BB72AB4,
	0x0BB82ABE,
...
u32 dNessModel_gap_0x2C04_sub_0x2DC[4] = {
	0x0BB93018,
	0x0BBA2AAA,
	0x0BBB2AB4,
	0x0BC72ABE,
...
u16 dNessModel_palette_0xAE08[20] = {
...
u16 dNessModel_palette_0xBD98[20] = {
	#include <NessModel/palette_0xBD98.palette.inc.c>
};

u16 dNessModel_palette_0xBDC0[20] = {
