...
/* Raw data from file offset 0x0040 to 0x06D0 (1680 bytes) */
u8 dNessModel_Joint_0x0040_post[1680] = {
	#include <NessModel/Joint_0x0040_post.data.inc.c>
};
...
/* Raw data from file offset 0x2C04 to 0x34E0 (2268 bytes) */
/* gap sub-block @ 0x2C04 (was gap+0x0, 16 bytes) */
u8 dNessModel_gap_0x2C04[16] = {
	#include <NessModel/gap_0x2C04.data.inc.c>
};
...
u8 dNessModel_gap_0x2C04_sub_0x1D8[12] = {
	#include <NessModel/gap_0x2C04_sub_0x1D8.data.inc.c>
};

/* gap sub-block @ 0x2DE8 (was gap+0x1E4, 4 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x1E4[4] = {
	#include <NessModel/gap_0x2C04_sub_0x1E4.data.inc.c>
};
...
u8 dNessModel_gap_0x2C04_sub_0x1F4[4] = {
	#include <NessModel/gap_0x2C04_sub_0x1F4.data.inc.c>
};

/* gap sub-block @ 0x2DFC (was gap+0x1F8, 4 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x1F8[4] = {
	#include <NessModel/gap_0x2C04_sub_0x1F8.data.inc.c>
};

/* gap sub-block @ 0x2E00 (was gap+0x1FC, 4 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x1FC[4] = {
	#include <NessModel/gap_0x2C04_sub_0x1FC.data.inc.c>
};

/* gap sub-block @ 0x2E04 (was gap+0x200, 4 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x200[4] = {
	#include <NessModel/gap_0x2C04_sub_0x200.data.inc.c>
};
...
u8 dNessModel_gap_0x2C04_sub_0x278[16] = {
	#include <NessModel/gap_0x2C04_sub_0x278.data.inc.c>
};

/* gap sub-block @ 0x2E8C (was gap+0x288, 16 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x288[16] = {
	#include <NessModel/gap_0x2C04_sub_0x288.data.inc.c>
};

/* gap sub-block @ 0x2E9C (was gap+0x298, 16 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x298[16] = {
	#include <NessModel/gap_0x2C04_sub_0x298.data.inc.c>
};

/* gap sub-block @ 0x2EAC (was gap+0x2A8, 20 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x2A8[20] = {
	#include <NessModel/gap_0x2C04_sub_0x2A8.data.inc.c>
};

/* gap sub-block @ 0x2EC0 (was gap+0x2BC, 16 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x2BC[16] = {
	#include <NessModel/gap_0x2C04_sub_0x2BC.data.inc.c>
};

/* gap sub-block @ 0x2ED0 (was gap+0x2CC, 16 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x2CC[16] = {
	#include <NessModel/gap_0x2C04_sub_0x2CC.data.inc.c>
};

/* gap sub-block @ 0x2EE0 (was gap+0x2DC, 16 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x2DC[16] = {
	#include <NessModel/gap_0x2C04_sub_0x2DC.data.inc.c>
};

/* gap sub-block @ 0x2EF0 (was gap+0x2EC, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x2EC[120] = {
	#include <NessModel/gap_0x2C04_sub_0x2EC.data.inc.c>
};

/* gap sub-block @ 0x2F68 (was gap+0x364, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x364[120] = {
	#include <NessModel/gap_0x2C04_sub_0x364.data.inc.c>
};

/* gap sub-block @ 0x2FE0 (was gap+0x3DC, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x3DC[120] = {
	#include <NessModel/gap_0x2C04_sub_0x3DC.data.inc.c>
};

/* gap sub-block @ 0x3058 (was gap+0x454, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x454[120] = {
	#include <NessModel/gap_0x2C04_sub_0x454.data.inc.c>
};

/* gap sub-block @ 0x30D0 (was gap+0x4CC, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x4CC[120] = {
	#include <NessModel/gap_0x2C04_sub_0x4CC.data.inc.c>
};

/* gap sub-block @ 0x3148 (was gap+0x544, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x544[120] = {
	#include <NessModel/gap_0x2C04_sub_0x544.data.inc.c>
};

/* gap sub-block @ 0x31C0 (was gap+0x5BC, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x5BC[120] = {
	#include <NessModel/gap_0x2C04_sub_0x5BC.data.inc.c>
};

/* gap sub-block @ 0x3238 (was gap+0x634, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x634[120] = {
	#include <NessModel/gap_0x2C04_sub_0x634.data.inc.c>
};

/* gap sub-block @ 0x32B0 (was gap+0x6AC, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x6AC[120] = {
	#include <NessModel/gap_0x2C04_sub_0x6AC.data.inc.c>
};

/* gap sub-block @ 0x3328 (was gap+0x724, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x724[120] = {
	#include <NessModel/gap_0x2C04_sub_0x724.data.inc.c>
};

/* gap sub-block @ 0x33A0 (was gap+0x79C, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x79C[120] = {
	#include <NessModel/gap_0x2C04_sub_0x79C.data.inc.c>
};

/* gap sub-block @ 0x3418 (was gap+0x814, 120 bytes) */
u8 dNessModel_gap_0x2C04_sub_0x814[120] = {
	#include <NessModel/gap_0x2C04_sub_0x814.data.inc.c>
};
...
/* Raw data from file offset 0x553C to 0x9050 (15124 bytes) */
/* gap sub-block @ 0x553C (was gap+0x0, 24 bytes) */
u8 dNessModel_gap_0x553C[24] = {
	#include <NessModel/gap_0x553C.data.inc.c>
};
...
u8 dNessModel_gap_0x553C_sub_0x1E0[12] = {
	#include <NessModel/gap_0x553C_sub_0x1E0.data.inc.c>
};

/* gap sub-block @ 0x5728 (was gap+0x1EC, 4 bytes) */
u8 dNessModel_gap_0x553C_sub_0x1EC[4] = {
	#include <NessModel/gap_0x553C_sub_0x1EC.data.inc.c>
};
...
u8 dNessModel_gap_0x553C_sub_0x1FC[4] = {
	#include <NessModel/gap_0x553C_sub_0x1FC.data.inc.c>
};

/* gap sub-block @ 0x573C (was gap+0x200, 4 bytes) */
u8 dNessModel_gap_0x553C_sub_0x200[4] = {
	#include <NessModel/gap_0x553C_sub_0x200.data.inc.c>
};

/* gap sub-block @ 0x5740 (was gap+0x204, 4 bytes) */
u8 dNessModel_gap_0x553C_sub_0x204[4] = {
	#include <NessModel/gap_0x553C_sub_0x204.data.inc.c>
};

/* gap sub-block @ 0x5744 (was gap+0x208, 4 bytes) */
u8 dNessModel_gap_0x553C_sub_0x208[4] = {
	#include <NessModel/gap_0x553C_sub_0x208.data.inc.c>
};
...
/* Raw tail after DL @ 0x6ED8 (16 bytes) */
u8 dNessModel_gap_0x553C_sub_0x1854_post[16] = {
...
u8 dNessModel_gap_0x553C_sub_0x25C4[16] = {
	#include <NessModel/gap_0x553C_sub_0x25C4.data.inc.c>
};

/* gap sub-block @ 0x7B10 (was gap+0x25D4, 120 bytes) */
u8 dNessModel_gap_0x553C_sub_0x25D4[120] = {
	#include <NessModel/gap_0x553C_sub_0x25D4.data.inc.c>
};
...
u8 dNessModel_gap_0x553C_sub_0x27EC[72] = {
	#include <NessModel/gap_0x553C_sub_0x27EC.data.inc.c>
};
...
u8 dNessModel_gap_0x553C_sub_0x283C[40] = {
	#include <NessModel/gap_0x553C_sub_0x283C.data.inc.c>
};
...
u8 dNessModel_gap_0x553C_sub_0x3490[12] = {
	#include <NessModel/gap_0x553C_sub_0x3490.data.inc.c>
};

/* gap sub-block @ 0x89D8 (was gap+0x349C, 120 bytes) */
u8 dNessModel_gap_0x553C_sub_0x349C[120] = {
	#include <NessModel/gap_0x553C_sub_0x349C.data.inc.c>
};
...
u8 dNessModel_gap_0x553C_sub_0x361C[1024] = {
	#include <NessModel/gap_0x553C_sub_0x361C.data.inc.c>
};
...
u8 dNessModel_gap_0x9050[24] = {
	#include <NessModel/gap_0x9050.data.inc.c>
};

/* gap sub-block @ 0x9068 (was gap+0x18, 1032 bytes) */
u8 dNessModel_gap_0x9050_sub_0x18[1032] = {
	#include <NessModel/gap_0x9050_sub_0x18.data.inc.c>
};

/* gap sub-block @ 0x9470 (was gap+0x420, 1024 bytes) */
u8 dNessModel_gap_0x9050_sub_0x420[1024] = {
	#include <NessModel/gap_0x9050_sub_0x420.data.inc.c>
};
...
/* Raw data from file offset 0x98E8 to 0x9A10 (296 bytes) */
/* gap sub-block @ 0x98E8 (was gap+0x0, 24 bytes) */
u8 dNessModel_gap_0x98E8[24] = {
	#include <NessModel/gap_0x98E8.data.inc.c>
};
...
u32 dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint[988] = {
	aobjEvent32End(),
	aobjEvent32End(),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xAC),
	...
	aobjEvent32SetValAfterBlock(0x001, 2),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetAnim(0x000, 0),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xC),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xC),
	aobjEvent32EndRaw(0x03D, 32742),
	aobjEvent32EndRaw(0x020, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x04D, 32758),
	    0xFFF60000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x001, 32738),
	aobjEvent32EndRaw(0x03E, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x022, 4),
	    0xFFE40000,
	aobjEvent32End(),
	    0xFFFFFF00,
	    0xFFE2FFE6,
	...
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xB0),
	aobjEvent32SetValBlock(0x01C, 3082),
	    0x000E0A08,  /* 1.2892954806682631e-39f */
	    0x060E060C,  /* 2.6711674192809015e-35f */
	    0x000E0804,  /* 1.2885724106606715e-39f */
	aobjEvent32SetValBlock(0x01C, 518),
	    0x000E0400,  /* 1.2871318758393456e-39f */
	    0x050E0002,  /* 6.67680934760022e-36f */
	    0x00000000,  /* 0.0f */
	    0xE7000000,
	aobjEvent32End(),
	    0xE7000000,
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x200, 1194),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x048, 66),
	aobjEvent32End(),
	aobjEvent32JumpCmd(0x000, 825),
	    (u32)0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 54),
	aobjEvent32EndRaw(0x03C, 0),
	aobjEvent32EndRaw(0x200, 577),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 3),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x201, 32257),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 66),
	    0xFFE60000,
	aobjEvent32EndRaw(0x200, 825),
	    0xFFFFFF00,
	    0xFFDC0042,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x000, 825),
	    0xFFFFFF00,
	    0xE7000000,
	aobjEvent32End(),
	    0xD9DDFFFF,
	...
	aobjEvent32SetValBlock(0x201, 16432),
	    ...
	    0x0008C330,  /* 8.047040509293122e-40f */
	    0xFD100000,
	aobjEvent32SetExtValAfter(0x312, 2),
	    0xE6000000,  /* -1.5111572745182865e+23f */
	    0x00000000,  /* 0.0f */
	    0xF0000000,  /* -1.5845632502852868e+29f */
	    0x05008000,  /* 6.042040963226558e-36f */
	    0xE7000000,
	aobjEvent32End(),
	    0xD7000002,
	    0xFFFFFFFF,
	...
	aobjEvent32EndRaw(0x007, 16508),
	    0xFD500000,
	aobjEvent32SetExtValBlock(0x0B2, 6),
	    0xE6000000,  /* -1.5111572745182865e+23f */
	    0x00000000,  /* 0.0f */
	...
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x1A0),
	aobjEvent32SetValBlock(0x014, 2054),
	    0x00040A06,  /* 3.709377164914223e-40f */
	    0x06080206,  /* 2.5580243660987034e-35f */
	aobjEvent32EndRaw(0x010, 2560),
	aobjEvent32SetValBlock(0x004, 1030),
	    0x000A0400,  /* 9.197898912073807e-40f */
	aobjEvent32SetValBlock(0x004, 2048),
	...
	aobjEvent32End(),
	    0xDF000000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x062, 21),
	aobjEvent32EndRaw(0x018, 0),
	aobjEvent32JumpCmd(0x3C5, 32527),
	    (u32)0xFFFFFF00,
	aobjEvent32EndRaw(0x094, 107),
	aobjEvent32EndRaw(0x008, 0),
	aobjEvent32WaitRaw(0x1B6, 549),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x06A, 112),
	aobjEvent32EndRaw(0x082, 0),
	aobjEvent32WaitRaw(0x00C, 595),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 113),
	aobjEvent32EndRaw(0x0AA, 0),
	aobjEvent32JumpCmd(0x000, 604),
	    (u32)0xFFFFFF00,
	aobjEvent32EndRaw(0x062, 37),
	aobjEvent32EndRaw(0x070, 0),
	aobjEvent32JumpCmd(0x3BF, 32671),
	    (u32)0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 37),
	aobjEvent32EndRaw(0x0A6, 0),
	aobjEvent32JumpCmd(0x001, 32671),
	    (u32)0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 70),
	aobjEvent32EndRaw(0x098, 0),
	aobjEvent32JumpCmd(0x000, 204),
	    (u32)0xFFFFFF00,
	    0xFFCB0070,
	aobjEvent32EndRaw(0x082, 0),
	    0xFFFA0253,
	    ...
	    0xFFCF0025,
	aobjEvent32EndRaw(0x070, 0),
	aobjEvent32EndRaw(0x041, 32671),
	    0xFFFFFF00,
	    0xFFCF0015,
	aobjEvent32EndRaw(0x018, 0),
	aobjEvent32EndRaw(0x03B, 32527),
	    0xFFFFFF00,
	    0xFFB6006B,
	aobjEvent32EndRaw(0x008, 0),
	    0xFF250225,
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x054, 156),
	...
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x07A, 156),
	aobjEvent32EndRaw(0x008, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x000, 156),
	...
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x04C, 68),
	aobjEvent32EndRaw(0x06A, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x0A4, 79),
	    0xFFFC0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x098, 49),
	...
	aobjEvent32SetValBlock(0x201, 16432),
	    ...
	    0xFD100000,
	aobjEvent32SetExtValBlock(0x0CA, 24),
	    0xE6000000,  /* -1.5111572745182865e+23f */
	    0x00000000,  /* 0.0f */
	    0xF0000000,  /* -1.5845632502852868e+29f */
	    0x0501C000,  /* 6.100815680767672e-36f */
	    0xE7000000,
	aobjEvent32End(),
	    0xD7000002,
	    0xFFFFFFFF,
	...
	aobjEvent32SetValBlock(0x203, 30720),
	    ...
	    0x00000000,  /* 0.0f */
	    0x0100B016,  /* 2.363622248079542e-38f */
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x2E0),
	aobjEvent32SetValBlock(0x028, 4624),
	    0x00100E14,  /* 1.474418218193286e-39f */
	    0x060E100C,  /* 2.6719021032501654e-35f */
	aobjEvent32EndRaw(0x020, 2572),
	aobjEvent32SetValBlock(0x018, 2568),
	    0x000C060E,  /* 1.104197966515598e-39f */
	    0x0608040C,  /* 2.558173024808109e-35f */
	aobjEvent32EndRaw(0x010, 516),
	aobjEvent32SetValBlock(0x010, 2),
	    0x0004060C,  /* 3.695111946547397e-40f */
	    0xE7000000,
	aobjEvent32End(),
	    0xE3001001,
	aobjEvent32End(),
	...
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x390),
	aobjEvent32SetValBlock(0x05C, 11306),
	    0x002C282A,  /* 4.055169981761801e-39f */
	    0x06282C26,  /* 3.162972329940239e-35f */
	    0x002C2E24,  /* 4.057313968412218e-39f */
	    0x062C2426,  /* 3.237616221217454e-35f */
	aobjEvent32EndRaw(0x054, 8750),
	aobjEvent32SetValBlock(0x054, 10272),
	    0x0028261E,  /* 3.68709371673453e-39f */
	    0x061C2E22,  /* 2.9374232034325105e-35f */
	    0x0020222A,  /* 2.9509916334247036e-39f */
	aobjEvent32SetValBlock(0x04C, 9242),
	    0x001E2618,  /* 2.768730347363832e-39f */
	    0x0620281E,  /* 3.0122128835598766e-35f */
	    0x00261A18,  /* 3.499109527745356e-39f */
	aobjEvent32SetValBlock(0x02C, 7202),
	    0x001E1814,  /* 2.7637024884738345e-39f */
	    0x06201222,  /* 3.010597726771198e-35f */
	    0x0024101A,  /* 3.3118540139576305e-39f */
	aobjEvent32SetValBlock(0x024, 5666),
	    0x00240E10,  /* 3.311122536159253e-39f */
	    0x06201E0C,  /* 3.011473033843954e-35f */
	aobjEvent32EndRaw(0x030, 6666),
	aobjEvent32SetValBlock(0x018, 7700),
	    0x0014180A,  /* 1.845333513909279e-39f */
	    0x061A100A,  /* 2.8975964446361936e-35f */
	aobjEvent32EndRaw(0x01C, 2064),
	aobjEvent32SetValBlock(0x018, 5126),
	    0x000E0408,  /* 1.2871430862270602e-39f */
	    0x0606140A,  /* 2.521732125960767e-35f */
	aobjEvent32EndRaw(0x020, 2058),
	aobjEvent32SetValBlock(0x004, 3078),
	    0x0000060A,  /* 2.1664074258461672e-42f */
	aobjEvent32SetValBlock(0x010, 10),
	    0x00040008,  /* 3.6735319501967944e-40f */
	aobjEvent32SetValBlock(0x008, 512),
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x200, 24588),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x510),
	aobjEvent32SetValBlock(0x014, 2054),
	    0x00040200,  /* 3.6805944944569915e-40f */
	    0xE7000000,  /* -6.044629098073146e+23f */
	aobjEvent32End(),
	...
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x730),
	aobjEvent32SetValBlock(0x024, 4110),
	    0x00100C0E,  /* 1.4736923455887658e-39f */
	    0x060A120E,  /* 2.596817975563243e-35f */
	aobjEvent32EndRaw(0x018, 2574),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x038, 0),
	aobjEvent32EndRaw(0x00C, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x040, 6),
	aobjEvent32End(),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x002, 0),
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x201, 8212),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x840),
	aobjEvent32SetValBlock(0x024, 4110),
	    0x00100C0E,  /* 1.4736923455887658e-39f */
	    0x060A120E,  /* 2.596817975563243e-35f */
	aobjEvent32EndRaw(0x018, 2574),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x03B, 32764),
	aobjEvent32EndRaw(0x01E, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x047, 32758),
	    0xFFF70000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x02C, 18),
	    0xFFF60000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x001, 32765),
	aobjEvent32EndRaw(0x01C, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x019, 32742),
	    0xFFEC0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	    0xFFFE000C,
	...
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0x950),
	aobjEvent32SetValBlock(0x018, 2568),
	    0x00060C08,  /* 5.553289762180677e-40f */
	    0x06060A0C,  /* 2.5209980159633543e-35f */
	aobjEvent32EndRaw(0x014, 1032),
	aobjEvent32SetValBlock(0x010, 1026),
	    0x00080006,  /* 7.346923770547156e-40f */
	aobjEvent32SetValBlock(0x000, 2050),
	aobjEvent32EndRaw(0x008, 2566),
	aobjEvent32SetValBlock(0x00C, 4),
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x200, 28686),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xA30),
	aobjEvent32SetValBlock(0x018, 2568),
	    0x000A0608,  /* 9.205185664088296e-40f */
	    0x0608040C,  /* 2.558173024808109e-35f */
	aobjEvent32EndRaw(0x018, 1546),
	aobjEvent32SetValBlock(0x004, 1032),
	    0x00000C04,  /* 4.310394076263137e-42f */
	aobjEvent32SetValBlock(0x010, 1538),
	    0x000C0206,  /* 1.1027518265004148e-39f */
	aobjEvent32SetValBlock(0x000, 524),
	...
	aobjEvent32EndRaw(0x044, 0),
	    0xDF000000,
	aobjEvent32End(),
	aobjEvent32EndRaw(0x05A, 1),
	aobjEvent32EndRaw(0x00C, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x062, 6),
	    0xFFFF0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	...
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x012, 1),
	aobjEvent32EndRaw(0x00C, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x00A, 6),
	    0xFFFF0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x048, 0),
	aobjEvent32End(),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x013, 32767),
	    0xFFFA0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x00B, 32762),
	aobjEvent32EndRaw(0x002, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	    0xE7000000,
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x201, 8212),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xB10),
	aobjEvent32SetValBlock(0x024, 4110),
	    0x00100C0E,  /* 1.4736923455887658e-39f */
	    0x060A120E,  /* 2.596817975563243e-35f */
	aobjEvent32EndRaw(0x018, 2574),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x068, 1),
	aobjEvent32EndRaw(0x00C, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x074, 7),
	    0xFFFF0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x01C, 0),
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x201, 8212),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xC20),
	aobjEvent32SetValBlock(0x024, 4110),
	    0x00100C0E,  /* 1.4736923455887658e-39f */
	    0x060A120E,  /* 2.596817975563243e-35f */
	aobjEvent32EndRaw(0x018, 2574),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x042, 5),
	aobjEvent32EndRaw(0x026, 0),
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x068, 2),
	    0xFFFA0000,
	aobjEvent32End(),
	    0xFFFFFF00,
	aobjEvent32EndRaw(0x03C, 2),
	    0xFFE40000,
	aobjEvent32End(),
	    0xFFFFFF00,
	    0xFFF50007,
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x200, 28686),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xD30),
	aobjEvent32SetValBlock(0x018, 2568),
	    0x000C060A,  /* 1.1041923613217407e-39f */
	    0x06080A04,  /* 2.5586115393022635e-35f */
	aobjEvent32EndRaw(0x008, 2566),
	...
	aobjEvent32End(),
	aobjEvent32EndRaw(0x200, 28686),
	(u32)((u8*)dNessModel_PKThunderWaveMatAnimJoint_MatAnimJoint + 0xE10),
	aobjEvent32SetValBlock(0x018, 2568),
	    0x00080A06,  /* 7.382797011233872e-40f */
	    0x06060C08,  /* 2.521143804813505e-35f */
	aobjEvent32EndRaw(0x014, 1030),
	aobjEvent32SetValBlock(0x014, 3074),
	    0x00040A02,  /* 3.70932111297565e-40f */
	    0x06020C06,  /* 2.4459115923890277e-35f */
	aobjEvent32EndRaw(0x008, 6),
	aobjEvent32SetValBlock(0x000, 518),
	aobjEvent32EndRaw(0x004, 4),
	    0xE7000000,
	aobjEvent32End(),
	    0xE7000000,
	aobjEvent32End(),
	...
	aobjEvent32End(),
	aobjEvent32End(),
	aobjEvent32EndRaw(0x003, 20447),
	    0xFB81FEA9,
	aobjEvent32WaitRaw(0x382, 1),
	    0xFD6BD55F,
	    0xBC99DA81,
	    0xBB4196D7,
	    0x6A01F87B,
...
/* Texture data @ 0xAB20 (480 bytes) */
u8 dNessModel_Tex_0xAB20[480] = {
