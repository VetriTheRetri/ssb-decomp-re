...
u32 dYoshiSpecial3_EggLayBreak_AnimJoint_0x9F8[] = {
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTZ, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32Wait(10),
	aobjEvent32End(),
};
...
u32 dYoshiSpecial3_EggLayBreak_AnimJoint_0xA08[] = {
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 0),
	    0x37D1FFFF,  /* 2.503394898667466e-05f */
	    0xB7700000,  /* -1.430511474609375e-05f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 86),
	    0x37D1FFFF,  /* 2.503394898667466e-05f */
	    0x363A26F4,  /* 2.773883352347184e-06f */
	    0xB7700000,  /* -1.430511474609375e-05f */
	    0xB5D9187D,  /* -1.6174886923181475e-06f */
	aobjEvent32Cmd12(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 70),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAXYZ, 0),
	    0x42B40000,  /* 90.0f */
	...
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTZ, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAXYZ, 1),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_SCAY, 6),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_SCAX, 1),
	    0x3F12CA5A,  /* 0.5734001398086548f */
...
u32 dYoshiSpecial3_EggLayThrow_AnimJoint_0xBA8[] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAXYZ, 1),
	    ...
	    0x3F86FA36,  /* 1.0545108318328857f */
	    0x3E6FDA69,  /* 0.2342316061258316f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX, 0),
	    0xC1C1F90D,  /* -24.246606826782227f */
	    0x3E6F963E,  /* 0.23397156596183777f */
	aobjEvent32SetTargetRate(AOBJ_FLAG_SCAZ, 0),
	    0x3E6FD960,  /* 0.23422765731811523f */
	...
	aobjEvent32SetValRate(AOBJ_FLAG_SCAY, 6),
	    0x3EAF80A4,  /* 0.3427783250808716f */
	    0x3DF2E95F,  /* 0.11860918253660202f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAX, 4),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAY | AOBJ_FLAG_SCAY | AOBJ_FLAG_SCAZ, 1),
	...
	aobjEvent32SetTargetRate(AOBJ_FLAG_SCAY | AOBJ_FLAG_SCAZ, 0),
	    0xBB9B03DC,  /* -0.00473068468272686f */
	    0xB90726DB,  /* -0.00012889078061562032f */
	aobjEvent32SetValRate(AOBJ_FLAG_SCAY | AOBJ_FLAG_SCAZ, 5),
	    0x3F400000,  /* 0.75f */
...
u32 dYoshiSpecial3_EggLayWait_AnimJoint_0xDF4[] = {
	...
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 86),
	    ...
	    0xB7700000,  /* -1.430511474609375e-05f */
	    0xB5D9187D,  /* -1.6174886923181475e-06f */
	aobjEvent32Cmd12(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 30),
