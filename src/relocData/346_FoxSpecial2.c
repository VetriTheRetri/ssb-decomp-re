...
u32 dFoxSpecial2_ReflectorStart_AnimJoint_0x348[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAXYZ | AOBJ_FLAG_SCAXYZ, 0),
	    0x00000000,
	    0x43700000,
	    0x00000000,
	    0x3E4CCCCD,
	    0x3E4CCCCD,
	    0x3E4CCCCD,
	aobjEvent32SetVal(AOBJ_FLAG_TRAXYZ, 9),
	    0x00000000,
	    0x43700000,
	    0x00000000,
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAXYZ, 4),
	    0x3F800000,
	    0x3F800000,
	    0x3F800000,
	aobjEvent32SetVal(AOBJ_FLAG_SCAXYZ, 1),
	    0x3ECCCCCD,
	    0x3ECCCCCD,
	    0x3ECCCCCD,
	aobjEvent32Wait(0),
...
u32 dFoxSpecial2_EntryArwingL_AnimJoint_0x5C0[] = {
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAXYZ, 0),
	...
	aobjEvent32Wait(12),
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 18),
	...
	aobjEvent32Wait(1),
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 60),
	...
	aobjEvent32Wait(4),
	aobjEvent32SetValRate(AOBJ_FLAG_TRAY, 56),
	    0x46EA6000,  /* 30000.0f */
	    0x443093BC,  /* 706.308349609375f */
	aobjEvent32Wait(6),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTX, 50),
...
u32 dFoxSpecial2_EntryArwingL_AnimJoint_0x6C8[] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 56),
...
u32 dFoxSpecial2_EntryArwingL_AnimJoint_0x714[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 55),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 5),
	    0xC0060A92,  /* -2.094395160675049f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 2),
	    0xC0060A92,  /* -2.094395160675049f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 9),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 49),
	    0x00000000,  /* 0.0f */
	aobjEvent32End(),
};
