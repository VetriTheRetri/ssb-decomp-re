...
u16 dFTFoxAnimClaps_joint25[40] = {
	...
	ftAnimEnd(),
	0x480C, 0x00DB, 0x0000, 0x3802, 0xFE9B, 0x4003, 0x001E, 0x0166, 0x5803, 0x0010, 0x0801, 0x000E, 0x3803, 0x001E, 0xFE9B, 0x4003, 0x001E, 0x0166, 0x0801, 0x0010, 0x6800, 0xFFD6,
};
