...
u32 dMVOpeningRoomScene1_CamAnimJoint[249] = {
	aobjEvent32SetVal0Rate(AOBJ_CAMFLAG_EYEX | AOBJ_CAMFLAG_EYEZ | AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ, 0),
	    0x00000000,  /* 0.0f */
	    0xC559EC07,  /* -3486.751708984375f */
	    0x00000000,  /* 0.0f */
	    0x4504A7D2,  /* 2122.48876953125f */
	    0xC55C8799,  /* -3528.474853515625f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_EYEY, 0),
	    0x45EACFF9,  /* 7513.99658203125f */
	    0xBE294E6C,  /* -0.16533821821212769f */
	aobjEvent32SetValBlock(AOBJ_CAMFLAG_FOVY, 0),
	    0x41838231,  /* 16.438570022583008f */
	aobjEvent32SetVal0Rate(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY, 20),
	    0x00000000,  /* 0.0f */
	    0x4504A7D2,  /* 2122.48876953125f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ, 20),
	    0x45EACFF9,  /* 7513.99658203125f */
	    0x3E21702A,  /* 0.15765443444252014f */
	    0xC559EC07,  /* -3486.751708984375f */
	    0xBE32B9E6,  /* -0.1745372712612152f */
	aobjEvent32SetVal0Rate(AOBJ_CAMFLAG_EYEX, 21),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal(AOBJ_CAMFLAG_FOVY, 80),
	    0x41838231,  /* 16.438570022583008f */
	aobjEvent32SetVal0RateBlock(AOBJ_CAMFLAG_ATZ, 9),
	    0xC55C8799,  /* -3528.474853515625f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATZ, 60),
	    0xC55C8799,  /* -3528.474853515625f */
	    0xBEF8B014,  /* -0.48571836948394775f */
	aobjEvent32Wait(11),
	aobjEvent32SetVal(AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ, 60),
	    0x4603532A,  /* 8404.791015625f */
	    0xC50390A1,  /* -2105.039306640625f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY, 60),
	    0x00000000,  /* 0.0f */
	    0x3F133190,  /* 0.5749750137329102f */
	    0x4504A7D2,  /* 2122.48876953125f */
	    0xBD997426,  /* -0.07492856681346893f */
	aobjEvent32Wait(1),
	aobjEvent32SetValAfter(AOBJ_CAMFLAG_EYEX, 59),
	    0x00000000,  /* 0.0f */
	aobjEvent32Wait(48),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATZ, 35),
	    0xC535E582,  /* -2910.34423828125f */
	    0x423A1B94,  /* 46.52693176269531f */
	aobjEvent32Wait(11),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATY, 35),
	    0x44F0582B,  /* 1922.7552490234375f */
	    0xC14516FF,  /* -12.318114280700684f */
	aobjEvent32SetTargetRate(AOBJ_CAMFLAG_ATX, 0),
	    0x3F133333,  /* 0.574999988079071f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATX, 44),
	    0xC43A28AC,  /* -744.635498046875f */
	    0xC22C111F,  /* -43.016719818115234f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_FOVY, 59),
	...
	aobjEvent32SetValRate(AOBJ_CAMFLAG_EYEY, 60),
	    0x45895A0B,  /* 4395.25537109375f */
	    0xC273115B,  /* -60.76694869995117f */
	aobjEvent32SetTargetRate(AOBJ_CAMFLAG_EYEX, 0),
	    0x40815D14,  /* 4.042612075805664f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_EYEX, 80),
	...
	aobjEvent32Wait(9),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATZ, 33),
	    0xC47EADCB,  /* -1018.7155151367188f */
	    0xC1696A19,  /* -14.58840274810791f */
	aobjEvent32Wait(1),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATY, 14),
	    0x44A0B716,  /* 1285.721435546875f */
	    0x41504290,  /* 13.016250610351562f */
	aobjEvent32Wait(10),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_FOVY, 20),
	    0x420628B3,  /* 33.53974533081055f */
	    0xBD832064,  /* -0.06402662396430969f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATX, 26),
	    0xC58CF50C,  /* -4510.630859375f */
	    0x42DD732F,  /* 110.72496795654297f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_EYEX | AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ, 90),
	...
	aobjEvent32Wait(5),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_FOVY, 25),
	    0x417E3805,  /* 15.888676643371582f */
	    0x3BA01BC6,  /* 0.004886123351752758f */
	aobjEvent32Wait(10),
	aobjEvent32SetValRate(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY, 19),
	    0xC490824E,  /* -1156.072021484375f */
	    0xBF8C571B,  /* -1.0964082479476929f */
	    0x450DB725,  /* 2267.446533203125f */
	    0xBF7A9857,  /* -0.9788870215415955f */
	aobjEvent32Wait(5),
	aobjEvent32SetValRateBlock(AOBJ_CAMFLAG_EYEX | AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ, 10),
	...
	aobjEvent32SetVal0Rate(AOBJ_CAMFLAG_EYEX | AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ, 160),
	    0xC47F39E0,  /* -1020.904296875f */
	    0x453E361B,  /* 3043.381591796875f */
	    0xC493A5CA,  /* -1181.180908203125f */
	aobjEvent32SetValRate(AOBJ_CAMFLAG_FOVY, 160),
	    0x41800355,  /* 16.00162696838379f */
	    0x3C0647C9,  /* 0.008195825852453709f */
	aobjEvent32Wait(4),
	aobjEvent32SetVal0RateBlock(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ, 156),
