...
u32 dMVOpeningRoomScene2_CamAnimJoint[17] = {
	...
	aobjEvent32SetVal0RateBlock(AOBJ_CAMFLAG_EYEX | AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ | AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ | AOBJ_CAMFLAG_FOVY, 300),
