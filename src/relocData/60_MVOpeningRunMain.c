...
u32 dMVOpeningRunMain_CamAnimJoint[60] = {
	aobjEvent32SetValRate(AOBJ_CAMFLAG_EYEX, 0),
	    0x43861E4D,  /* 268.2367248535156f */
	    0x413FD203,  /* 11.98877239227295f */
	aobjEvent32SetVal0RateBlock(AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ | AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ, 0),
	...
	aobjEvent32SetValRateBlock(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ, 40),
	...
	aobjEvent32SetValRateBlock(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ, 20),
	...
	aobjEvent32SetVal0Rate(AOBJ_CAMFLAG_EYEX | AOBJ_CAMFLAG_EYEY | AOBJ_CAMFLAG_EYEZ, 90),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_CAMFLAG_ATX | AOBJ_CAMFLAG_ATY | AOBJ_CAMFLAG_ATZ, 20),
