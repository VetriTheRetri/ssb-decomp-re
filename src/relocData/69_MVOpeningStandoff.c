...
/* @tex fmt=CI4 dim=64x64 lut=dMVOpeningStandoff_Lut_0x0008_palette */
...
/* @tex fmt=CI4 dim=64x64 lut=dMVOpeningStandoff_Lut_0x0030_palette */
...
/* @tex fmt=CI4 dim=32x32 lut=dMVOpeningStandoff_Lut_0x0058_palette */
...
u32 dMVOpeningStandoff_LightningMatAnimJoint_MatAnimJoint_0x6BEC[] = {
	aobjEvent32SetValBlock(AOBJ_MATFLAG_TEXID, 0),
	    0x00000000,
	aobjEvent32SetValBlock(AOBJ_MATFLAG_TEXID, 261),
	    0x00000000,
...
u32 dMVOpeningStandoff_LightningMatAnimJoint_MatAnimJoint_0x6C54[] = {
	aobjEvent32SetValBlock(AOBJ_MATFLAG_TEXID, 0),
	    0x00000000,
	aobjEvent32SetValBlock(AOBJ_MATFLAG_TEXID, 150),
	    0x00000000,
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID, 1),
	    0x40800000,
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID, 1),
...
u32 dMVOpeningStandoff_LightningMatAnimJoint_MatAnimJoint_0x6CC4[] = {
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID | AOBJ_MATFLAG_TRAU | AOBJ_MATFLAG_TRAV | AOBJ_MATFLAG_SCAU | AOBJ_MATFLAG_SCAV, 0),
	    ...
	    0x3F800000,
	    0x3F800000,
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID, 20),
	    0x00000000,
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID, 1),
	    0x40800000,
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID, 1),
...
u32 dMVOpeningStandoff_LightningMatAnimJoint_MatAnimJoint_0x6D0C[] = {
	...
	aobjEvent32SetValAfterBlock(AOBJ_MATFLAG_TEXID, 1),
	    0x00000000,
	aobjEvent32SetValAfter(AOBJ_MATFLAG_TEXID, 16),
	    0x00000000,
	aobjEvent32Wait(316),
	aobjEvent32End(),
};
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x6D94[] = {
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAXYZ, 0),
	    ...
	    0x41448CE8,  /* 12.284400939941406f */
	    0x41448CE8,  /* 12.284400939941406f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAY, 0),
	    0x4009DB21,  /* 2.1539995670318604f */
	    0x45D9828D,  /* 6960.31884765625f */
	aobjEvent32SetValRate(AOBJ_FLAG_SCAXYZ, 262),
	    ...
	    0x3DFEF40F,  /* 0.1244889423251152f */
	aobjEvent32SetVal(AOBJ_FLAG_ROTY, 265),
	    0x40053F77,  /* 2.081998586654663f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAY, 261),
	    0x45ABC6BC,  /* 5496.841796875f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 90),
	    0x45ABC6BC,  /* 5496.841796875f */
	aobjEvent32Wait(1),
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAXYZ, 89),
	    0x42CDF5C5,  /* 102.98001861572266f */
	    0x425FEB8A,  /* 55.980018615722656f */
	    0x425FEB8A,  /* 55.980018615722656f */
	aobjEvent32Wait(3),
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 55),
	    0x40053F77,  /* 2.081998586654663f */
	aobjEvent32End(),
};
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x6E1C[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAXYZ | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAZ, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAY, 262),
	    0x3FBAE144,  /* 1.4599995613098145f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 1),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 259),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 1),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTY, 5),
	    0x00000000,  /* 0.0f */
	aobjEvent32Wait(1),
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAY, 89),
	    0x3F800000,  /* 1.0f */
	aobjEvent32Wait(4),
	aobjEvent32SetFlags(0x003, 0),
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTY, 85),
	    0x00000000,  /* 0.0f */
	aobjEvent32Wait(54),
	aobjEvent32End(),
};
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x6EA4[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 0),
	    0x00000000,  /* 0.0f */
	    0x3F800000,  /* 1.0f */
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAXYZ | AOBJ_FLAG_SCAZ, 0),
	    ...
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 261),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 262),
	...
	aobjEvent32SetVal(AOBJ_FLAG_SCAX, 89),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 2),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 1),
	    0x3FF5C28D,  /* 1.9199997186660767f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 86),
	    0x3FF5C28D,  /* 1.9199997186660767f */
	aobjEvent32Wait(1),
	aobjEvent32SetFlags(0x003, 0),
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTY, 85),
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x6F4C[] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAXYZ, 0),
	    ...
	    0x41448CE8,  /* 12.284400939941406f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetValRate(AOBJ_FLAG_SCAXYZ, 153),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_SCAXYZ, 109),
	    0x431891D9,  /* 152.56971740722656f */
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x6FDC[] = {
	...
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAXYZ | AOBJ_FLAG_SCAZ, 0),
	    ...
	    0x00000000,  /* 0.0f */
	    0x3F516873,  /* 0.8180000185966492f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 150),
	    0x3F516873,  /* 0.8180000185966492f */
	    0x3F516873,  /* 0.8180000185966492f */
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 160),
	    0x3FAAF919,  /* 1.3357268571853638f */
	    0x3F968BE7,  /* 1.1761444807052612f */
	aobjEvent32End(),
};
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x7060[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAY, 161),
	    0x3F847104,  /* 1.0346989631652832f */
	    0x3FE6F82B,  /* 1.8044484853744507f */
	aobjEvent32End(),
};
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x70CC[] = {
	...
	aobjEvent32SetVal(AOBJ_FLAG_ROTY, 320),
	    0xBFC147A1,  /* -1.5099984407424927f */
	aobjEvent32SetValRateBlock(AOBJ_FLAG_SCAXYZ, 21),
	    0x42F66663,  /* 123.1999740600586f */
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_SCAXYZ, 296),
	    0x42F66663,  /* 123.1999740600586f */
	    0x4270A6E6,  /* 60.162986755371094f */
	    0x4270A6E6,  /* 60.162986755371094f */
	aobjEvent32End(),
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x7144[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 1),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 18),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 1),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 5),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetFlags(0x003, 0),
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 295),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32End(),
};
...
u32 dMVOpeningStandoff_LightningAnimJoint_AnimJoint_0x71B0[] = {
	...
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTXYZ | AOBJ_FLAG_TRAXYZ | AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAZ, 0),
	    ...
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetFlags(0x002, 0),
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 20),
	    0x3F800000,  /* 1.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 1),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 18),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 1),
	    0x3FF5C28D,  /* 1.9199997186660767f */
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 296),
	    0x3FF5C28D,  /* 1.9199997186660767f */
	aobjEvent32Wait(1),
	aobjEvent32SetFlags(0x003, 0),
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTY, 295),
...
u32 dMVOpeningStandoff_Cam_AnimJoint[1848] = {
	aobjEvent32SetValAfter(AOBJ_FLAG_TRAX | AOBJ_FLAG_SCAZ, 0),
	    0x00000000,  /* 0.0f */
	    0x428E5385,  /* 71.16312408447266f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 0),
	    0xC511CA4F,  /* -2332.644287109375f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAY | AOBJ_FLAG_TRAZ, 0),
	    0x42C3537C,  /* 97.66305541992188f */
	    0xC4A9F7BC,  /* -1359.74169921875f */
	    0x436459C7,  /* 228.35069274902344f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 1),
	    0xC5129BE3,  /* -2345.742919921875f */
	    0xC14E84E7,  /* -12.90744686126709f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 89),
	    0x436459C7,  /* 228.35069274902344f */
	aobjEvent32SetValAfter(AOBJ_FLAG_TRAX | AOBJ_FLAG_SCAZ, 90),
	    0x44160000,  /* 600.0f */
	    0x411FAEE1,  /* 9.980195045471191f */
	aobjEvent32SetVal(AOBJ_FLAG_TRAZ, 300),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ, 1),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAY, 1),
	...
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 15),
	    0x438744C2,  /* 270.53717041015625f */
	aobjEvent32SetValAfter(AOBJ_FLAG_TRAX | AOBJ_FLAG_SCAZ, 15),
	    0x00000000,  /* 0.0f */
	...
	aobjEvent32SetValAfter(AOBJ_FLAG_TRAX | AOBJ_FLAG_SCAZ, 75),
	    0xC4160000,  /* -600.0f */
	...
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 73),
	    0x436459C7,  /* 228.35069274902344f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ, 1),
	...
	aobjEvent32SetVal(AOBJ_FLAG_ROTY, 5),
	    0x42C352F0,  /* 97.6619873046875f */
	...
	aobjEvent32SetValAfter(AOBJ_FLAG_SCAZ, 105),
	    0x429BCC03,  /* 77.8984603881836f */
	aobjEvent32SetValAfter(AOBJ_FLAG_TRAX, 125),
	...
	aobjEvent32SetVal(AOBJ_FLAG_TRAY, 104),
	    0x436459C7,  /* 228.35069274902344f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ, 1),
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 1),
	    0x41340281,  /* 11.250611305236816f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ, 1),
	    0x43A877DD,  /* 336.9364318847656f */
	    0xC4833FFC,  /* -1049.99951171875f */
	aobjEvent32SetVal(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAZ, 20),
	    0x43A877DD,  /* 336.9364318847656f */
	    0xC403F89A,  /* -527.8843994140625f */
	    0xC39243D7,  /* -292.5299987792969f */
	aobjEvent32SetValAfter(AOBJ_FLAG_SCAZ, 20),
	    0x429BCC03,  /* 77.8984603881836f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX, 20),
	    0x41340281,  /* 11.250611305236816f */
