...
u32 dMVOpeningYamabuki_LegsAnimJoint_0x9924[] = {
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 0),
	    0xBF060A92,  /* -0.5235987901687622f */
	    0x4493C90A,  /* 1182.282470703125f */
	    0xC4035707,  /* -525.3598022460938f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAY, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX | AOBJ_FLAG_TRAZ, 30),
	    0x44205C54,  /* 641.442626953125f */
	    0xC19AE977,  /* -19.363996505737305f */
	    0xC4035709,  /* -525.3599243164062f */
	    0xB6000000,  /* -1.9073486328125e-06f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTY, 30),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAZ, 30),
	    0xBF060A92,  /* -0.5235987901687622f */
	    0xC4035709,  /* -525.3599243164062f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAX, 30),
	    0xC41923AC,  /* -612.557373046875f */
	    0xC1A39997,  /* -20.449995040893555f */
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAZ, 100),
	    0xC4035709,  /* -525.3599243164062f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTY, 30),
	    0x3F060A92,  /* 0.5235987901687622f */
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAX, 30),
	    0xBF060A92,  /* -0.5235987901687622f */
	    0xC496D1D4,  /* -1206.55712890625f */
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY | AOBJ_FLAG_TRAX, 40),
	    0xBF060A92,  /* -0.5235987901687622f */
	    0xC496D1D4,  /* -1206.55712890625f */
	aobjEvent32End(),
};
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0x99B0[] = {
	aobjEvent32SetVal0Rate(AOBJ_FLAG_TRAXYZ, 0),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValRate(AOBJ_FLAG_TRAXYZ, 30),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTY, 15),
	    0x3D567750,  /* 0.05235987901687622f */
	aobjEvent32SetVal(AOBJ_FLAG_ROTY, 30),
	    0xBD567750,  /* -0.05235987901687622f */
	aobjEvent32Wait(15),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAXYZ, 15),
	...
	aobjEvent32Wait(15),
	aobjEvent32SetVal(AOBJ_FLAG_ROTY, 55),
	    0xBD567750,  /* -0.05235987901687622f */
	aobjEvent32Wait(15),
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAXYZ, 40),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0x9AB8[] = {
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 20),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 9),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 8),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 12),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 10),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 8),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 10),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 13),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 8),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 11),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 11),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 11),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTY, 9),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 17),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 9),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 45),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 38),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTX, 37),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0x9F9C[] = {
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTY, 23),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 12),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 7),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 6),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 5),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 9),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0xA368[] = {
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 18),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 23),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 19),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 7),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 21),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 15),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 36),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 25),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0xA6B8[] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 35),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0xA7DC[] = {
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 20),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTZ, 18),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 14),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 4),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTY, 32),
	...
	aobjEvent32SetValRate(AOBJ_FLAG_ROTX, 37),
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTZ, 31),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0xAB1C[] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAXYZ, 30),
	...
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_TRAXYZ, 30),
	    0x44402640,  /* 768.59765625f */
	    0x43E73A2F,  /* 462.4545593261719f */
	    0xC467645A,  /* -925.5679931640625f */
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAXYZ, 40),
	    0x44402640,  /* 768.59765625f */
	    0x43E73A2F,  /* 462.4545593261719f */
	    0xC467645A,  /* -925.5679931640625f */
	aobjEvent32End(),
...
u32 dMVOpeningYamabuki_LegsAnimJoint_0xAC2C[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAXYZ, 70),
	    0xC2191D83,  /* -38.2788200378418f */
	    0xC332B7D5,  /* -178.7180938720703f */
	    0xC24E0314,  /* -51.50300598144531f */
	aobjEvent32End(),
...
u32 dMVOpeningYamabuki_LegsShadowAnimJoint_0xB3B8[] = {
	...
	aobjEvent32SetValRateBlock(AOBJ_FLAG_TRAX, 30),
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 40),
	    0xC53498A3,  /* -2889.539794921875f */
	aobjEvent32End(),
};
...
u32 dMVOpeningYamabuki_LegsShadowAnimJoint_0xB410[] = {
	...
	aobjEvent32SetValBlock(AOBJ_FLAG_TRAX, 70),
	    0xC4EAD8DB,  /* -1878.7767333984375f */
	aobjEvent32End(),
};
...
u32 dMVOpeningYamabuki_MBallAnimJoint_0xCAE8[] = {
	...
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTXYZ, 0),
	    0x00000000,  /* 0.0f */
