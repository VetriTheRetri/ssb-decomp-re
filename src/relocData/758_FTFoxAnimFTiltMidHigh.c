...
extern u16 dFTFoxAnimFTiltMidHigh_joint25[60];
extern u16 dFTFoxAnimFTiltMidHigh_joint26[58];

/* Joint pointer table (26 entries, 104 bytes) */
AObjEvent32 * dFTFoxAnimFTiltMidHigh_joints[] = {
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint1, /* [0] joint 1 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint2, /* [1] joint 2 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint4, /* [2] joint 4 */
	NULL, /* [3] NULL */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint5, /* [4] joint 5 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint6, /* [5] joint 6 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint7, /* [6] joint 7 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint8, /* [7] joint 8 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint10, /* [8] joint 10 */
	NULL, /* [9] NULL */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint11, /* [10] joint 11 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint12, /* [11] joint 12 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint13, /* [12] joint 13 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint15, /* [13] joint 15 */
	NULL, /* [14] NULL */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint16, /* [15] joint 16 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint18, /* [16] joint 18 */
	NULL, /* [17] NULL */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint20, /* [18] joint 20 */
	NULL, /* [19] NULL */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint21, /* [20] joint 21 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint23, /* [21] joint 23 */
	NULL, /* [22] NULL */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint24, /* [23] joint 24 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint25, /* [24] joint 25 */
	(AObjEvent32 *)dFTFoxAnimFTiltMidHigh_joint26, /* [25] joint 26 */
};
...
u16 dFTFoxAnimFTiltMidHigh_joint21[194] = {
	ftAnimSetValRate(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ), 1963, -620, 1470, -214, 1743, -770,
	...
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1343, -336, 1256, -85, 972, -428,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1291, -27, 1300, 25, 886, -48,
	ftAnimSetValRateT(FT_ANIM_ROTY, 2), 1256, 12,
	ftAnimSetValRateT(FT_ANIM_ROTX, 3), 1550, 238,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 876, 42,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 972, 469,
	ftAnimSetVal0RateT(FT_ANIM_SCAX | FT_ANIM_SCAY | FT_ANIM_SCAZ, 2), 5324, 4300, 4300,
	ftAnimSetValRateBlockT(FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1331, -118, 1814, 480,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1819, 72, 1019, -156, 1933, -32,
	ftAnimSetVal0RateT(FT_ANIM_SCAX | FT_ANIM_SCAY | FT_ANIM_SCAZ, 6), 5324, 4300, 4300,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1695, -109, 1018, 0, 1750, -151,
	ftAnimSetValRateT(FT_ANIM_ROTY, 5), 1001, 2,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 1), 1599, -101, 1630, -112,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 4), 1244, -4, 1365, -5,
	ftAnimSetVal0RateT(FT_ANIM_SCAX | FT_ANIM_SCAY | FT_ANIM_SCAZ, 6), 4096, 4096, 4096,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1280, -17, 1016, 70, 1375, -79,
	ftAnimSetValRateT(FT_ANIM_ROTY, 4), 1309, -4,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 1), 1208, -14, 1206, -109,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 1), 1252, 19, 1156, -68,
	ftAnimSetValRateT(FT_ANIM_ROTX, 3), 1329, 147,
	ftAnimSetValRateT(FT_ANIM_ROTZ, 4), 1328, 211,
	ftAnimBlock(0, 2),
	ftAnimSetValRateBlockT(FT_ANIM_ROTY, 1), 1281, -15,
	ftAnimSetValRateT(FT_ANIM_ROTY, 4), 1488, -25,
	ftAnimSetVal0RateT(FT_ANIM_SCAX | FT_ANIM_SCAY | FT_ANIM_SCAZ, 9), 4095, 4096, 4095,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX, 1), 1552, 226,
	ftAnimSetValRateT(FT_ANIM_ROTX, 3), 1894, 8,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 1559, 185,
	ftAnimSetValRateT(FT_ANIM_ROTZ, 5), 1686, 25,
	ftAnimBlock(0, 2),
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY, 1), 1889, 3, 1437, -34,
	ftAnimSetValRateT(FT_ANIM_ROTX | FT_ANIM_ROTY, 3), 1951, 18, 1452, 21,
	ftAnimBlock(0, 2),
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 1720, 28,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), 1963, 11, 1470, 18, 1743, 22,
	ftAnimEnd(),
	0x0000,
};
...
u16 dFTFoxAnimFTiltMidHigh_joint23[72] = {
	...
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 2), 914, -193,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 665, -454,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 5, -329,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 5, -2,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 5), 0, 35,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 76, 282,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 565, 341,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 760, 175,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 5), 962, -174,
...
u16 dFTFoxAnimFTiltMidHigh_joint24[146] = {
	...
	ftAnimSetValRateT(FT_ANIM_ROTX, 2), -1303, -67,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 1135, 22,
	ftAnimSetValRateBlockT(FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), -1509, -89, 1177, 419,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), -1443, -132, -1688, -73, 1974, 264,
	ftAnimSetValRateT(FT_ANIM_ROTX, 9), -1556, -71,
	ftAnimSetValRateBlockT(FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), -1656, 36, 1705, -73,
	ftAnimSetValRateT(FT_ANIM_ROTY, 5), -1679, -18,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 1), 1827, 87,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 4), 1893, -3,
	ftAnimSetValRateBlockT(FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), -1686, 35, 1894, -51,
	ftAnimSetValRateT(FT_ANIM_ROTY, 3), -1378, 25,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 2), 1597, -91,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 1), -1642, -60, 1607, 11,
	ftAnimSetValRateT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 4), -1646, -35, 1184, -147,
	ftAnimSetValRateBlockT(FT_ANIM_ROTY, 1), -1403, -49,
	ftAnimSetValRateT(FT_ANIM_ROTY, 7), -1643, 48,
	ftAnimBlock(0, 3),
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTZ, 1), -1677, 5, 1073, -42,
	ftAnimSetValRateT(FT_ANIM_ROTX, 4), -1516, -8,
	ftAnimSetValRateBlockT(FT_ANIM_ROTZ, 3), 1123, 27,
	ftAnimSetValRateBlockT(FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), -1595, 46, 1176, 66,
	ftAnimSetValRateT(FT_ANIM_ROTY | FT_ANIM_ROTZ, 2), -1518, 22, 1338, 62,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX, 1), -1538, -28,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX, 1), -1573, -26,
	ftAnimSetValRateBlockT(FT_ANIM_ROTX | FT_ANIM_ROTY | FT_ANIM_ROTZ, 1), -1592, -19, -1505, 12, 1381, 43,
	ftAnimEnd(),
};

/* Joint 25 */
u16 dFTFoxAnimFTiltMidHigh_joint25[60] = {
...
/* Joint 26 */
u16 dFTFoxAnimFTiltMidHigh_joint26[58] = {
