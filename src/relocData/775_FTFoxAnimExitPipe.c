...
u16 dFTFoxAnimExitPipe_joint25[52] = {
	...
	ftAnimEnd(),
	0x0000, 0x4002, 0xFF4E, 0x480C, 0xFF86, 0x0000, 0x2003, 0x001A, 0xFF4E, 0xFFF5, 0x2003, 0x0004, 0xFDE8, 0x004F, 0x2003, 0x0005, 0x0218, 0x0023, 0x3803, 0x0005, 0xFF4E, 0x0000, 0x0000,
};
