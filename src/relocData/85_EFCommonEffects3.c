...
u32 dEFCommonEffects3_MBallRays_AnimJoint_0x720[] = {
	aobjEvent32SetValBlock(AOBJ_FLAG_ROTX, 0),
	    0x00000000,  /* 0.0f */
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAXYZ, 0),
	    0x00000000,  /* 0.0f */
	    0xC1100000,  /* -9.0f */
	    0xC0900000,  /* -4.5f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal(AOBJ_FLAG_ROTX, 90),
	    0x2F0EFA35,  /* 1.3003716159420975e-10f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTX, 40),
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTY, 50),
	...
	aobjEvent32SetVal(AOBJ_FLAG_SCAY, 28),
	    0x405BEA92,  /* 3.436192035675049f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAZ, 12),
	    0x3FCDF0EF,  /* 1.6089152097702026f */
	    0x3FCDF192,  /* 1.6089346408843994f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAZ, 16),
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_SCAX | AOBJ_FLAG_SCAZ, 17),
	    0x4212EA88,  /* 36.729034423828125f */
	    0x4212EA88,  /* 36.729034423828125f */
	aobjEvent32SetValBlock(AOBJ_FLAG_SCAY, 17),
...
u32 dEFCommonEffects3_MBallRays_AnimJoint_0x7C8[] = {
	...
	aobjEvent32SetValAfterBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAXYZ, 0),
	    0x00000000,  /* 0.0f */
	    0x00000000,  /* 0.0f */
	    0xC1100000,  /* -9.0f */
	    0xC0900000,  /* -4.5f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetVal(AOBJ_FLAG_ROTY, 90),
	    0x4200CE28,  /* 32.201324462890625f */
	aobjEvent32Cmd12(AOBJ_FLAG_ROTY, 40),
	aobjEvent32SetVal(AOBJ_FLAG_SCAXYZ, 0),
	    0x3BF90998,  /* 0.007600020617246628f */
	    0x3BF90998,  /* 0.007600020617246628f */
	    0x00000000,  /* 0.0f */
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetVal(AOBJ_FLAG_SCAZ, 17),
	    0x3FCDF192,  /* 1.6089346408843994f */
...
u32 dEFCommonEffects3_MBallRays_MatAnimJoint_data[9] = {
	...
	aobjEvent32SetExtValBlock(AOBJ_EXTFLAG_PRIMCOLOR, 25),
	    0xFFFFFFFF,  /* RGBA(255, 255, 255, 255) */
...
u32 dEFCommonEffects3_ItemGetSwirl_AnimJoint_0x32C8[] = {
	aobjEvent32SetValAfter(AOBJ_FLAG_ROTY | AOBJ_FLAG_ROTZ | AOBJ_FLAG_TRAXYZ | AOBJ_FLAG_SCAXYZ, 0),
	...
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetValRateBlock(AOBJ_FLAG_ROTX, 8),
...
u32 dEFCommonEffects3_ItemGetSwirl_AnimJoint_0x330C[] = {
	...
	aobjEvent32SetVal0Rate(AOBJ_FLAG_ROTX | AOBJ_FLAG_SCAXYZ, 0),
	...
	aobjEvent32SetFlags(0x000, 0),
	aobjEvent32SetVal0RateBlock(AOBJ_FLAG_ROTX | AOBJ_FLAG_TRAY | AOBJ_FLAG_TRAZ | AOBJ_FLAG_SCAXYZ, 8),
...
u32 dEFCommonEffects3_ItemGetSwirl_MatAnimJoint_0x34A8[] = {
	aobjEvent32SetExtValBlock(AOBJ_EXTFLAG_PRIMCOLOR, 0),
	    0x4CFFFFFF,  /* RGBA(76, 255, 255, 255) */
	aobjEvent32SetExtValBlock(AOBJ_EXTFLAG_PRIMCOLOR, 5),
	    0x1CFFB0FF,  /* RGBA(28, 255, 176, 255) */
	aobjEvent32SetExtValBlock(AOBJ_EXTFLAG_PRIMCOLOR, 3),
	    0x00FF808D,  /* RGBA(0, 255, 128, 141) */
	aobjEvent32End(),
};
