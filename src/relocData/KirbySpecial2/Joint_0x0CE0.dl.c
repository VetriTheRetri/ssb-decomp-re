...
Gfx dKirbySpecial2_Joint_0x0CE0_DisplayList[] = {
	...
	{ { 0xFD100000, (unsigned int)((u8*)dKirbySpecial2_gap_0x0BA4 + 0x14) } },  /* cmd 0xFD */
	{ { 0xE6000000, 0x00000000 } },  /* cmd 0xE6 */
	{ { 0xF0000000, 0x0503C000 } },  /* cmd 0xF0 */
	{ { 0xE7000000, 0x00000000 } },  /* cmd 0xE7 */
	{ { 0xD7000002, 0xFFFFFFFF } },  /* cmd 0xD7 */
	{ { 0xF2000000, 0x0003C01C } },  /* cmd 0xF2 */
	{ { 0xFD500000, (unsigned int)((u8*)dKirbySpecial2_gap_0x0BA4 + 0x3C) } },  /* cmd 0xFD */
	{ { 0xE6000000, 0x00000000 } },  /* cmd 0xE6 */
	...
	{ { 0x01002008, (unsigned int)((u8*)dKirbySpecial2_gap_0x0BA4 + 0xAC) } },  /* cmd 0x01 */
