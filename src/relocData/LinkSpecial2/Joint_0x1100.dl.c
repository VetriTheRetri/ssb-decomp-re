...
Gfx dLinkSpecial2_Joint_0x1100_DisplayList[] = {
	...
	{ { 0xFD700000, (unsigned int)((u8*)dLinkSpecial2_EntryBeamMatAnimJoint_MatAnimJoint + 0x48) } },  /* cmd 0xFD */
	{ { 0xDE000000, 0x0E000000 } },  /* cmd 0xDE */
	{ { 0xE6000000, 0x00000000 } },  /* cmd 0xE6 */
	{ { 0xF3000000, 0x071FF200 } },  /* cmd 0xF3 */
	{ { 0xE7000000, 0x00000000 } },  /* cmd 0xE7 */
	{ { 0xD9DDFBFB, 0x00000000 } },  /* cmd 0xD9 */
	{ { 0x01004008, (unsigned int)((u8*)dLinkSpecial2_gap_0x10B0 + 0x10) } },  /* cmd 0x01 */
