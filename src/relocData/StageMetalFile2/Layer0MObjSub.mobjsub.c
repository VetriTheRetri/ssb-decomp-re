extern u32 dStageMetalFile2_Layer0MObjSub_MObjSubPtrArray[];

/* MObjSub array: Layer0MObjSub @ 0xC30 (5 entries) */
MObjSub dStageMetalFile2_Layer0MObjSub_MObjSub[5] = {
	/* [0] @ 0xC30 */
	{
		0x0000,
		0x00, 0x00,
		(void**)((u8*)dStageMetalFile2_Layer0_MObjSubPtrArray + 0x8),
...
u32 dStageMetalFile2_Layer0MObjSub_MObjSubPtrArray[] = {
