...
extern void sc1PGameBossAddBossInterface(GObj *fighter_gobj, s32 arg1);
extern void sc1PGameBossLockPlayerControl(GObj *fighter_gobj, s32 arg1);
extern void sc1PGameBossSetIgnorePlayerMapBounds(GObj *fighter_gobj, s32 arg1);
