...
// 80131F58
void sc1PChallengerMakeFighterCamera()
{
...
// 80132040
void sc1PChallengerMakeDecalsCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
