...
// 8018E598
void sc1PGameSetPlayerInterfacePositions()
{
...
// 8018E670
void sc1PGameWaitStageCommonUpdate()
{
	GObj *fighter_gobj;
	s32 random;
	s32 player_count;
...
// 8018E824
void sc1PGameWaitStageTeamUpdate()
{
	GObj *fighter_gobj;
	s32 player_count;
	s32 player;
...
// 8018E8F8
void sc1PGameWaitStageBonus3Update()
{
...
// 8018E9A4
void sc1PGameWaitStageBossUpdate()
{
	GObj *player_gobj;
	FTStruct *player_fp;
	FTStruct *com_fp;
...
// 8018EB68
void sc1PGameSetGameStatusWait()
{
	gcAddGObjProcess
	(
		gcMakeGObjSPAfter
...
// 8018EE44
void sc1PGameInitTeamStockDisplay()
{
	GObj *interface_gobj;
	FTStruct *fp;
	Sprite *sprite;
...
// 8018F1C0
void sc1PGameTryInitPlayerArrows()
{
...
// 8018F1F8
void sc1PGameInitTimeUpMessage()
{
	if (gSCManagerSceneData.spgame_stage != nSC1PGameStageBonus3)
	{
...
// 8018F540
void sc1PGameBossHidePlayerTagAll()
{
...
// 0x8018F5E4 - Unused?
void func_ovl65_8018F5E4()
{
	return;
}

// 8018F5EC
void sc1PGameBossDefeatInterfaceProcUpdate()
{
...
// 8018F6DC
void func_ovl65_8018F6DC()
{
	D_8009EDD0_406D0.sfx_max = sSC1PGameBossDefeatSoundTerminateTemp;
}

// 8018F6F0
void sc1PGameBossDefeatInterfaceProcSet()
{
