...
// 80191114
void sc1PGameBossSetChangeWallpaper()
{
	sSC1PGameBossMain.is_skip_wallpaper_change = FALSE;
}

// 80191120
void sc1PGameBossMakeCamera()
{
...
// 80191A94
void sc1PGameBossUpdateWallpaperColorID()
{
...
// 801924E0
void sc1PGameBossAdvanceWallpaper()
{
	GObj *gobj;
	s32 anim_id;
	s32 effect_id;
...
// 801926F8
void sc1PGameBossSetBossPlayer()
{
	s32 player;
...
// 80192764
void sc1PGameBossInitWallpaper()
{
	GObj *gobj;
