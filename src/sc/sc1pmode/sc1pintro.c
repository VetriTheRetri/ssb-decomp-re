...
// 0x80131ECC - unused?
void func_ovl24_80131ECC()
{
	return;
}

// 80131ED4
void sc1PIntroMakeVSDecal()
{
	GObj *gobj;
	SObj *sobj;
...
// 8013438C
void sc1PIntroMakeBannersCamera()
{
...
// 8013442C
void sc1PIntroMakeDecalsCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
...
// 801344CC
void sc1PIntroMakePicturesCamera()
{
	CObj *cobj = CObjGetStruct
	(
		gcMakeCameraGObj
