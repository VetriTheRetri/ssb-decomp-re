...
extern void sc1PStageCardMakeFighter(sc1PStageCardFighter fighter, s32 card_anim_frame_id, void **figatree);
...
extern Camera* sc1PStageCardMakeStageCamera(s32 stage, u32 dl_link);
...
extern CameraDesc* sc1PStageCardGetFighterCameraDesc(CameraDesc *cam_desc, s32 ft_kind, s32 cam_id);
extern void sc1PStageCardMakeFighterCamera(s32 ft_kind, s32 cam_id);
