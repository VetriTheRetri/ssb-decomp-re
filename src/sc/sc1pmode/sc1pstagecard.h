...
extern f32 sc1PStageCardGetVSFighterVelocityZ(s32 stage, s32 fkind);
extern void sc1PStageCardVSFighterProcUpdate(GObj *fighter_gobj);
extern void sc1PStageCardSetKirbyTeamModelPartIDs(GObj *fighter_gobj, s32 fkind);
extern f32 sc1PStageCardGetVSFighterPositionZ(s32 stage, s32 fkind);
extern void sc1PStageCardVSFighterFuncDisplay(GObj *fighter_gobj);
extern GObj* sc1PStageCardMakeVSFighter(s32 fkind, s32 stage, s32 card_anim_frame_id, void **figatree, u8 dl_link);
...
extern sb32 sSC1PStageCardCheckCostumeUsed(s32 stage, s32 fkind, s32 color);
extern void sc1PStageCardInitVSFighters(s32 stage);
extern CObjDesc* sc1PStageCardGetFighterCObjDesc(CObjDesc *cobj_desc, s32 fkind, s32 cobj_id);
extern void sc1PStageCardMakeFighterCamera(s32 fkind, s32 cobj_id);
