...
extern void sc1PStageClearBonusObjectiveProcUpdate(GObj *gobj);
extern void sc1PStageClearMakeBonusObjective(f32 x, f32 y, s32 objective_num);
extern void sc1PStageClearMakeBonusObjectives(void);
