...
extern SObj* sc1PTrainingModeMakeMenuSprite(GObj *interface_gobj, SC1PTrainingModeSprites *ts);
extern void sc1PTrainingModeSetMainMenuSpriteAttrs(void);
extern void sc1PTrainingModeUpdateMainMenuHighlight(void);
extern void sc1PTrainingModeMakeMainMenuHighlight(void);
extern void sc1PTrainingModeSetSubMenuSpriteAttrs(void);
extern s32 sc1PTrainingModeGetOptionSpriteID(void);
extern void sc1PTrainingModeUpdateSubMenuHighlight(void);
extern void sc1PTrainingModeMakeSubMenuHighlight(void);
