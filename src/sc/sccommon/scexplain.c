...
// 8018D0C0
void scExplainLoadExplainFiles()
{
...
// 8018D3D8
void scExplainMakeWindowCamera()
{
	gcMakeCameraGObj
	(
...
// 8018D440
void scExplainSetPlayerInterfacePositions()
{
...
// 8018D500
GObj* scExplainMakeControlStickCamera()
{
	GObj *camera_gobj = gcMakeCameraGObj
	(
		nGCCommonKindScissorCamera,
...
// 8018D748
GObj* scExplainMakeControlStickInterface()
{
...
// 8018D8E8
void scExplainUpdateTapSparkEffect()
{
...
// 8018DACC
void scExplainSpecialMoveRGBProcUpdate()
{
...
// 8018DB44
GObj* scExplainMakeSpecialMoveRGB()
{
	GObj *interface_gobj = gcMakeGObjSPAfter
	(
		nGCCommonKindInterface, 
...
// 8018DBD0
void scExplainSetInterfaceGObjs()
{
...
// 8018DD18
void scExplainUpdateTextBoxSprite()
{
...
// 8018DF80
void scExplainTryMakeFireFlower()
{
	Vec3f pos;
	Vec3f vel;
...
// 8018E13C
GObj* scExplainMakeSceneInterface()
{
	GObj *interface_gobj = gcMakeGObjSPAfter
	(
		nGCCommonKindInterface, 
