...
// 80003C00
void syControllerUpdateDeviceIndexes()
{
	s32 controllers = 0;
	s32 i;
...
// 80003CC4
void syControllerUpdateDeviceStatuses()
{
	s32 i;
...
// 80003DD4
void syControllerReadDeviceData()
{
	s32 i;
...
// 80003F98
void syControllerUpdateGlobalData()
{
	s32 i;
