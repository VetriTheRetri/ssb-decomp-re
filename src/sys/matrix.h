...
extern void
syMatrixTraRotRF(Mtx44f *mf, f32 tx, f32 ty, f32 tz, f32 angle, f32 rx, f32 ry, f32 rz);
...
extern void
syMatrixTraRotDF(Mtx44f *mf, f32 tx, f32 ty, f32 tz, f32 a, f32 rx, f32 ry, f32 rz);
extern void
syMatrixTraRotD(Mtx *m, f32 tx, f32 ty, f32 tz, f32 a, f32 rx, f32 ry, f32 rz);
extern void syMatrixRotRpyDF(Mtx44f *mf, f32 r, f32 p, f32 y);
extern void syMatrixRotRpyD(Mtx *m, f32 r, f32 p, f32 y);
extern void
syMatrixTraRotRpyDF(Mtx44f *mf, f32 tx, f32 ty, f32 tz, f32 r, f32 p, f32 y);
