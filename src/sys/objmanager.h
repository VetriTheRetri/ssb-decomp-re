...
extern GObj* gcInitGObjCommon(u32 id, void (*proc_run)(GObj*), u8 link, u32 priority);
extern GObj* gcMakeGObjSPAfter(u32 id, void (*proc_run)(GObj*), u8 link, u32 priority);
extern GObj* gcMakeGObjSPBefore(u32 id, void (*proc_run)(GObj*), u8 link, u32 priority);
