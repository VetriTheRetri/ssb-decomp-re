...
void wpManagerAllocWeapons(void)
{
    ...
    sWPManagerStructsAllocFree = wp = syTasklogMalloc(sizeof(wpStruct) * WEAPON_ALLOC_MAX, 0x8);
...
GObj* wpManagerMakeWeapon(GObj *parent_gobj, wpCreateDesc *wp_desc, Vec3f *spawn_pos, u32 flags)
{
    ...
    gcAddGObjDisplay(weapon_gobj, proc_display, 14, GOBJ_DLLINKORDER_DEFAULT, -1);
