...
// Unknown
void wpManagerUpdateHitInteractStatsGroupID(wpStruct* this_wp, wpHitbox* wp_hit, GObj* target_gobj, s32 hitbox_type,
										  u32 interact_mask);

// Set weapon VS weapon hitbox detection results
void wpManagerUpdateAttackStatWeapon(wpStruct* this_wp, wpHitbox* this_hit, s32 this_hit_id, wpStruct* victim_wp,
