...
extern void wpNessPKThunderHeadMakeTrail(GObj *weapon_gobj, s32 trail_index);
...
extern GObj* wpNessPKThunderTrailMakeWeapon(GObj *head_gobj, Vec3f *pos, s32 trail_index);
extern void wpNessPKReflectHeadMakeTrail(GObj *weapon_gobj, s32 trail_index);
...
extern GObj* wpNessPKReflectTrailMakeWeapon(GObj *old_gobj, Vec3f *pos, s32 trail_index);
