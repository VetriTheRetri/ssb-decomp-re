...
GObj* wpPikachuThunderJoltGroundMakeWeapon(GObj *prev_gobj, Vec3f *pos, s32 coll_type)
{
    ...
    {
    case nMPLineKindGround:
        new_wp->lr = (prev_wp->phys_info.vel_air.x >= 0.0F) ? nGMDirectionR : nGMDirectionL;
