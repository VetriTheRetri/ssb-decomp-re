...
// Unknown
void wpProcessUpdateHitInteractStatsGroupID(WPStruct* this_wp, WPAttackColl* attack_coll, GObj* target_gobj, s32 attack_type,
										  u32 interact_mask);

// Set weapon VS weapon hitbox detection results
void wpProcessUpdateAttackStatWeapon(WPStruct* this_wp, WPAttackColl* this_hit, s32 this_attack_id, WPStruct* victim_wp,
									  WPAttackColl* victim_hit, s32 victim_attack_id, GObj* this_gobj, GObj* victim_gobj);
