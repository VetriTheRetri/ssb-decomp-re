...
def _build_global_sym_index(version):
    """Scan every relocData .o for defined symbols → {sym: (fid, offset)}.

    Built lazily once per process. Drives extern resolution in --auto
    mode where the .reloc-file file-id hint isn't available.
    """
