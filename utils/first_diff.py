...
parser.add_argument(
    ...
    default="us",
    choices=["us"],
    help="version to check for first diff"
)
...
basemap = f"expected/build/{version}/ssb64.{version}.map"

myimg = f"build/{version}/ssb64.{version}.z64"
mymap = f"build/{version}/ssb64.{version}.map"
